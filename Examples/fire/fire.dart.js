...
(function dartProgram() {
  ...
  G = {
    ...
    Framebuffer$: function(_cgl, colorTexture) {
      var t1, t2, err;
      t1 = new G.Framebuffer(_cgl, null, colorTexture, null, null);
    ...
    TypedTextureMutable$: function(cgl, url, _width, _height, _internalFormat, prop, format, datatype, data) {
      var t1, t2;
      t1 = J.createTexture$0$x(cgl._gl);
      J.bindTexture$2$x(cgl._gl, 3553, t1);
      J.texImage2D$9$x(cgl._gl, 3553, 0, _internalFormat, _width, _height, 0, format, datatype, data);
      ...
      return new G.TypedTextureMutable(_width, _height, _internalFormat, url, t1, 3553, cgl, prop);
    },
  ...
  X = {
    main: function() {
      var _box_0, t1, t2, t3, text, t4, fps, canvas, w, h, cgl, t5, t6, t10, t20, programFire, programColor, t7, t8, t9, vertices, uvs, n, normals, gb, i, md, desc, index, fb1, fb2, ug, _i, e;
      _box_0 = {};
      t1 = $.$get$_VarsDb();
      t1.$indexSet(0, "uFlameHeight", C.ShaderVarDesc_float_0);
      t1.$indexSet(0, "uFlameWidth", C.ShaderVarDesc_float_0);
      t1.$indexSet(0, "uFlameTurbulence", C.ShaderVarDesc_float_0);
      t1.$indexSet(0, "uFlameThrottle", C.ShaderVarDesc_float_0);
      t1.$indexSet(0, "uRandomSeed", C.ShaderVarDesc_float_0);
      t2 = document;
      ...
      t5 = $.$get$TexturePropertiesFramebuffer();
      t10 = G.TypedTextureMutable$(cgl, "t1", w, h, 6408, t5, 6408, 5121, null);
      t20 = G.TypedTextureMutable$(cgl, "t2", w, h, 6408, t5, 6408, 5121, null);
      t5 = $.$get$nullVertexShader();
      programFire = G.RenderProgram$("fire", cgl, t5, $.$get$fireFragmentShader());
      programColor = G.RenderProgram$("color", cgl, t5, $.$get$colorFragmentShader());
      ...
      t6 = H.setRuntimeTypeInfo([], [G.Face4]);
      t7 = H.setRuntimeTypeInfo([], t9);
      gb = new G.GeometryBuilder(false, t5, t6, t7, P.LinkedHashMap_LinkedHashMap$_empty(t3, [P.List,,]));
      gb.EnableAttribute$1("aTexUV");
      H.assertSubtype(vertices, "$isList", t9, "$asList");
      i = t7.length;
      C.JSArray_methods.add$1(t6, new G.Face4(i, i + 1, i + 2, i + 3));
      ...
      t5 = programFire._cgl;
      t6 = programFire._shaderObjectV._canonicalToLayoutPos;
      t8 = P.LinkedHashMap_LinkedHashMap$_empty(t3, t4);
      t9 = J.createVertexArray$0$x(t5._gl);
      md = new G.MeshData(t5, t9, 4, t8, t6, -1, P.LinkedHashMap_LinkedHashMap$_empty(t3, P.Float32List), "meshdata:quad");
      t7 = G.FlattenVector3List(t7);
      t8.$indexSet(0, "aPosition", J.createBuffer$0$x(t5._gl));
      md._vertices = t7;
      md.ChangeAttribute$3("aPosition", t7, 3);
      desc = t1.$index(0, "aPosition");
      if (desc == null)
        H.throwExpression("Unknown canonical aPosition");
      index = t6.$index(0, "aPosition");
      J.bindVertexArray$1$x(t5._gl, t9);
      t5.enableVertexAttribArray$2(0, index, 0);
      t5.vertexAttribPointer$7(0, t8.$index(0, "aPosition"), index, desc.GetSize$0(), 5126, false, 0, 0);
      t1 = H.assertSubtype(gb.GenerateFaceIndices$0(), "$isList", [P.int], "$asList");
      md._indexBuffer = J.createBuffer$0$x(t5._gl);
      ...
      t1 = md._indexBuffer;
      t6 = md._faces;
      J.bindBuffer$2$x(t5._gl, 34963, t1);
      J.bufferData$3$x(t5._gl, 34963, t6, 35048);
      G._GeometryBuilderAttributesToMeshData(gb, md);
      fb1 = G.Framebuffer$(cgl, t10);
      fb2 = G.Framebuffer$(cgl, t20);
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t3, t4);
      ug = new G.UniformGroup(t1, "ug");
      t1.$indexSet(0, "uRandomSeed", 0);
      t1.$indexSet(0, "uFlameTurbulence", 0.2);
      t1.$indexSet(0, "uFlameHeight", 3.5);
      t1.$indexSet(0, "uFlameWidth", 1.2);
      t1.$indexSet(0, "uFlameThrottle", 0.248);
      for (t1 = t2.getElementsByTagName("input"), t3 = t1.length, _i = 0; _i < t1.length; t1.length === t3 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
        t4 = J.get$onChange$x(H.interceptedTypeCheck(t1[_i], "$isElement"));
        t5 = H.getTypeArgumentByIndex(t4, 0);
        W._EventStreamSubscription$(t4._target, t4._eventType, H.functionTypeCheck(new X.main_closure(ug), {func: 1, ret: -1, args: [t5]}), false, t5);
      }
      for (t1 = t2.getElementsByTagName("input"), t3 = t1.length, _i = 0; _i < t1.length; t1.length === t3 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
        t4 = H.interceptedTypeCheck(t1[_i], "$isElement");
        e = t2.createEvent("Event");
        e.initEvent("change", true, true);
        t4.dispatchEvent(e);
      }
      _box_0._lastTimeMs = 0;
      _box_0.frame = 0;
      new X.main_animate(_box_0, ug, fb1, w, h, t20, programFire, md, new G.Framebuffer(cgl, null, null, null, null), t10, programColor, fb2, fps).call$1(0);
    },
  ...
  var holders = [C, H, J, P, W, G, R, A, T, X];
          ...
          case 99:
            ...
            switch (t7) {
              ...
              case "cBlendEquation":
                ...
                t7 = val.get$srcFactor();
                t8 = val.get$dstFactor();
  ...
  G.TypedTextureMutable.prototype = {
    toString$0: function(_) {
      return "TypedTextureMutable[" + this._url + ", " + this._internalFormat + ", " + H.S(this._width) + " X " + H.S(this._height) + "]";
    }
  };
  R.Stats.prototype = {
  ...
  X.main_closure.prototype = {
    call$1: function(e) {
      ...
      if (input.type === "range") {
        output = H.interceptedTypeCheck(document.getElementById(J.$add$ansx(input.id, "2")), "$isOutputElement");
        this.ug._uniforms.$indexSet(0, input.id, P.double_parse(input.value));
  ...
  X.main_animate.prototype = {
    call$1: function(timeMs) {
      var _lastTimeMs, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12;
      H.numTypeCheck(timeMs);
      if (typeof timeMs !== "number")
        return timeMs.$add();
      _lastTimeMs = timeMs + 0;
      t1 = this._box_0;
      t1._lastTimeMs = _lastTimeMs;
      ++t1.frame;
      t2 = this.ug;
      t3 = t2._uniforms;
      t3.$indexSet(0, "uRandomSeed", _lastTimeMs);
      t4 = this.w;
      t5 = this.h;
      t6 = this.t2;
      t7 = this.programFire;
      ...
      t9 = this.screen;
      t10 = this.t1;
      t11 = this.programColor;
      t12 = [G.UniformGroup];
      if (C.JSInt_methods.$mod(t1.frame, 2) === 0) {
        this.fb1.Activate$5(17664, 0, 0, t4, t5);
        t3.$indexSet(0, "uTexture", t6);
        t7.Draw$2(t8, H.setRuntimeTypeInfo([t2], t12));
        t9.Activate$5(17664, 0, 0, t4, t5);
        t3.$indexSet(0, "uTexture", t10);
        t11.Draw$2(t8, H.setRuntimeTypeInfo([t2], t12));
      } else {
        this.fb2.Activate$5(17664, 0, 0, t4, t5);
        t3.$indexSet(0, "uTexture", t10);
        t7.Draw$2(t8, H.setRuntimeTypeInfo([t2], t12));
        t9.Activate$5(17664, 0, 0, t4, t5);
        t3.$indexSet(0, "uTexture", t6);
      ...
      this.fps.UpdateFrameCount$2(t1._lastTimeMs, "" + t1.frame);
    },
    $signature: 24
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(W.EventTarget, [W.Node, W.FileWriter, W.SourceBuffer, W._SourceBufferList_EventTarget_ListMixin, W.TextTrack, W.TextTrackCue, W._TextTrackList_EventTarget_ListMixin, W.VideoTrackList, W.Window, P.Request, P.AudioTrackList, P.BaseAudioContext]);
    _inheritMany(W.Node, [W.Element, W.CharacterData, W._Attr]);
    _inheritMany(W.Element, [W.HtmlElement, P.SvgElement]);
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.BaseElement, W.BodyElement, W.CanvasElement, W.DivElement, W.FormElement, W.InputElement, W.OutputElement, W.SelectElement, W.TableElement, W.TableRowElement, W.TableSectionElement, W.TemplateElement]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "nullVertexShader", "$get$nullVertexShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("nullShaderV");
      t2 = [P.String];
      t1.AddAttributeVars$1(H.setRuntimeTypeInfo(["aPosition"], t2));
      t1.SetBody$1(H.setRuntimeTypeInfo(["void main() {\n  gl_Position = vec4(aPosition, 1.0);\n}\n"], t2));
      return t1;
    });
    _lazy($, "fireFragmentShader", "$get$fireFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("fireShaderF");
      t2 = [P.String];
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uTexture", "uFlameThrottle", "uRandomSeed", "uFlameWidth", "uFlameHeight", "uFlameTurbulence"], t2));
