...
(function dartProgram() {
  ...
  P = {
    ...
    _LinkedHashSet: function _LinkedHashSet(t0) {
      ...
      _._last = _._collection$_first = _._rest = _._nums = _._strings = null;
  ...
  T = {
    Matrix3_Matrix3: function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
  ...
  U = {
    RangeOverTime: function(a, b, interval, t) {
      return (b - a) * (0.5 + 0.5 * Math.cos(t)) + a;
    },
    Effect$: function(cgl, shader, uniforms) {
      var t1, t2;
      t1 = uniforms.name;
      t2 = new U.Effect(G.RenderProgram$(t1, cgl, $.$get$effectVertexShader(), shader), uniforms);
      $.$get$Effect_all().$indexSet(0, t1, t2);
      return t2;
    },
    RegisterEffects: function(cgl, fb) {
      var t1, t2, t3, t4, t5;
      t1 = $.$get$copyFragmentShader();
      t2 = P.String;
      t3 = P.Object;
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "none"));
      t4 = $.$get$toonFragmentShader();
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "toon"));
      t1 = $.$get$hexPixelateFragmentShader();
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0.5, 0.5);
      t4.$indexSet(0, "uCenter2", t5);
      t4.$indexSet(0, "uPointSize", 10);
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "hexalate-10"));
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0.5, 0.5);
      t4.$indexSet(0, "uCenter2", t5);
      t4.$indexSet(0, "uPointSize", 20);
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "hexalate-20"));
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0.5, 0.5);
      t4.$indexSet(0, "uCenter2", t5);
      t4.$indexSet(0, "uPointSize", 10);
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "hexalate-varying"));
      t4 = $.$get$dotFragmentShader();
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0, 0);
      t1.$indexSet(0, "uCenter2", t5);
      t1.$indexSet(0, "uScale", 0.8);
      t1.$indexSet(0, "uAngle", 0.5);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "dot"));
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0, 0);
      t1.$indexSet(0, "uCenter2", t5);
      t1.$indexSet(0, "uScale", 0.3);
      t1.$indexSet(0, "uAngle", 0.5);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "dot2"));
      t1 = $.$get$tvDistortionFragmentShader();
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uScale", 0.0009);
      t4.$indexSet(0, "uTime", 0);
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "tv-distortion"));
      t4 = $.$get$kaleidoscopeShader();
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t1.$indexSet(0, "uScale", 8);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0.5, 0.5);
      t1.$indexSet(0, "uCenter2", t5);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "kaleidoscope8"));
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t1.$indexSet(0, "uScale", 5);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0.5, 0.5);
      t1.$indexSet(0, "uCenter2", t5);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "kaleidoscope5"));
      t1 = $.$get$lumidotsFragmentShader();
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uPointSize", 8);
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "lumidots-8"));
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uPointSize", 16);
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "lumidots-16"));
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uPointSize", 16);
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "lumidots-varying"));
      t4 = $.$get$squarePixelateFragmentShader();
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t1.$indexSet(0, "uPointSize", 8);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "square-8"));
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t1.$indexSet(0, "uPointSize", 16);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "square-16"));
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t1.$indexSet(0, "uPointSize", 16);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "square-varying"));
      t1 = $.$get$scanlineFragmentShader();
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(120, 240);
      t4.$indexSet(0, "uRange", t5);
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "scanline"));
      t4 = $.$get$waterFragmentShader();
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "water"));
      t1 = [t2];
      t4 = new G.ShaderObject(H.setRuntimeTypeInfo([], t1), H.setRuntimeTypeInfo([], t1), H.setRuntimeTypeInfo([], t1), H.setRuntimeTypeInfo([], t1), P.LinkedHashMap_LinkedHashMap$_empty(t2, P.int));
      t4.AddUniformVars$1(H.setRuntimeTypeInfo(["uTexture"], t1));
      t4.SetBody$1(H.setRuntimeTypeInfo(["#define MODE 0", "float level1 = 1.0;\nfloat level2 = 0.7;\nfloat level3 = 0.5;\nfloat level4 = 0.3;\n\nfloat dist = 10.0;\nfloat thickness = 0.5;\n\n#if MODE == 0\n// diagonal crosshach\nvec2 slope = vec2(1.0, 1.0);\n#elif MODE == 1\n// regular crosshatch\nvec2 slope = vec2(1.0, 0.0);\n#else\nERROR\n#endif\n\nfloat PixelColor(vec2 pixel, float lum) {\n    if (lum < level1) {\n        // main anti diagonal\n        if (mod(pixel.x * slope.x + pixel.y * slope.y, dist) <= thickness) return 0.0; \n    }  \n  \n    if (lum < level2) { \n        // main diagonal\n        if (mod(pixel.x * slope.y - pixel.y * slope.x, dist) <= thickness) return 0.0;\n    }  \n  \n    if (lum < level3) {\n        // inbetween anti diagonals\n        if (mod(pixel.x * slope.x + pixel.y * slope.y - dist * 0.5, dist) <= thickness) return 0.0;\n    }  \n  \n    if (lum < level4) {\n        // inbetween main diagonals\n        if (mod(pixel.x * slope.y - pixel.y * slope.x - dist * 0.5, dist) <= thickness) return 0.0;\n    } \n    \n    return 1.0;\n}       \n       \nvoid main()  { \n    vec2 pixel = gl_FragCoord.xy;  // this is really pixel + 0.5\n   \n    float lum = dot(vec3(0.2126, 0.7152, 0.0723), \n                    texelFetch(uTexture, ivec2(pixel), 0).rgb);\n    \n    float color = PixelColor(pixel, lum);\n    oFragColor = vec4(vec3(color), 1.0);  \n}      \n\n"], t1));
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "crosshatch"));
      t1 = $.$get$luminosityHighPassFragmentShader();
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0.85, 0.86);
      t4.$indexSet(0, "uRange", t5);
      t4.$indexSet(0, "uColorAlpha", new T.Vector4(new Float32Array(4)));
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "luminosity-highpass"));
      t1 = $.$get$fisheyeFragmentShader();
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "fisheye"));
      t4 = $.$get$filmFragmentShader();
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t1.$indexSet(0, "uTexture", fb);
      U.Effect$(cgl, t4, new G.UniformGroup(t1, "film"));
      t1 = $.$get$convolution3x3FragmentShader();
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uConvolutionMatrix", $.$get$ConvolutionMatrixEmboss());
      t4.$indexSet(0, "uColor", $.$get$ConvolutionOffsetEmboss());
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "emboss"));
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uConvolutionMatrix", $.$get$ConvolutionMatrixEmboss2());
      t4.$indexSet(0, "uColor", $.$get$ConvolutionOffsetEmboss2());
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "emboss2"));
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uConvolutionMatrix", $.$get$ConvolutionMatrixEngrave());
      t4.$indexSet(0, "uColor", $.$get$ConvolutionOffsetEngrave());
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "engrave"));
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uConvolutionMatrix", $.$get$ConvolutionMatrixSharpen());
      t4.$indexSet(0, "uColor", $.$get$ConvolutionOffsetSharpen());
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "sharpen"));
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4.$indexSet(0, "uConvolutionMatrix", $.$get$ConvolutionMatrixEdges());
      t4.$indexSet(0, "uColor", $.$get$ConvolutionOffsetEdges());
      U.Effect$(cgl, t1, new G.UniformGroup(t4, "edges"));
      t3 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t3.$indexSet(0, "uConvolutionMatrix", $.$get$ConvolutionMatrixBlur());
      t3.$indexSet(0, "uColor", $.$get$ConvolutionOffsetBlur());
      U.Effect$(cgl, t1, new G.UniformGroup(t3, "blur"));
      for (t1 = $.$get$Effect_all(), t1 = new H.LinkedHashMapKeyIterable(t1, [H.getTypeArgumentByIndex(t1, 0)]), t1 = t1.get$iterator(t1); t1.moveNext$0();) {
        t2 = t1._current;
        t3 = $.$get$gEffect();
        (t3 && C.SelectElement_methods).insertAdjacentHtml$4$treeSanitizer$validator(t3, "beforeend", "<option>" + H.S(t2) + "</option>", null, null);
      }
    },
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, width, height, cgl, t5, t6, t7, t8, t9, orbit, perspective, fb, err, progDemo, vertices, uvs, n, normals, gb, unitQuad, cosAngle, sinAngle, t10, t11, t12, t13, t14;
      t1 = {};
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(15, -45, 0.3, 0, new T.Vector3(t4), -0.02, t5, t6, t7, new T.Vector3(t8), new T.Vector3(t9), "camera:orbit");
      ...
      t4 = $.$get$TexturePropertiesFramebuffer();
      t5 = G.TypedTexture$(cgl, "frame::color", width, height, 32856, t4);
      t4 = G.TypedTexture$(cgl, "frame::depth", width, height, 33190, t4);
      fb = new G.Framebuffer(cgl, null, t5, t4, null);
      t6 = J.createFramebuffer$0$x(cgl._gl);
      fb._framebuffer = t6;
      J.bindFramebuffer$2$x(cgl._gl, 36160, t6);
      J.framebufferTexture2D$5$x(cgl._gl, 36160, 36064, 3553, t5._texture, 0);
      J.framebufferTexture2D$5$x(cgl._gl, 36160, 36096, 3553, t4._texture, 0);
      ...
      U.RegisterEffects(cgl, t5);
      progDemo = G.RenderProgram$("demo", cgl, $.$get$demoVertexShader(), $.$get$demoFragmentShader());
      t4 = $.$get$Effect_all().$index(0, "dot").program;
      ...
      t7.setValues$3(1, 1, 0);
      t8 = new T.Vector3(new Float32Array(3));
      t8.setValues$3(-1, 1, 0);
      t9 = [T.Vector3];
      vertices = H.setRuntimeTypeInfo([t5, t6, t7, t8], t9);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0, 0);
      ...
      t8.setValues$2(0, 1);
      uvs = H.setRuntimeTypeInfo([t5, t6, t7, t8], [T.Vector2]);
      n = new T.Vector3(new Float32Array(3));
      n.setValues$3(0, 0, 1);
      normals = H.setRuntimeTypeInfo([n, n, n, n], t9);
      gb = new G.GeometryBuilder(false, H.setRuntimeTypeInfo([], [G.Face3]), H.setRuntimeTypeInfo([], [G.Face4]), H.setRuntimeTypeInfo([], t9), P.LinkedHashMap_LinkedHashMap$_empty(t2, [P.List,,]));
      gb.EnableAttribute$1("aTexUV");
      gb.AddVerticesFace4$1(vertices);
      gb.AddAttributesVector2$2("aTexUV", uvs);
      gb.EnableAttribute$1("aNormal");
      gb.AddAttributesVector3$2("aNormal", normals);
      unitQuad = G.GeometryBuilderToMeshData("quad", t4, gb);
      t1.ctLogo = null;
      ...
      t2.$indexSet(0, "uColor", $.$get$ColorGray8());
      ...
      t13 = t4[11];
      t14 = -sinAngle;
      t4[4] = t6 * cosAngle + t7 * sinAngle;
      t4[5] = t8 * cosAngle + t9 * sinAngle;
      t4[6] = t10 * cosAngle + t11 * sinAngle;
      t4[7] = t12 * cosAngle + t13 * sinAngle;
      t4[8] = t6 * t14 + t7 * cosAngle;
      t4[9] = t8 * t14 + t9 * cosAngle;
      t4[10] = t10 * t14 + t11 * cosAngle;
      t4[11] = t12 * t14 + t13 * cosAngle;
      t2.$indexSet(0, "uModelMatrix", t5);
      t1._lastTimeMs = 0;
      P.Future_wait(H.setRuntimeTypeInfo([D.LoadRaw("../ct_logo.obj")], [[P.Future, P.Object]]), t3).then$1$1(new U.main_closure(t1, progDemo, new U.main_animate(t1, orbit, fb, width, height, progDemo, perspective, new G.Material(t2, "mat"), new G.Framebuffer(cgl, null, null, null, null), unitQuad, fps)), null);
    },
    Effect: function Effect(t0, t1) {
      this.program = t0;
      this.uniforms = t1;
    },
    main_animate: function main_animate(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) {
      var _ = this;
      _._box_0 = t0;
      _.orbit = t1;
      _.fb = t2;
  ...
  Y = {
    ImportGeometryFromWavefront: function(text) {
      var t1, t2, t3, t4, t5, gb, groups, lines, vertices, normals, uvs, sep, trail, t6, _i, line2, t7, line, array, t8, t9, t10, faceVertices, faceNormal, faceUvs, i, f, vtx, tex, nor;
      ...
      for (t6 = lines.length, _i = 0; _i < lines.length; lines.length === t6 || (0, H.throwConcurrentModificationError)(lines), ++_i) {
        line2 = lines[_i];
        line2.toString;
        t7 = H.stringReplaceAllUnchecked(line2, sep, " ");
        line = H.stringReplaceFirstUnchecked(t7, trail, "", 0);
        t7 = line.length;
        if (t7 !== 0) {
          if (0 >= t7)
        ...
        if (J.$eq$(t8, "g")) {
          ...
          if (1 >= t7)
            return H.ioore(array, 1);
          t8 = P.double_parse(array[1]);
          if (2 >= t7)
            return H.ioore(array, 2);
          t9 = P.double_parse(array[2]);
          if (3 >= t7)
            return H.ioore(array, 3);
          t7 = P.double_parse(array[3]);
          t10 = new Float32Array(3);
          C.NativeFloat32List_methods.$indexSet(t10, 0, t8);
          C.NativeFloat32List_methods.$indexSet(t10, 1, t9);
          C.NativeFloat32List_methods.$indexSet(t10, 2, t7);
          C.JSArray_methods.add$1(vertices, new T.Vector3(t10));
        } else if (J.$eq$(t8, "vt")) {
          if (1 >= t7)
            return H.ioore(array, 1);
          t8 = P.double_parse(array[1]);
          if (2 >= t7)
            return H.ioore(array, 2);
          t7 = P.double_parse(array[2]);
          t9 = new Float32Array(2);
          C.NativeFloat32List_methods.$indexSet(t9, 0, t8);
          C.NativeFloat32List_methods.$indexSet(t9, 1, t7);
          C.JSArray_methods.add$1(uvs, new T.Vector2(t9));
        } else if (J.$eq$(t8, "vn")) {
          if (1 >= t7)
            return H.ioore(array, 1);
          t8 = P.double_parse(array[1]);
          ...
          C.NativeFloat32List_methods.$indexSet(t10, 1, t9);
          C.NativeFloat32List_methods.$indexSet(t10, 2, t7);
          C.JSArray_methods.add$1(normals, new T.Vector3(t10));
        } else if (J.$eq$(t8, "f")) {
          if (t7 !== 4 && t7 !== 5) {
          ...
          for (i = 1; t7 = array.length, i < t7; ++i) {
          ...
          if (t7 === 4) {
            ...
            gb.AddVerticesFace4$1(faceVertices);
          gb.AddAttributesVector3$2("aNormal", faceNormal);
          gb.AddAttributesVector2$2("aTexUV", faceUvs);
        }
      }
      P.print("loaded (" + P.Duration$(Date.now() - new P.DateTime(t2, false)._value, 0).toString$0(0) + ") " + gb.toString$0(0));
      return gb;
    }
  };
  var holders = [C, H, J, P, W, G, R, D, A, T, U, Y];
  ...
  G.GeometryBuilder.prototype = {
    ...
    AddVerticesFace4$1: function(vs) {
      var i;
      H.assertSubtype(vs, "$isList", [T.Vector3], "$asList");
      i = this.vertices.length;
      C.JSArray_methods.add$1(this._faces4, new G.Face4(i, i + 1, i + 2, i + 3));
      this.AddVertices$1(vs);
    },
  ...
  G.RenderProgram.prototype = {
    ...
    Draw$2: function(md, uniforms) {
      ...
      if (t2.__js_helper$_length > 0) {
        t2.__js_helper$_last = null;
        t2._first = null;
        t2.__js_helper$_rest = null;
        t2.__js_helper$_nums = null;
        t2.__js_helper$_strings = null;
        t2.__js_helper$_length = 0;
        t2.__js_helper$_modified$0();
      }
  ...
  G.ShaderObject.prototype = {
    AddAttributeVars$1: function(names) {
      ...
      for (t1 = this.attributeVars, t2 = this._canonicalToLayoutPos, _i = 0; _i < 1; ++_i) {
        n = names[_i];
  ...
  G.TypedTexture.prototype = {
    toString$0: function(_) {
      return "TypedTexture[" + this._url + ", " + this._internalFormat + ", " + H.S(this._width) + " X " + H.S(this._height) + "]";
    }
  };
  R.Stats.prototype = {
  ...
  U.Effect.prototype = {};
  U.main_animate.prototype = {
    call$1: function(timeMs) {
      var t1, t2, t3, t4, t5, t6, t7, rcp, t8, t9, up, z, x, y, t10, t11, t12, t13, t14, t15, t16, t17, len, c, s, $C, m11, m12, m13, m21, m22, m23, m31, m32, m33, active, timeSec;
      ...
      t7 = t9[7];
      t8 = t9[11];
      t9[0] = t2 * m11 + t13 * m21 + t11 * m31;
      t9[1] = t14 * m11 + t15 * m21 + t16 * m31;
      t9[2] = t17 * m11 + t10 * m21 + t12 * m31;
      t9[3] = t6 * m11 + t7 * m21 + t8 * m31;
      t9[4] = t2 * m12 + t13 * m22 + t11 * m32;
      t9[5] = t14 * m12 + t15 * m22 + t16 * m32;
      t9[6] = t17 * m12 + t10 * m22 + t12 * m32;
      t9[7] = t6 * m12 + t7 * m22 + t8 * m32;
      t9[8] = t2 * m13 + t13 * m23 + t11 * m33;
      t9[9] = t14 * m13 + t15 * m23 + t16 * m33;
      t9[10] = t17 * m13 + t10 * m23 + t12 * m33;
      t9[11] = t6 * m13 + t7 * m23 + t8 * m33;
      ...
      active = $.$get$Effect_all().$index(0, $.$get$gEffect().value);
      timeSec = timeMs / 1000;
      t2 = $.$get$gEffect().value;
      if (t2 === "tv-distortion")
        active.uniforms._uniforms.$indexSet(0, "uTime", timeSec);
      else if (t2 === "hexalate-varying")
        active.uniforms._uniforms.$indexSet(0, "uPointSize", U.RangeOverTime(4, 30, 20, timeSec));
      else if (t2 === "square-varying")
        active.uniforms._uniforms.$indexSet(0, "uPointSize", U.RangeOverTime(4, 30, 20, timeSec));
      else if (t2 === "lumidots-varying")
        active.uniforms._uniforms.$indexSet(0, "uPointSize", U.RangeOverTime(4, 30, 20, timeSec));
      else if (t2 === "water")
        active.uniforms._uniforms.$indexSet(0, "uTime", t1._lastTimeMs / 1000);
      t2 = this.width;
      t3 = this.height;
      this.fb.Activate$5(17664, 0, 0, t2, t3);
      t4 = [G.UniformGroup];
      this.progDemo.Draw$2(t1.ctLogo, H.setRuntimeTypeInfo([this.perspective, this.material], t4));
      this.screen.Activate$5(17664, 0, 0, t2, t3);
      active.program.Draw$2(this.unitQuad, H.setRuntimeTypeInfo([active.uniforms], t4));
  ...
  U.main_closure.prototype = {
    call$1: function(list) {
      this._box_0.ctLogo = G.GeometryBuilderToMeshData("", this.progDemo, Y.ImportGeometryFromWavefront(H.stringTypeCheck(J.$index$asx(H.listTypeCheck(list), 0))));
  ...
  (function inheritance() {
    ...
    _inheritMany(W.EventTarget, [W.Node, W.FileWriter, W.HttpRequestEventTarget, W.SourceBuffer, W._SourceBufferList_EventTarget_ListMixin, W.TextTrack, W.TextTrackCue, W._TextTrackList_EventTarget_ListMixin, W.VideoTrackList, W.Window, P.AudioTrackList, P.BaseAudioContext]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "ConvolutionMatrixEmboss", "$get$ConvolutionMatrixEmboss", function() {
      return T.Matrix3_Matrix3(-1, 0, -1, 0, 4, 0, -1, 0, -1);
    });
    _lazy($, "ConvolutionOffsetEmboss", "$get$ConvolutionOffsetEmboss", function() {
      return T.Vector3_Vector3(0.5, 0.5, 0.5);
    });
    _lazy($, "ConvolutionMatrixEmboss2", "$get$ConvolutionMatrixEmboss2", function() {
      return T.Matrix3_Matrix3(2, 0, 0, 0, -1, 0, 0, 0, -1);
    });
    _lazy($, "ConvolutionOffsetEmboss2", "$get$ConvolutionOffsetEmboss2", function() {
      return T.Vector3_Vector3(0.5, 0.5, 0.5);
    });
    _lazy($, "ConvolutionMatrixEngrave", "$get$ConvolutionMatrixEngrave", function() {
      return T.Matrix3_Matrix3(-2, 0, 0, 0, 2, 0, 0, 0, 0);
    });
    _lazy($, "ConvolutionOffsetEngrave", "$get$ConvolutionOffsetEngrave", function() {
      return T.Vector3_Vector3(0.37, 0.37, 0.37);
    });
    _lazy($, "ConvolutionMatrixSharpen", "$get$ConvolutionMatrixSharpen", function() {
      var t1 = T.Matrix3_Matrix3(0, -2, 0, -2, 11, -2, 0, -2, 0);
      t1.scale$1(0, 0.333);
      return t1;
    });
    _lazy($, "ConvolutionOffsetSharpen", "$get$ConvolutionOffsetSharpen", function() {
      return T.Vector3_Vector3(0, 0, 0);
    });
    _lazy($, "ConvolutionMatrixEdges", "$get$ConvolutionMatrixEdges", function() {
      return T.Matrix3_Matrix3(-1, -1, -1, -1, 8, -1, -1, -1, -1);
    });
    _lazy($, "ConvolutionOffsetEdges", "$get$ConvolutionOffsetEdges", function() {
      return T.Vector3_Vector3(0, 0, 0);
    });
    _lazy($, "ConvolutionMatrixBlur", "$get$ConvolutionMatrixBlur", function() {
      var t1 = T.Matrix3_Matrix3(1, 2, 1, 2, 4, 2, 1, 2, 1);
      t1.scale$1(0, 0.0625);
      return t1;
    });
    _lazy($, "ConvolutionOffsetBlur", "$get$ConvolutionOffsetBlur", function() {
      return T.Vector3_Vector3(0, 0, 0);
    });
    _lazy($, "convolution3x3FragmentShader", "$get$convolution3x3FragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("Convolution3x3F");
      t2 = [P.String];
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uTexture", "uColor", "uConvolutionMatrix"], t2));
      t1.SetBody$1(H.setRuntimeTypeInfo(["void main() {\n    mat3 m = uConvolutionMatrix;\n    ivec2 center = ivec2(gl_FragCoord.xy);\n    vec3 sum = vec3(0.0, 0.0, 0.0);\n    for (int x = -1; x <= 1; x++) {\n      for (int y = -1; y <= 1; y++) {\n        sum += m[x+1][y+1] * texelFetch(uTexture, center + ivec2(x, y), 0).rgb;     \n      }\n    }\n    oFragColor.rgb = uColor + sum;\n}\n\n"], t2));
      return t1;
    });
    _lazy($, "scanlineFragmentShader", "$get$scanlineFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("ScanlinePixelateF");
      t2 = [P.String];
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uTexture", "uRange"], t2));
    ...
    _lazy($, "gEffect", "$get$gEffect", function() {
      return H.interceptedTypeCast(W.document().querySelector("#effect"), "$isSelectElement");
    });
    _lazy($, "Effect_all", "$get$Effect_all", function() {
      return P.LinkedHashMap_LinkedHashMap$_empty(P.String, U.Effect);
    });
  })();
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: -1, args: [P.String,,]}, {func: 1, ret: P.Null, args: [W.MouseEvent]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, args: [,]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: -1, args: [,]}, {func: 1, ret: P.Null, args: [W.KeyboardEvent]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [, P.StackTrace]}, {func: 1, ret: P.Null, args: [,], opt: [P.StackTrace]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, ret: -1, args: [P.String, P.String]}, {func: 1, ret: P.Null, args: [P.num]}, {func: 1, args: [W.Event]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, args: [,,]}, {func: 1, ret: P.Null, args: [W.ProgressEvent]}, {func: 1, ret: P.Null, args: [W.WheelEvent]}, {func: 1, ret: P.int, args: [P.int, P.Object]}, {func: 1, ret: -1, args: [P.num]}, {func: 1, ret: P.Null, args: [[P.List,,]]}, {func: 1, ret: P.int, args: [,,]}], interceptorsByTag: null, leafTags: null};
