...
(function dartProgram() {
  ...
  G = {
    ...
    CubeTexture$: function(cgl, url, images) {
      var t1 = new G.TextureProperties(1, 9729, 9729);
      t1.clamp = true;
      t1 = new G.CubeTexture(url, J.createTexture$0$x(cgl._gl), 34067, cgl, t1);
      t1.CubeTexture$3(cgl, url, images);
      return t1;
    },
    ...
    CubeTexture: function CubeTexture(t0, t1, t2, t3, t4) {
      var _ = this;
      _._url = t0;
      _._texture = t1;
      _._textureType = t2;
  ...
  R = {
    ...
    ShapeCube: function(prog, x, y, z) {
      var gb, md, t1, t2, t3;
      gb = B.CubeGeometry(1, 0, 1, 0, x, y, z);
      md = G.MeshData$("cube", prog._cgl, 4, prog._shaderObjectV._canonicalToLayoutPos);
  ...
  D = {
    LoadCubeImages: function(urlPrefix, urlSuffix) {
      var t1, out, t2, t3, t4, i, t5, t6, e, t7;
      t1 = new Array(6);
      t1.fixed$length = Array;
      out = H.setRuntimeTypeInfo(t1, [[P.Future, W.ImageElement]]);
      for (t1 = [W.Event], t2 = -1, t3 = W.ImageElement, t4 = [t3], t3 = [t3], i = 0; t5 = $.$get$_kUrlInfix(), i < 6; ++i) {
        t6 = new P._Future(0, $.Zone__current, t4);
        e = document.createElement("img");
        t7 = new W._ElementEventStreamImpl(e, "load", false, t1);
        t7.get$first(t7).then$1$1(new D.LoadCubeImages_closure(new P._AsyncCompleter(t6, t3), e), t2);
        e.src = urlPrefix + t5[i] + urlSuffix;
        C.JSArray_methods.$indexSet(out, i, t6);
      }
      return out;
    },
    ...
    LoadCubeImages_closure: function LoadCubeImages_closure(t0, t1) {
      this.c = t0;
      this.image = t1;
    },
  ...
  M = {
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, t10, orbit, perspective, progCube, mat, mdCube, mdSky, progStars, e, ctx, gradient, mdStars;
      t1 = {};
      t2 = document;
      ...
      t6.setIdentity$0();
      perspective = new R.PerspectiveResizeAware(canvas, cgl, orbit, 50, 1, 0.1, 1000, t5, t6, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t3, t4), "perspective");
      perspective.Update$0();
      perspective.resolutionChange$1(null);
      t5 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(perspective.get$resolutionChange(), {func: 1, ret: -1, args: [t5]}), false, t5);
      progCube = G.RenderProgram$("solid", cgl, $.$get$cubeMapVertexShader(), $.$get$cubeMapFragmentShader());
      t5 = P.LinkedHashMap_LinkedHashMap$_empty(t3, t4);
      mat = new G.Material(t5, "cubemap");
      t5.$indexSet(0, "cDepthTest", true);
      t5.$indexSet(0, "cDepthWrite", true);
      t5.$indexSet(0, "cBlendEquation", $.$get$BlendEquationNone());
      t6 = $.$get$StencilFunctionNone();
      t5.$indexSet(0, "cStencilFunc", t6);
      t7 = new T.Matrix4(new Float32Array(16));
      t7.setIdentity$0();
      t5.$indexSet(0, "uModelMatrix", t7);
      mdCube = R.ShapeCube(progCube, 2, 2, 2);
      mdSky = R.ShapeCube(progCube, 512, 512, 512);
      progStars = G.RenderProgram$("stars", cgl, $.$get$pointSpritesVertexShader(), $.$get$pointSpritesFragmentShader());
      t7 = $.$get$BlendEquationMix();
      t3 = P.LinkedHashMap_LinkedHashMap$_empty(t3, t4);
      t3.$indexSet(0, "cDepthTest", true);
      t3.$indexSet(0, "cDepthWrite", false);
      t3.$indexSet(0, "cBlendEquation", t7);
      t3.$indexSet(0, "cStencilFunc", t6);
      ...
      ctx.fill();
      t2 = new G.TextureProperties(1, 9729, 9729);
      ...
      t2.InstallLate$2(cgl, 3553);
      J.getError$0$x(cgl._gl);
      J.bindTexture$2$x(cgl._gl, 3553, null);
      t3.$indexSet(0, "uTexture", new G.ImageTexture(e, "Utils::Particles", t5, 3553, cgl, t2));
      t3.$indexSet(0, "uPointSize", 1000);
      t2 = new T.Matrix4(new Float32Array(16));
      t2.setIdentity$0();
      t3.$indexSet(0, "uModelMatrix", t2);
      mdStars = R.Utils_MakeStarMesh(progStars, 2000, 100);
      t1._lastTimeMs = 0;
      P.Future_wait(D.LoadCubeImages("skybox_", ".png"), t4).then$1$1(new M.main_closure(cgl, mat, new M.main_animate(t1, orbit, progCube, mdCube, mat, perspective, mdSky, progStars, mdStars, new G.Material(t3, "stars"), fps)), null);
    },
  ...
  var holders = [C, H, J, P, W, G, R, D, A, T, M, B];
  ...
  G.TextureProperties.prototype = {
    InstallLate$2: function(cgl, type) {
      ...
      J.texParameteri$3$x(cgl._gl, type, 10240, this.magFilter);
      J.texParameteri$3$x(cgl._gl, type, 10241, this.minFilter);
      if (this.clamp) {
  ...
  G.CubeTexture.prototype = {
    CubeTexture$3: function(cgl, url, images) {
      var t1, t2, t3, i, t4, t5;
      t1 = this._cgl;
      J.pixelStorei$2$x(t1._gl, 37440, 1);
      t2 = this._textureType;
      J.bindTexture$2$x(t1._gl, t2, this._texture);
      for (t3 = J.getInterceptor$asx(images), i = 0; i < 6; ++i) {
        t4 = C.List_6kr[i];
        t5 = t3.$index(images, i);
        J.texImage2D$6$x(t1._gl, t4, 0, 6408, 6408, 5121, t5);
      }
      t3 = this.properties;
      t3.InstallLate$2(t1, t2);
      J.getError$0$x(t1._gl);
      J.bindTexture$2$x(t1._gl, t2, null);
      t3.clamp = true;
    }
  };
  ...
  D.LoadCubeImages_closure.prototype = {
    call$1: function(_) {
  ...
  M.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      t8 = this.perspective;
      t7 = [G.UniformGroup];
      t3.Draw$2(this.mdCube, H.setRuntimeTypeInfo([t4, t8], t7));
      t3.Draw$2(this.mdSky, H.setRuntimeTypeInfo([t4, t8], t7));
      this.progStars.Draw$2(this.mdStars, H.setRuntimeTypeInfo([this.matStars, t8], t7));
  ...
  M.main_closure.prototype = {
    call$1: function(list) {
      this.mat._uniforms.$indexSet(0, "uCubeTexture", G.CubeTexture$(this.cgl, "stars", H.listTypeCheck(list)));
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(R.PerspectiveResizeAware.prototype, "get$resolutionChange", "resolutionChange$1", 11);
  })();
  (function inheritance() {
    ...
    _inheritMany(G.Texture, [G.ImageTexture, G.CubeTexture]);
...
;
    ...
    C.List_6kr = H.setRuntimeTypeInfo(makeConstList([34070, 34069, 34072, 34071, 34074, 34073]), [P.int]);
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "cubeMapVertexShader", "$get$cubeMapVertexShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("CubeMap");
      t2 = [P.String];
      t1.AddAttributeVars$1(H.setRuntimeTypeInfo(["aPosition"], t2));
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vPosition"], t2));
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uPerspectiveViewMatrix", "uModelMatrix"], t2));
      t1.SetBodyWithMain$1(H.setRuntimeTypeInfo(["gl_Position = uPerspectiveViewMatrix * uModelMatrix * vec4(aPosition, 1.0);", "vPosition = normalize(aPosition);"], t2));
      return t1;
    });
    _lazy($, "cubeMapFragmentShader", "$get$cubeMapFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("CubeMapF");
      t2 = [P.String];
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vPosition"], t2));
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uCubeTexture"], t2));
      t1.SetBodyWithMain$1(H.setRuntimeTypeInfo(["oFragColor = texture( uCubeTexture, vPosition );"], t2));
      return t1;
    });
