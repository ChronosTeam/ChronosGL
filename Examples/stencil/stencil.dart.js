...
(function dartProgram() {
  ...
  G = {
    ...
    TheStencilFunction$: function(func, value, mask) {
      return new G.TheStencilFunction(func, value, mask);
    },
  ...
  A = {
    ...
    RenderPhase$: function($name, _cgl, _framebuffer) {
      ...
      if (_framebuffer == null)
        t1._lib$_framebuffer = new G.Framebuffer(_cgl, null, null, null, null);
      return t1;
    },
  ...
  V = {
    MakeStripedStencilBuffer: function(cgl, width, height, stripeWidth) {
      var data, t1, t2, x, t3, y, t4, t5;
      if (typeof width !== "number")
        return width.$mul();
      if (typeof height !== "number")
        return H.iae(height);
      data = new Uint32Array(width * height);
      for (t1 = data.length, t2 = 2 * stripeWidth, x = 0; x < width; ++x)
        for (t3 = x % t2 < stripeWidth, y = 0; y < height; ++y) {
          t4 = y * width + x;
          t5 = t3 ? 0 : 1;
          if (t4 < 0 || t4 >= t1)
      ...
      J.texImage2D$9$x(cgl._gl, 3553, 0, 35056, width, height, 0, 34041, 34042, data);
      t1.InstallLate$2(cgl, 3553);
      J.getError$0$x(cgl._gl);
      J.bindTexture$2$x(cgl._gl, 3553, null);
      return new G.TypedTextureMutable(width, height, 35056, "frame::depth.stencil", t2, 3553, cgl, t1);
    },
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, t10, orbit, perspective, width, height, colorBuffer, depthStencilBuffer, fb, err, phase, matRed, StencilEqualOne, matBlueStencil, t11, t12, t13, t14, phase2, vertices, uvs, n, normals, gb, i, UnitQuad;
      t1 = {};
      t2 = document;
      ...
      t6 = J.createTexture$0$x(t4);
      colorBuffer = new G.TypedTexture(width, height, 32856, "frame::color", t6, 3553, cgl, t5);
      J.bindTexture$2$x(t4, 3553, t6);
      J.texStorage2D$5$x(cgl._gl, 3553, 1, 32856, width, height);
      t5.InstallLate$2(cgl, 3553);
      J.getError$0$x(cgl._gl);
      J.bindTexture$2$x(cgl._gl, 3553, null);
      depthStencilBuffer = V.MakeStripedStencilBuffer(cgl, width, height, 8);
      fb = new G.Framebuffer(cgl, null, colorBuffer, depthStencilBuffer, null);
      t5 = J.createFramebuffer$0$x(cgl._gl);
      fb._framebuffer = t5;
      J.bindFramebuffer$2$x(cgl._gl, 36160, t5);
      J.framebufferTexture2D$5$x(cgl._gl, 36160, 36064, 3553, t6, 0);
      J.framebufferTexture2D$5$x(cgl._gl, 36160, 33306, 3553, depthStencilBuffer._texture, 0);
      ...
      phase = A.RenderPhase$("main", cgl, fb);
      phase.viewPortW = width;
      phase.viewPortH = height;
      phase._clear_mode &= 4294966271;
      ...
      C.JSArray_methods.add$1(phase._scenes, new A.Scene(t4, t6, t8, "solid"));
      matRed = G.Material$("red");
      t6 = matRed._uniforms;
      t6.$indexSet(0, "uColor", $.$get$ColorRed());
      t6.$indexSet(0, "cStencilFunc", $.$get$StencilFunctionNone());
      StencilEqualOne = new G.TheStencilFunction(514, 1, 255);
      matBlueStencil = G.Material$("blue");
      t6 = matBlueStencil._uniforms;
      t6.$indexSet(0, "uColor", $.$get$ColorBlue());
      t6.$indexSet(0, "cStencilFunc", StencilEqualOne);
      t6 = G.GeometryBuilderToMeshData("icosahedron-3", t4, B.IcosahedronGeometry(true, 1, 3));
      ...
      new Float32Array(3);
      new Float32Array(3);
      t6 = new A.Node(matRed, t6, t9, new T.Matrix3(t10), t11, t12, new T.Vector3(t13), new T.Vector3(t14), "sphere");
      t6.setPos$3(0, 0, 0);
      C.JSArray_methods.add$1(t8, t6);
      t6 = G.GeometryBuilderToMeshData("cube", t4, B.CubeGeometry(1, 0, 1, 0, 1, 1, 1));
      t9 = H.setRuntimeTypeInfo([], t7);
      t10 = new Float32Array(9);
      t11 = new T.Matrix4(new Float32Array(16));
      t11.setIdentity$0();
      ...
      new Float32Array(3);
      new Float32Array(3);
      t6 = new A.Node(matBlueStencil, t6, t9, new T.Matrix3(t10), t11, t12, new T.Vector3(t13), new T.Vector3(t14), "cube");
      t6.setPos$3(-5, 0, -5);
      C.JSArray_methods.add$1(t8, t6);
      t6 = G.GeometryBuilderToMeshData("cylinder-32", t4, B.CylinderGeometry(1, 3, 2, 32, true));
      t9 = H.setRuntimeTypeInfo([], t7);
      t10 = new Float32Array(9);
      t11 = new T.Matrix4(new Float32Array(16));
      t11.setIdentity$0();
      ...
      new Float32Array(3);
      new Float32Array(3);
      t6 = new A.Node(matRed, t6, t9, new T.Matrix3(t10), t11, t12, new T.Vector3(t13), new T.Vector3(t14), "cylinder");
      t6.setPos$3(5, 0, -5);
      C.JSArray_methods.add$1(t8, t6);
      t4 = G.GeometryBuilderToMeshData("torusknot", t4, B.TorusKnotGeometry(true, 1, 2, 3, 1, 128, 16, 0.4));
      t6 = H.setRuntimeTypeInfo([], t7);
      ...
      new Float32Array(3);
      new Float32Array(3);
      t4 = new A.Node(matBlueStencil, t4, t6, new T.Matrix3(t9), t10, t11, new T.Vector3(t12), new T.Vector3(t13), "torus");
      t4.setPos$3(5, 0, 5);
      C.JSArray_methods.add$1(t8, t4);
      phase2 = A.RenderPhase$("copy", cgl, null);
      ...
      if (typeof height !== "number")
        return H.iae(height);
      t4 = new T.Vector2(new Float32Array(2));
      t4.setValues$2(width, height);
      t3.$indexSet(0, "uCanvasSize", t4);
      t3.$indexSet(0, "uTexture", colorBuffer);
      t4 = G.RenderProgram$("postproc", cgl, $.$get$copyVertexShader(), $.$get$copyFragmentShader());
      t5 = H.setRuntimeTypeInfo([new G.UniformGroup(t3, "plain")], t5);
      t3 = H.setRuntimeTypeInfo([], t7);
      C.JSArray_methods.add$1(phase2._scenes, new A.Scene(t4, t5, t3, "postproc"));
      t5 = new T.Vector3(new Float32Array(3));
      ...
      t10 = [T.Vector3];
      vertices = H.setRuntimeTypeInfo([t5, t6, t8, t9], t10);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0, 0);
      t6 = new T.Vector2(new Float32Array(2));
      t6.setValues$2(1, 0);
      ...
      t9 = new T.Vector2(new Float32Array(2));
      t9.setValues$2(0, 1);
      uvs = H.setRuntimeTypeInfo([t5, t6, t8, t9], [T.Vector2]);
      n = new T.Vector3(new Float32Array(3));
      n.setValues$3(0, 0, 1);
      normals = H.setRuntimeTypeInfo([n, n, n, n], t10);
      t5 = H.setRuntimeTypeInfo([], [G.Face3]);
      t6 = H.setRuntimeTypeInfo([], [G.Face4]);
      t8 = H.setRuntimeTypeInfo([], t10);
      gb = new G.GeometryBuilder(false, t5, t6, t8, P.LinkedHashMap_LinkedHashMap$_empty(t2, [P.List,,]));
      gb.EnableAttribute$1("aTexUV");
      H.assertSubtype(vertices, "$isList", t10, "$asList");
      i = t8.length;
      ...
      new Float32Array(3);
      new Float32Array(3);
      C.JSArray_methods.add$1(t3, new A.Node(t4, UnitQuad, t7, new T.Matrix3(t2), t5, t6, new T.Vector3(t8), new T.Vector3(t9), "unit-mesh"));
      t1._lastTimeMs = 0;
      new V.main_animate(t1, orbit, matBlueStencil, StencilEqualOne, phase, phase2, fps).call$1(0);
    },
  ...
  G.TypedTextureMutable.prototype = {
    toString$0: function(_) {
      return "TypedTextureMutable[" + this._url + ", " + this._internalFormat + ", " + this._width + " X " + H.S(this._height) + "]";
    }
  };
  R.Stats.prototype = {
  ...
  V.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      t2 = $.$get$gStencil().checked ? this.StencilEqualOne : $.$get$StencilFunctionNone();
      this.matBlueStencil._uniforms.$indexSet(0, "cStencilFunc", t2);
      stats = H.setRuntimeTypeInfo([], [G.DrawStats]);
      this.phase.Draw$1(stats);
      this.phase2.Draw$1(stats);
      out = H.setRuntimeTypeInfo([], [P.String]);
  ...
  (function inheritance() {
    ...
    _inheritMany(G.Texture, [G.TypedTexture, G.TypedTextureMutable]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "StencilFunctionNone", "$get$StencilFunctionNone", function() {
      return G.TheStencilFunction$(1281, 0, 4294967295);
    });
    ...
    _lazy($, "copyVertexShader", "$get$copyVertexShader", function() {
      return $.$get$effectVertexShader();
    });
    ...
    _lazy($, "gStencil", "$get$gStencil", function() {
      return H.interceptedTypeCast(W.document().querySelector("#stencil"), "$isInputElement");
    });
  })();
