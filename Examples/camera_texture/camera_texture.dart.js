...
(function dartProgram() {
  ...
  U = {
    main2: function(video) {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, orbit, perspective, program, gb, md, desc, index, texture;
      t1 = {};
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(15, 10, 0, 0, new T.Vector3(t4), -0.02, t5, t6, t7, new T.Vector3(t8), new T.Vector3(t9), "camera:orbit");
      ...
      program = G.RenderProgram$("solid", cgl, $.$get$texturedVertexShader(), $.$get$texturedFragmentShader());
      gb = B.CubeGeometry(1, 0, 1, 0, 1, 1, 1);
      t4 = program._cgl;
      t5 = program._shaderObjectV._canonicalToLayoutPos;
      t6 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t7 = J.createVertexArray$0$x(t4._gl);
      md = new G.MeshData(t4, t7, 4, t6, t5, -1, P.LinkedHashMap_LinkedHashMap$_empty(t2, P.Float32List), "meshdata:cube");
      t8 = G.FlattenVector3List(gb.vertices);
      t6.$indexSet(0, "aPosition", J.createBuffer$0$x(t4._gl));
      md._vertices = t8;
      md.ChangeAttribute$3("aPosition", t8, 3);
      desc = $.$get$_VarsDb().$index(0, "aPosition");
      if (desc == null)
        H.throwExpression("Unknown canonical aPosition");
      index = t5.$index(0, "aPosition");
      J.bindVertexArray$1$x(t4._gl, t7);
      t4.enableVertexAttribArray$2(0, index, 0);
      t4.vertexAttribPointer$7(0, t6.$index(0, "aPosition"), index, desc.GetSize$0(), 5126, false, 0, 0);
      t5 = H.assertSubtype(gb.GenerateFaceIndices$0(), "$isList", [P.int], "$asList");
      md._indexBuffer = J.createBuffer$0$x(t4._gl);
      t6 = md._vertices.length;
      if (t6 < 768) {
        md.set$_faces(new Uint8Array(H._ensureNativeList(t5)));
        md._indexBufferType = 5121;
      } else if (t6 < 196608) {
        md.set$_faces(new Uint16Array(H._ensureNativeList(t5)));
        md._indexBufferType = 5123;
      } else {
        md.set$_faces(new Uint32Array(H._ensureNativeList(t5)));
        md._indexBufferType = 5125;
      }
      J.bindVertexArray$1$x(t4._gl, t7);
      t5 = md._indexBuffer;
      t6 = md._faces;
      J.bindBuffer$2$x(t4._gl, 34963, t5);
      J.bufferData$3$x(t4._gl, 34963, t6, 35048);
      G._GeometryBuilderAttributesToMeshData(gb, md);
      t4 = $.$get$TexturePropertiesVideo();
      if (t4 == null)
        t4 = new G.TextureProperties(1, 9729, 9729);
      t5 = J.createTexture$0$x(cgl._gl);
      texture = new G.ImageTexture(video, "video", t5, 3553, cgl, t4);
      J.bindTexture$2$x(cgl._gl, 3553, t5);
      J.pixelStorei$2$x(cgl._gl, 37440, 1);
      texture.SetImageData$1(video);
      t5 = t4.anisotropicFilterLevel;
      if (t5 !== 1)
        J.texParameterf$3$x(cgl._gl, 3553, 34046, t5);
      J.texParameteri$3$x(cgl._gl, 3553, 10240, t4.magFilter);
      J.texParameteri$3$x(cgl._gl, 3553, 10241, t4.minFilter);
      if (t4.clamp) {
      ...
      t2.$indexSet(0, "uColor", $.$get$ColorBlack());
      t3 = new T.Matrix4(new Float32Array(16));
      t3.setIdentity$0();
      t2.$indexSet(0, "uModelMatrix", t3);
      t2.$indexSet(0, "uTexture", texture);
      t1._lastTimeMs = 0;
      new U.main2_animate(t1, orbit, texture, program, md, perspective, new G.Material(t2, "cube"), fps).call$1(0);
    },
    main: function() {
      D.MakeVideoElementFromCamera().then$1$1(U.camera_texture__main2$closure(), -1).catchError$1(new U.main_closure());
    },
    main2_animate: function main2_animate(t0, t1, t2, t3, t4, t5, t6, t7) {
      var _ = this;
      _._box_0 = t0;
      _.orbit = t1;
      _.texture = t2;
  ...
  var holders = [C, H, J, P, W, G, R, D, A, T, U, B];
  ...
  G.GeometryBuilder.prototype = {
    ...
    AddVertices$1: function(vs) {
      ...
      for (t1 = this.vertices, _i = 0; _i < 24; ++_i) {
        v = vs[_i];
        t2 = new T.Vector3(new Float32Array(3));
        t2.setFrom$1(v);
    ...
    AddAttributesVector2$2: function(canonical, lst) {
      ...
      for (t1 = ts && C.JSArray_methods, _i = 0; _i < 24; ++_i) {
        v = lst[_i];
  ...
  R.PerspectiveResizeAware.prototype = {
    resolutionChange$1: function(ev) {
      ...
      J.viewport$4$x(this._lib$_cgl._gl, 0, 0, w, h);
    }
  };
  R.Stats.prototype = {
  ...
  D.Mouse.prototype = {
    Mouse$1: function(elem) {
      ...
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, H.functionTypeCheck(new D.Mouse_closure(this), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = t1.get$onMouseDown(elem);
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._html$_target, t3._eventType, H.functionTypeCheck(new D.Mouse_closure0(this), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = t1.get$onMouseUp(elem);
      t3 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, H.functionTypeCheck(new D.Mouse_closure1(this), {func: 1, ret: -1, args: [t3]}), false, t3);
      t1 = t1.get$onMouseWheel(elem);
      t3 = H.getTypeArgumentByIndex(t1, 0);
      W._EventStreamSubscription$(t1._html$_target, t1._eventType, H.functionTypeCheck(new D.Mouse_closure2(this), {func: 1, ret: -1, args: [t3]}), false, t3);
    }
  };
  ...
  U.main2_animate.prototype = {
    call$1: function(timeMs) {
      var exception, t1, t2, t3, t4, t5, t6, t7, rcp, t8, t9, up, z, x, y, t10, t11, t12, t13, t14, t15, t16, t17, len, c, s, $C, m11, m12, m13, m21, m22, m23, m31, m32, m33, exception0;
      ...
      try {
        t2 = this.texture;
        t2.SetImageData$1(t2._element);
        J.bindTexture$2$x(t2._cgl._gl, t2._textureType, null);
      } catch (exception0) {
        exception = H.unwrapException(exception0);
        P.print(exception);
      }
      this.program.Draw$2(this.cube, H.setRuntimeTypeInfo([this.perspective, this.mat], [G.UniformGroup]));
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(R.PerspectiveResizeAware.prototype, "get$resolutionChange", "resolutionChange$1", 14);
    _static_1(U, "camera_texture__main2$closure", "main2", 22);
  })();
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "texturedFragmentShader", "$get$texturedFragmentShader", function() {
      ...
      t1.shader = t1._CreateShader$3(true, H.assertSubtype(H.setRuntimeTypeInfo(["oFragColor = texture(uTexture, vTexUV) + vec4( uColor, 0.0 );"], t2), "$isList", t2, "$asList"), null);
      return t1;
    });
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: -1, args: [P.String,,]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [W.MouseEvent]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: P.Null, args: [W.KeyboardEvent]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, args: [,]}, {func: 1, ret: P.Null, args: [W.MediaStream]}, {func: 1, ret: -1, args: [W.Event]}, {func: 1, ret: -1, args: [P.String, P.String]}, {func: 1, ret: P.Null, args: [P.num]}, {func: 1, ret: P.Null, args: [W.NavigatorUserMediaError]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, ret: -1, args: [W.VideoElement]}, {func: 1, ret: P.Null, args: [,], opt: [P.StackTrace]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [W.WheelEvent]}, {func: 1, ret: P.Null, args: [P.Object]}, {func: 1, ret: P.int, args: [P.int, P.Object]}, {func: 1, ret: -1, args: [P.num]}, {func: 1, ret: P.Null, args: [P.AsyncError]}, {func: 1, ret: P.int, args: [,,]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.String, args: [W.EventTarget]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, args: [W.Event]}], interceptorsByTag: null, leafTags: null};
