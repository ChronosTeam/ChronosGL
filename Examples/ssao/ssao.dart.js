...
(function dartProgram() {
  ...
  B = {
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, width, height, cgl, t5, t6, t7, t8, t9, orbit, perspective, fb, err, progSolid, progSSAO, vertices, uvs, n, normals, gb, unitQuad, future, cosAngle, sinAngle, t10, t11, t12, t13, t14, t15, t16;
      t1 = {};
      t2 = document;
      ...
      progSolid = G.RenderProgram$("solid", cgl, $.$get$solidColorVertexShader(), $.$get$solidColorFragmentShader());
      progSSAO = G.RenderProgram$("ssao", cgl, $.$get$ssaoVertexShader(), $.$get$ssaoFragmentShader());
      t6 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t6.$indexSet(0, "uCameraNear", 0.1);
      t6.$indexSet(0, "uCameraFar", 2529);
      if (typeof width !== "number")
        return H.iae(width);
      if (typeof height !== "number")
        return H.iae(height);
      t7 = new T.Vector2(new Float32Array(2));
      t7.setValues$2(width, height);
      t6.$indexSet(0, "uCanvasSize", t7);
      t6.$indexSet(0, "uDepthMap", t4);
      t6.$indexSet(0, "uTexture", t5);
      ...
      t9 = [T.Vector3];
      vertices = H.setRuntimeTypeInfo([t4, t5, t7, t8], t9);
      ...
      t8.setValues$2(0, 1);
      uvs = H.setRuntimeTypeInfo([t4, t5, t7, t8], [T.Vector2]);
      ...
      unitQuad = G.GeometryBuilderToMeshData("quad", progSSAO, gb);
      t1.ctLogo = null;
      future = D.LoadRaw("../ct_logo.obj");
      future.then$1$1(new B.main_closure(t1, progSolid), null);
      t4 = $.$get$gLoadables();
      ...
      t2.$indexSet(0, "uModelMatrix", t7);
      t1._lastTimeMs = 0;
      P.Future_wait(t4, t3).then$1$1(new B.main_closure0(new B.main_animate(t1, orbit, fb, width, height, progSolid, perspective, new G.Material(t2, "mat"), new G.Framebuffer(cgl, null, null, null, null), progSSAO, unitQuad, new G.UniformGroup(t6, "plain"), fps)), null);
    },
  ...
  var holders = [C, H, J, P, W, G, R, D, A, T, B, Y];
  ...
  B.main_closure.prototype = {
    call$1: function($content) {
      this._box_0.ctLogo = G.GeometryBuilderToMeshData("", this.progSolid, Y.ImportGeometryFromWavefront(H.stringTypeCheck($content)));
    },
    $signature: 28
  };
  B.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      if ($.$get$gSSAO().checked) {
        ...
        this.progSSAO.Draw$2(this.unitQuad, H.setRuntimeTypeInfo([this.uniforms], t5));
      } else
        t2.Draw$2(t1.ctLogo, H.setRuntimeTypeInfo([t3, t4], t5));
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "ssaoVertexShader", "$get$ssaoVertexShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("SSAOV");
      t2 = [P.String];
    ...
    _lazy($, "ssaoFragmentShader", "$get$ssaoFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("SSAOF");
      t2 = [P.String];
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vTexUV"], t2));
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uCanvasSize", "uCameraNear", "uCameraFar", "uTexture", "uDepthMap"], t2));
    ...
    _lazy($, "gSSAO", "$get$gSSAO", function() {
