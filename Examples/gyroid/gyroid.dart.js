...
(function dartProgram() {
  ...
  L = {
    main: function() {
      var canvas, w, h, cgl, t1, t2, t3, t4, program, t5, t6, t7, vertices, uvs, n, normals, gb, i, md, desc, index;
      ...
      program = G.RenderProgram$("gyroid", cgl, $.$get$gyroidVertexShader(), $.$get$gyroidFragmentShader());
      ...
      t6 = P.LinkedHashMap_LinkedHashMap$_empty(t1, t2);
      t7 = J.createVertexArray$0$x(t3._gl);
      md = new G.MeshData(t3, t7, 4, t6, t4, -1, P.LinkedHashMap_LinkedHashMap$_empty(t1, P.Float32List), "meshdata:quad");
      ...
      new L.main_animate(new G.UniformGroup(P.LinkedHashMap_LinkedHashMap$_empty(t1, t2), "plain"), w, h, program, md).call$1(0);
    },
  ...
  L.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      if (typeof t4 !== "number")
        return H.iae(t4);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(t3, t4);
      t2.$indexSet(0, "uCanvasSize", t5);
      this.program.Draw$2(this.unitQuad, H.setRuntimeTypeInfo([t1], [G.UniformGroup]));
