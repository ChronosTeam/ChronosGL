...
["", "icosahedron.dart", , B, {
  ...
  main: [function() {
    ...
    orbit = B.OrbitCamera$(chronosGL._camera, 25, 0, 0);
    chronosGL.animateCallbacks.$indexSet(0, "rotateCamera", new B.main_closure(orbit));
    ...
    textureCache.loadAllThenExecute$1(new B.main_closure0(chronosGL, blockTex));
  ...
  main_closure0: {
    ...
    call$0: function() {
      var t1, md, m, t2, t3, canvas, texture;
      t1 = this.chronosGL_1;
      t1._utils.toString;
      md = B.Icosahedron$(3);
