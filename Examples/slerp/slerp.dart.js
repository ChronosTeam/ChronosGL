...
(function dartProgram() {
  ...
  A = {
    drawRecursively: function(prog, node, $parent, stats, uniforms) {
      var t1, t2, t3, t4, t5, r, t6, temp, _i;
      ...
      if (t3 != null && node._meshData != null) {
        ...
        t5 = node._normMatrix;
        r = new T.Matrix3(new Float32Array(9));
        t1.copyRotation$1(r);
        t5.copyInverse$1(r);
        t6 = t5._m3storage;
        temp = t6[3];
  ...
  T = {
    Quaternion_Quaternion$identity: function() {
  ...
  F = {
    main: function() {
      var t1, t2, canvas, cgl, t3, t4, t5, t6, t7, t8, t9, t10, orbit, perspective, phase, scene, t11, t12, t13, e, ctx, gradient, md, t14, t15, t16, t17, start, end, axis, node, future;
      t1 = {};
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(15, -45, 0.3, 0, new T.Vector3(t5), -0.02, t6, t7, t8, new T.Vector3(t9), new T.Vector3(t10), "camera:orbit");
      t5 = new T.Matrix4(new Float32Array(16));
      t5.setIdentity$0();
      t6 = new T.Matrix4(new Float32Array(16));
      t6.setIdentity$0();
      perspective = new G.Perspective(orbit, 50, 1, 1, 1000, t5, t6, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t3, t4), "perspective");
      ...
      t6 = G.RenderProgram$("demo", cgl, $.$get$demoVertexShader(), $.$get$demoFragmentShader());
      t7 = [G.UniformGroup];
      t8 = H.setRuntimeTypeInfo([perspective], t7);
      t9 = [A.Node];
      t10 = H.setRuntimeTypeInfo([], t9);
      scene = new A.Scene(t6, t8, t10, "demo");
      C.JSArray_methods.add$1(t5, scene);
      t6 = G.RenderProgram$("stars", cgl, $.$get$pointSpritesVertexShader(), $.$get$pointSpritesFragmentShader());
      t7 = H.setRuntimeTypeInfo([perspective], t7);
      t8 = H.setRuntimeTypeInfo([], t9);
      t11 = t6._cgl;
      t12 = $.$get$BlendEquationMix();
      t13 = P.LinkedHashMap_LinkedHashMap$_empty(t3, t4);
      t13.$indexSet(0, "cDepthTest", true);
      t13.$indexSet(0, "cDepthWrite", false);
      t13.$indexSet(0, "cBlendEquation", t12);
      t12 = $.$get$StencilFunctionNone();
      t13.$indexSet(0, "cStencilFunc", t12);
      ...
      ctx.fill();
      t2 = J.createTexture$0$x(t11._gl);
      J.bindTexture$2$x(t11._gl, 3553, t2);
      J.pixelStorei$2$x(t11._gl, 37440, 1);
      J.bindTexture$2$x(t11._gl, 3553, t2);
      J.texImage2D$6$x(t11._gl, 3553, 0, 6408, 6408, 5121, e);
      J.texParameteri$3$x(t11._gl, 3553, 10240, 9729);
      J.texParameteri$3$x(t11._gl, 3553, 10241, 9729);
      J.getError$0$x(t11._gl);
      J.bindTexture$2$x(t11._gl, 3553, null);
      t13.$indexSet(0, "uTexture", new G.ImageTexture(e, "Utils::Particles", t2, 3553, t11, new G.TextureProperties(1, 9729, 9729)));
      t13.$indexSet(0, "uPointSize", 1000);
      md = R.Utils_MakeStarMesh(t6, 2000, 100);
      t2 = H.setRuntimeTypeInfo([], t9);
      ...
      new Float32Array(3);
      new Float32Array(3);
      C.JSArray_methods.add$1(t8, new A.Node(new G.Material(t13, "stars"), md, t2, new T.Matrix3(t11), t14, t15, new T.Vector3(t16), new T.Vector3(t17), md.name));
      C.JSArray_methods.add$1(t5, new A.Scene(t6, t7, t8, "stars"));
      t2 = P.LinkedHashMap_LinkedHashMap$_empty(t3, t4);
      t2.$indexSet(0, "cDepthTest", true);
      t2.$indexSet(0, "cDepthWrite", true);
      t2.$indexSet(0, "cBlendEquation", $.$get$BlendEquationNone());
      t2.$indexSet(0, "cStencilFunc", t12);
      start = T.Quaternion_Quaternion$identity();
      end = T.Quaternion_Quaternion$identity();
      axis = new T.Vector3(new Float32Array(3));
      axis.setValues$3(0, 0, 1);
      t3 = H.setRuntimeTypeInfo([], t9);
      ...
      new Float32Array(3);
      new Float32Array(3);
      node = new A.Node(null, null, t3, new T.Matrix3(t5), t6, t7, new T.Vector3(t8), new T.Vector3(t9), "wrapper");
      C.JSArray_methods.add$1(t10, node);
      t3 = new T.Vector3(new Float32Array(3));
      t3.setValues$3(100, 0, -100);
      node.lookAt$1(t3);
      future = D.LoadRaw("../ct_logo.obj");
      future.then$1$1(new F.main_closure(scene, new G.Material(t2, "mat"), start, node, end, axis), null);
      t2 = $.$get$gLoadables();
      C.JSArray_methods.add$1(t2, future);
      t1.time = 0;
      t1._lastTimeMs = 0;
      P.Future_wait(t2, t4).then$1$1(new F.main_closure0(new F.main_animate(t1, orbit, new F.main_animateNode(t1, start, end, node, C.C__JSRandom, axis), phase)), null);
    },
    main_closure: function main_closure(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.scene = t0;
      _.mat = t1;
      _.start = t2;
    ...
    main_animateNode: function main_animateNode(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._box_0 = t0;
      _.start = t1;
      _.end = t2;
  ...
  var holders = [C, H, J, P, W, G, R, A, D, T, F, Y];
  ...
  T.Matrix4.prototype = {
    ...
    copyRotation$1: function(rotation) {
      var rStorage, t1;
      rStorage = rotation._m3storage;
      t1 = this._m4storage;
      rStorage[0] = t1[0];
      rStorage[1] = t1[1];
      rStorage[2] = t1[2];
  ...
  T.Quaternion.prototype = {
    ...
    setFromRotation$1: function(rotationMatrix) {
      var rotationMatrixStorage, t1, t2, t3, t, s, i, j, k, t4, t5, t6;
      ...
      if (t > 0) {
        ...
        t2 = t1 + i;
        if (t2 >= 9)
          return H.ioore(rotationMatrixStorage, t2);
        t2 = rotationMatrixStorage[t2];
        t3 = j * 3;
        t4 = t3 + j;
        if (t4 >= 9)
          return H.ioore(rotationMatrixStorage, t4);
        t4 = rotationMatrixStorage[t4];
        t5 = k * 3;
        t6 = t5 + k;
        if (t6 >= 9)
          return H.ioore(rotationMatrixStorage, t6);
        ...
        t3 += i;
        if (t3 >= 9)
          return H.ioore(rotationMatrixStorage, t3);
        t6[j] = (t2 + rotationMatrixStorage[t3]) * s;
        t1 += k;
        if (t1 >= 9)
          return H.ioore(rotationMatrixStorage, t1);
        t1 = rotationMatrixStorage[t1];
        t5 += i;
        if (t5 >= 9)
          return H.ioore(rotationMatrixStorage, t5);
  ...
  F.main_closure.prototype = {
    call$1: function($content) {
      var gb, t1, md, t2, t3, t4, t5, t6, t7, cosAngle, sinAngle, t8, t9, t10, t11, t12, t13, t14, t15, t16, r;
      gb = Y.ImportGeometryFromWavefront(H.stringTypeCheck($content));
      t1 = this.scene.program;
      md = G.MeshData$("", t1._cgl, 4, t1._shaderObjectV._canonicalToLayoutPos);
      ...
      t15 = t4[11];
      t16 = -sinAngle;
      t4[4] = t8 * cosAngle + t9 * sinAngle;
      t4[5] = t10 * cosAngle + t11 * sinAngle;
      t4[6] = t12 * cosAngle + t13 * sinAngle;
      t4[7] = t14 * cosAngle + t15 * sinAngle;
      t4[8] = t8 * t16 + t9 * cosAngle;
      t4[9] = t10 * t16 + t11 * cosAngle;
      t4[10] = t12 * t16 + t13 * cosAngle;
      t4[11] = t14 * t16 + t15 * cosAngle;
      ...
      t9 = t4[7];
      t8 = -sinAngle;
      t4[0] = t15 * cosAngle + t16 * sinAngle;
      t4[1] = t14 * cosAngle + t13 * sinAngle;
      t4[2] = t12 * cosAngle + t11 * sinAngle;
      t4[3] = t10 * cosAngle + t9 * sinAngle;
      t4[4] = t15 * t8 + t16 * cosAngle;
      t4[5] = t14 * t8 + t13 * cosAngle;
      t4[6] = t12 * t8 + t11 * cosAngle;
      t4[7] = t10 * t8 + t9 * cosAngle;
      t9 = this.node;
      r = new T.Matrix3(new Float32Array(9));
      t9.transform.copyRotation$1(r);
      this.start.setFromRotation$1(r);
      this.end.setAxisAngle$2(this.axis, 3.14);
      C.JSArray_methods.add$1(t9.children, new A.Node(this.mat, md, t1, new T.Matrix3(t2), t3, t5, new T.Vector3(t6), new T.Vector3(t7), md.name));
    },
    $signature: 25
  };
  F.main_animateNode.prototype = {
    call$1: function(elapsedMs) {
      var t1, t2, time, ax, ay, az, aw, bx, by, bz, bw, cosom, scale0, omega, sinom, scale1, s, _x, _y, _z, _w, xs, ys, zs, wx, wy, wz, xx, xy, xz, yy, yz, zz, angle, r;
      t1 = this._box_0;
      t2 = t1.time;
      if (t2 < 1) {
        time = t2 + 0.2 * elapsedMs / 1000;
        t1.time = time;
        t1 = this.start._qStorage;
        ax = t1[0];
        ay = t1[1];
        az = t1[2];
        aw = t1[3];
        t1 = this.end._qStorage;
        bx = t1[0];
        by = t1[1];
        bz = t1[2];
        bw = t1[3];
        ...
        if (1 - cosom > 0.000001) {
          ...
          scale1 = Math.sin(time * omega) / sinom;
        } else
          scale1 = time;
        t1 = new Float32Array(4);
        ...
        t2 = new Float32Array(9);
        s = 2 / new T.Quaternion(t1).get$length2();
        _x = t1[0];
        _y = t1[1];
        _z = t1[2];
        _w = t1[3];
        ...
        t2[7] = yz - wx;
        t2[8] = 1 - (xx + yy);
        t1 = this.node.transform._m4storage;
        t1[0] = t2[0];
        t1[1] = t2[1];
        t1[2] = t2[2];
        t1[4] = t2[3];
        ...
        P.print("new rotation");
        t1.time = 0;
        t1 = this.rng;
        t2 = this.axis;
        if (t1.nextBool$0()) {
          t2.setValues$3(t1.nextDouble$0(), t1.nextDouble$0(), t1.nextDouble$0());
          t2.normalize$0(0);
          angle = 6.283185307179586 * t1.nextDouble$0();
        } else {
          t2.setValues$3(1, 0, 0);
          angle = 0;
        }
        P.print("new rotation axis: " + t2.toString$0(0));
        r = new T.Matrix3(new Float32Array(9));
        this.node.transform.copyRotation$1(r);
        this.start.setFromRotation$1(r);
        this.end.setAxisAngle$2(t2, angle);
      }
    },
    $signature: 26
  };
  F.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      if (typeof t5 !== "number")
        return t5.$mul();
      t5 = t1._radius - t5 * t1.mouseWheelFactor;
      if (t5 > 0)
        t1._radius = t5;
      t5 = C.JSNumber_methods.clamp$2(t1.polar, -1.4707963267948965, 1.4707963267948965);
      t1.polar = t5;
      t6 = t1._radius;
      t7 = t1.azimuth;
      rcp = t6 * Math.cos(t5);
      ...
      this.animateNode.call$1(timeMs - t2);
      this.phase.Draw$0();
