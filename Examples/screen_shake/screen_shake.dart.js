...
(function dartProgram() {
  ...
  M = {
    RandomPointOnUnitSphere: function(out, rng) {
      var x, y, sq, rt, t1;
      for (; true;) {
        x = rng.nextDouble$0() * 2 - 1;
        y = rng.nextDouble$0() * 2 - 1;
        sq = x * x + y * y;
        if (sq >= 1)
          continue;
        rt = Math.sqrt(1 - sq);
    ...
    main: function() {
      var t1, t2, canvas, cgl, t3, t4, t5, t6, t7, t8, t9, t10, orbit, perspective, prog, gb, md, progSprites, e, ctx, gradient, stars, rng;
      t1 = {};
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(5, 0, 0, 0, new T.Vector3(t6), -0.02, t7, t5, t8, new T.Vector3(t9), new T.Vector3(t10), "camera:orbit");
      ...
      gb = B.TorusKnotGeometry(true, 1, 2, 3, 1, 128, 16, 0.4);
      md = G.MeshData$("torusknot", prog._cgl, 4, prog._shaderObjectV._canonicalToLayoutPos);
      md.AddVertices$1(G.FlattenVector3List(gb.vertices));
      t7 = H.assertSubtype(gb.GenerateFaceIndices$0(), "$isList", [P.int], "$asList");
      t8 = md._cgl;
      md._indexBuffer = J.createBuffer$0$x(t8._gl);
      t9 = md._vertices.length;
      if (t9 < 768) {
        md.set$_faces(new Uint8Array(H._ensureNativeList(t7)));
        md._indexBufferType = 5121;
      } else if (t9 < 196608) {
        md.set$_faces(new Uint16Array(H._ensureNativeList(t7)));
        md._indexBufferType = 5123;
      } else {
        md.set$_faces(new Uint32Array(H._ensureNativeList(t7)));
        md._indexBufferType = 5125;
      }
      J.bindVertexArray$1$x(t8._gl, md._vao);
      t7 = md._indexBuffer;
      t9 = md._faces;
      J.bindBuffer$2$x(t8._gl, 34963, t7);
      J.bufferData$3$x(t8._gl, 34963, t9, 35048);
      ...
      t4.$indexSet(0, "cBlendEquation", t7);
      t4.$indexSet(0, "cStencilFunc", t6);
      ...
      t1._lastShakeMs = 0;
      t1._lastTimeMs = 0;
      new M.main_animate(t1, orbit, 2000, 500, new M.CameraShaker(new T.Vector3(t2), rng, orbit), prog, md, perspective, new G.Material(t5, "torus-mat"), progSprites, stars, new G.Material(t4, "stars")).call$1(0);
    },
    CameraShaker: function CameraShaker(t0, t1, t2) {
      this._offset = t0;
      this._rng = t1;
      this._camera = t2;
    },
    main_animate: function main_animate(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11) {
      var _ = this;
      _._box_0 = t0;
      _.orbit = t1;
      _.shakeIntervalMs = t2;
      _.shakeDurationMs = t3;
      _.shaker = t4;
      _.prog = t5;
      _.torus = t6;
      _.perspective = t7;
  ...
  var holders = [C, H, J, P, W, G, R, B, D, A, T, M];
  ...
  G.Spatial.prototype = {
    ...
    translateFromVec$1: function(vector) {
      var t1, t2;
      t1 = this.transform._m4storage;
      t2 = vector._v3storage;
      t1[12] = t1[12] + t2[0];
      t1[13] = t1[13] + t2[1];
      t1[14] = t1[14] + t2[2];
    }
  ...
  M.CameraShaker.prototype = {
    Unshake$0: function() {
      var t1 = this._offset;
      t1.scale$1(0, -1);
      this._camera.translateFromVec$1(t1);
      t1.setZero$0();
    }
  };
  M.main_animate.prototype = {
    call$1: function(timeMs) {
      var t1, t2, t3, t4, t5, t6, t7, rcp, t8, t9, up, z, x, y, t10, t11, t12, t13, t14, t15, t16, t17, len, c, s, $C, m11, m12, m13, m21, m22, m23, m31, m32, m33, shakeAgeMs;
      ...
      shakeAgeMs = t1._lastTimeMs - (t1._lastShakeMs + this.shakeIntervalMs);
      if (shakeAgeMs >= 0) {
        if (shakeAgeMs >= this.shakeDurationMs) {
          this.shaker.Unshake$0();
          t1._lastShakeMs = t1._lastTimeMs;
        }
        t1 = this.shaker;
        t1.Unshake$0();
        t2 = t1._offset;
        M.RandomPointOnUnitSphere(t2, t1._rng);
        t2.scale$1(0, (500 - shakeAgeMs) * 0.0001);
        t1._camera.translateFromVec$1(t2);
      }
      t1 = this.perspective;
      t2 = [G.UniformGroup];
      this.prog.Draw$2(this.torus, H.setRuntimeTypeInfo([t1, this.material], t2));
      this.progSprites.Draw$2(this.stars, H.setRuntimeTypeInfo([t1, this.materialStars], t2));
  ...
  (function installTearOffs() {
    ...
    _static_1(W, "html_Element__determineMouseWheelEventType$closure", "Element__determineMouseWheelEventType", 24);
    _instance_1_u(R.PerspectiveResizeAware.prototype, "get$resolutionChange", "resolutionChange$1", 18);
  })();
