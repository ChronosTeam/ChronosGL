...
["", "obj.dart", , T, {
  "^": "",
  main: [function() {
    var chronosGL, shaderObject, prg, orbit;
    ...
    chronosGL.animateCallbacks.$indexSet(0, "rotateCamera", new T.main_closure(orbit));
    chronosGL.animatables.$indexSet(0, "orbitCam", orbit);
    B.loadObj("ct_logo.obj").then$1(new T.main_closure0(chronosGL, prg));
  ...
  main_closure0: {
    ...
    call$1: function(md) {
      var mesh, s, c, t1, a10, a11, a12, a13, a20, a21, a22, a23, t2, t3, t4, n;
      mesh = md.createMesh$0();
      s = Math.sin(H.checkNum(1.57));
      c = Math.cos(H.checkNum(1.57));
      t1 = mesh.transform.array;
      a10 = t1[4];
      a11 = t1[5];
      a12 = t1[6];
      a13 = t1[7];
      ...
      t4 = new Q.Matrix4(new Float32Array(16), Q.Vector$(0, 0, 0), Q.Vector$(0, 0, 0), Q.Vector$(0, 0, 0));
      t4.identity$0();
      n = new B.Node("", "", true, false, t2, t1, t3, null, t4, Q.Vector$(0, 0, 0), Q.Vector$(0, 0, 0), Q.Vector$(0, 0, 0), Q.Vector$(0, 0, 0));
      t2.push(mesh);
      t1 = Q.Vector$(100, 0, 0);
      t4.lookAt_alt$3(n.getPos$0(), t1, null);
      this.prg_2.objects.push(n);
      this.chronosGL_1.run$0();
    }
  }
},
1],
