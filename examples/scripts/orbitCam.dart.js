...
["chronosgl", "package:chronosgl/chronosgl.dart", , B, {
  ...
  OrbitCamera: {
    ...
    animate$1: function(_, elapsed) {
      var t1, t2, t3, t4, rcp, t5, t6, up, x, y, z, len;
      t1 = this.cpk;
  ...
  Mesh: {
    ...
    draw2$1: function(program) {
      ...
      if (t2.colorUniform != null) {
        t3 = program.colorUniform;
        J.uniform3fv$2$x(t3.gl, t3.uniformLocation, this.color.array);
      }
  ...
  ShaderProgram: {
    ...
    ShaderProgram$3: function(chronosGL, shaderObject, $name) {
      ...
      t1 = t2.colorUniform;
      if (t1 != null)
        this.colorUniform = new B.Uniform(J.getUniformLocation$2$x(this.gl, this.program, t1), this.gl);
      t2.cameraNear;
      t2.cameraFar;
      t2.size;
      t2.transformationMatrixUniform;
  ...
  Icosahedron: {
    "^": "MeshData;vertices,colors,normals,binormals,textureCoords,vertexIndices,texture,texture2,isOptimized",
    v$3: function(x, y, z) {
      var $length = Math.sqrt(H.checkNum(x * x + y * y + z * z));
      J.addAll$1$ax(this.vertices, [x / $length, y / $length, z / $length]);
    },
    f3$4: function(a, b, c, scope) {
      var t1, v1, v2, v3, t2, t3, t4, t5, t6, t7;
      t1 = J.getInterceptor$ns(a);
      v1 = J.sublist$2$ax(this.vertices, t1.$mul(a, 3), J.$add$ns(t1.$mul(a, 3), 3));
      t1 = b * 3;
      v2 = J.sublist$2$ax(this.vertices, t1, t1 + 3);
      t1 = c * 3;
      v3 = J.sublist$2$ax(this.vertices, t1, t1 + 3);
      J.addAll$1$ax(scope.vertexIndices, [a, b, c]);
      ...
      if (typeof t7 !== "number")
        H.throwExpression(P.ArgumentError$(t7));
      J.addAll$1$ax(t1, [0.5 * (1 + t2 * 0.3183098861837907), t3 * 0.3183098861837907, 0.5 * (1 + t4 * 0.3183098861837907), t5 * 0.3183098861837907, 0.5 * (1 + t6 * 0.3183098861837907), Math.acos(t7) * 0.3183098861837907]);
    },
    getMiddlePoint$2: function(p1, p2) {
      var t1, pos1, pos2, t2, t3;
      t1 = J.getInterceptor$ns(p1);
      pos1 = J.sublist$2$ax(this.vertices, t1.$mul(p1, 3), J.$add$ns(t1.$mul(p1, 3), 3));
      t1 = J.getInterceptor$ns(p2);
      pos2 = J.sublist$2$ax(this.vertices, t1.$mul(p2, 3), J.$add$ns(t1.$mul(p2, 3), 3));
      if (0 >= pos1.length)
    ...
    Icosahedron$1: function(subdivisions) {
      ...
      tempMeshData = B.MeshData$empty();
      t = (1 + Math.sqrt(H.checkNum(5))) / 2;
      this.v$3(-1, t, 0);
      this.v$3(1, t, 0);
      t1 = -t;
      this.v$3(-1, t1, 0);
      ...
      for (i = 0; i < subdivisions; ++i) {
        tempMeshData2 = B.MeshData$empty();
        for (l = C.JSInt_methods._tdivFast$1(tempMeshData.vertexIndices.length, 3), i0 = 0; i0 < l; ++i0) {
          t1 = i0 * 3;
          face = J.sublist$2$ax(tempMeshData.vertexIndices, t1, t1 + 3);
          t1 = face.length;
          if (0 >= t1)
      ...
      for (l = this.vertexIndices.length, i = 0; i < l; ++i) {
        ...
        J.addAll$1$ax(tempMeshData.vertices, J.sublist$2$ax(this.vertices, t1.$mul(index, 3), J.$add$ns(t1.$mul(index, 3), 3)));
        J.add$1$ax(tempMeshData.vertexIndices, i);
      }
      this.vertexIndices = tempMeshData.vertexIndices;
    ...
    static: {Icosahedron$: function(subdivisions) {
        var t1 = new B.Icosahedron(null, null, null, null, null, null, null, null, false);
        t1.MeshData$empty$0();
...
["chronosmath", "package:chronosgl/chronosmath.dart", , Q, {
  ...
  Matrix4: {
    ...
    setScale$1: function($receiver, x) {
      return this.setScale$3($receiver, x, null, null);
    },
...
["", "orbitCam.dart", , Y, {
  "^": "",
  main: [function() {
    var chronosGL, shaderObject, prg, orbit, sphere, head, leftEye, t1, rightEye, nose, t2, canvas, texture;
    chronosGL = B.ChronosGL$("#webgl-canvas", 1000, null, 0.1, false, false, false);
    shaderObject = new B.ShaderObject("Color", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, "", "", "", "");
    shaderObject.vertexPositionAttribute = "aVertexPosition";
    ...
    prg = chronosGL.createProgram$1(0, B.generateShader(shaderObject));
    orbit = B.OrbitCamera$(chronosGL._camera, 15, 0, 0);
    chronosGL.animatables.$indexSet(0, "orbitCam", orbit);
    chronosGL.animateCallbacks.$indexSet(0, "rotateCamera", new Y.main_closure(orbit));
    chronosGL._utils.toString;
    sphere = B.Icosahedron$(4);
    sphere.optimize$0();
    head = B.Mesh$(sphere, false);
    head.color.set$3(0.94, 0.72, 0.63);
    sphere.optimize$0();
    leftEye = B.Mesh$(sphere, false);
    leftEye.color.set$3(0, 0, 1);
    leftEye.setPos$3(-0.2, 0.4, -0.8);
    leftEye.transform.setScale$1(0, 0.2);
    t1 = head.children;
    t1.push(leftEye);
    sphere.optimize$0();
    rightEye = B.Mesh$(sphere, false);
    rightEye.color.set$3(0, 0, 1);
    rightEye.transform.setScale$1(0, 0.2);
    rightEye.setPos$3(0.2, 0.4, -0.8);
    t1.push(rightEye);
    sphere.optimize$0();
    nose = B.Mesh$(sphere, false);
    nose.color.set$3(0.9, 0.7, 0.6);
    nose.transform.setScale$1(0, 0.3);
    nose.setPos$3(0, 0, -0.9);
    t1.push(nose);
    prg.objects.push(head);
    t1 = chronosGL._utils;
    t2 = t1.chronosGL;
...
//# sourceMappingURL=orbitCam.dart.js.map
