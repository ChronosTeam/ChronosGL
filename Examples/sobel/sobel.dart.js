...
(function dartProgram() {
  ...
  S = {
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, width, height, cgl, t5, t6, t7, t8, t9, orbit, perspective, fb, err, greyShader, progGrey, progSobel, vertices, uvs, n, normals, gb, unitQuad, future, cosAngle, sinAngle, t10, t11, t12, t13, t14, t15, t16;
      t1 = {};
      t2 = document;
      ...
      t6 = [t2];
      t7 = P.int;
      t8 = new G.ShaderObject(H.setRuntimeTypeInfo([], t6), H.setRuntimeTypeInfo([], t6), H.setRuntimeTypeInfo([], t6), H.setRuntimeTypeInfo([], t6), P.LinkedHashMap_LinkedHashMap$_empty(t2, t7));
      t8.AddAttributeVars$1(H.setRuntimeTypeInfo(["aPosition", "aNormal"], t6));
      t8.AddVaryingVars$1(H.setRuntimeTypeInfo(["vColor"], t6));
      t8.AddUniformVars$1(H.setRuntimeTypeInfo(["uPerspectiveViewMatrix", "uModelMatrix"], t6));
      t8.SetBodyWithMain$1(H.setRuntimeTypeInfo(["float d = sin(dot( aPosition, aNormal)) / 2.0 + 0.5;", "vColor = vec3(d,d,d);", "gl_Position = uPerspectiveViewMatrix * uModelMatrix * vec4(aPosition, 1.0);"], t6));
      t7 = new G.ShaderObject(H.setRuntimeTypeInfo([], t6), H.setRuntimeTypeInfo([], t6), H.setRuntimeTypeInfo([], t6), H.setRuntimeTypeInfo([], t6), P.LinkedHashMap_LinkedHashMap$_empty(t2, t7));
      t7.AddVaryingVars$1(H.setRuntimeTypeInfo(["vColor"], t6));
      t7.SetBodyWithMain$1(H.setRuntimeTypeInfo(["oFragColor = vec4(vColor, 1.0);"], t6));
      greyShader = [t8, t7];
      progGrey = G.RenderProgram$("grey", cgl, greyShader[0], greyShader[1]);
      progSobel = G.RenderProgram$("ssao", cgl, $.$get$sobelVertexShader(), $.$get$sobelFragmentShader());
      t7 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      if (typeof width !== "number")
        return H.iae(width);
      if (typeof height !== "number")
        return H.iae(height);
      t6 = new T.Vector2(new Float32Array(2));
      t6.setValues$2(width, height);
      t7.$indexSet(0, "uCanvasSize", t6);
      t7.$indexSet(0, "uDepthMap", t4);
      t7.$indexSet(0, "uTexture", t5);
      ...
      t9 = [T.Vector3];
      vertices = H.setRuntimeTypeInfo([t4, t5, t6, t8], t9);
      ...
      t8.setValues$2(0, 1);
      uvs = H.setRuntimeTypeInfo([t4, t5, t6, t8], [T.Vector2]);
      ...
      unitQuad = G.GeometryBuilderToMeshData("quad", progSobel, gb);
      t1.ctLogo = null;
      future = D.LoadRaw("../ct_logo.obj");
      future.then$1$1(new S.main_closure(t1, progGrey), null);
      t4 = $.$get$gLoadables();
      ...
      t15 = t5[11];
      t16 = -sinAngle;
      t5[4] = t8 * cosAngle + t9 * sinAngle;
      t5[5] = t10 * cosAngle + t11 * sinAngle;
      t5[6] = t12 * cosAngle + t13 * sinAngle;
      t5[7] = t14 * cosAngle + t15 * sinAngle;
      t5[8] = t8 * t16 + t9 * cosAngle;
      t5[9] = t10 * t16 + t11 * cosAngle;
      t5[10] = t12 * t16 + t13 * cosAngle;
      t5[11] = t14 * t16 + t15 * cosAngle;
      t2.$indexSet(0, "uModelMatrix", t6);
      t1._lastTimeMs = 0;
      P.Future_wait(t4, t3).then$1$1(new S.main_closure0(new S.main_animate(t1, orbit, fb, width, height, progGrey, perspective, new G.Material(t2, "mat"), new G.Framebuffer(cgl, null, null, null, null), progSobel, unitQuad, new G.UniformGroup(t7, "plain"), fps)), null);
    },
  ...
  var holders = [C, H, J, P, W, G, R, D, A, T, S, Y];
  ...
  S.main_closure.prototype = {
    call$1: function($content) {
      this._box_0.ctLogo = G.GeometryBuilderToMeshData("", this.progGrey, Y.ImportGeometryFromWavefront(H.stringTypeCheck($content)));
    },
    $signature: 28
  };
  S.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      t4 = this.material;
      t5 = [G.UniformGroup];
      if ($.$get$gSobel().checked) {
        t6 = this.width;
        t7 = this.height;
        this.fb.Activate$5(17664, 0, 0, t6, t7);
        t2.Draw$2(t1.ctLogo, H.setRuntimeTypeInfo([t3, t4], t5));
        this.screen.Activate$5(17664, 0, 0, t6, t7);
        this.progSobel.Draw$2(this.unitQuad, H.setRuntimeTypeInfo([this.uniforms], t5));
      } else
        t2.Draw$2(t1.ctLogo, H.setRuntimeTypeInfo([t3, t4], t5));
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "sobelVertexShader", "$get$sobelVertexShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("SobelV");
      t2 = [P.String];
