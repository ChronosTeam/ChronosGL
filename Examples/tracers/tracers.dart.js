...
(function dartProgram() {
  ...
  Y = {
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, t10, orbit, perspective, phase, matBlur, t11, t12, t13, vertices, uvs, n, normals, gb, i, md, mat, e, ctx, gradient;
      t1 = {};
      t2 = document;
      ...
      t3 = P.String;
      t4 = P.Object;
      t5 = (canvas && C.CanvasElement_methods).getContext$2(canvas, "webgl2", P.LinkedHashMap_LinkedHashMap$_literal(["alpha", false, "depth", true, "stencil", true, "antialias", true, "premultipliedAlpha", true, "preserveDrawingBuffer", true, "failIfMajorPerformanceCaveat", false], t3, t4));
      cgl._gl = t5;
      if (t5 == null)
      ...
      t5 = phase._clear_mode |= 256;
      phase._clear_mode = t5 & 4294950911;
      t5 = G.RenderProgram$("blur", cgl, $.$get$blurdVertexShader(), $.$get$bluredFragmentShader());
      t6 = [G.UniformGroup];
      t7 = H.setRuntimeTypeInfo([perspective], t6);
      t8 = [A.Node];
      t9 = H.setRuntimeTypeInfo([], t8);
      C.JSArray_methods.add$1(t4, new A.Scene(t5, t7, t9, "blur"));
      matBlur = G.Material$Transparent("blur", $.$get$BlendEquationStandard());
      t7 = new Float32Array(4);
      t7[3] = 0.04;
      t7[2] = 0;
      t7[1] = 0;
      t7[0] = 0;
      matBlur._uniforms.$indexSet(0, "uColorAlpha", new T.Vector4(t7));
      ...
      t13 = [T.Vector3];
      vertices = H.setRuntimeTypeInfo([t7, t10, t11, t12], t13);
      ...
      t12.setValues$2(0, 1);
      uvs = H.setRuntimeTypeInfo([t7, t10, t11, t12], [T.Vector2]);
      n = new T.Vector3(new Float32Array(3));
      n.setValues$3(0, 0, 1);
      normals = H.setRuntimeTypeInfo([n, n, n, n], t13);
      t7 = H.setRuntimeTypeInfo([], [G.Face3]);
      t10 = H.setRuntimeTypeInfo([], [G.Face4]);
      t11 = H.setRuntimeTypeInfo([], t13);
      gb = new G.GeometryBuilder(false, t7, t10, t11, P.LinkedHashMap_LinkedHashMap$_empty(t3, [P.List,,]));
      ...
      md = G.MeshData$("quad", t5._cgl, 4, t5._shaderObjectV._canonicalToLayoutPos);
      md.AddVertices$1(G.FlattenVector3List(t11));
      ...
      J.bufferData$3$x(t5._gl, 34963, t7, 35048);
      G._GeometryBuilderAttributesToMeshData(gb, md);
      t3 = H.setRuntimeTypeInfo([], t8);
      ...
      new Float32Array(3);
      new Float32Array(3);
      C.JSArray_methods.add$1(t9, new A.Node(matBlur, md, t3, new T.Matrix3(t5), t7, t10, new T.Vector3(t11), new T.Vector3(t12), ""));
      t3 = G.RenderProgram$("stars", cgl, $.$get$pointSpritesVertexShader(), $.$get$pointSpritesFragmentShader());
      t6 = H.setRuntimeTypeInfo([perspective], t6);
      t5 = H.setRuntimeTypeInfo([], t8);
      t7 = t3._cgl;
      mat = G.Material$Transparent("stars", $.$get$BlendEquationMix());
      ...
      ctx.fill();
      t2 = J.createTexture$0$x(t7._gl);
      J.bindTexture$2$x(t7._gl, 3553, t2);
      J.pixelStorei$2$x(t7._gl, 37440, 1);
      J.bindTexture$2$x(t7._gl, 3553, t2);
      J.texImage2D$6$x(t7._gl, 3553, 0, 6408, 6408, 5121, e);
      J.texParameteri$3$x(t7._gl, 3553, 10240, 9729);
      J.texParameteri$3$x(t7._gl, 3553, 10241, 9729);
      J.getError$0$x(t7._gl);
      J.bindTexture$2$x(t7._gl, 3553, null);
      t9 = mat._uniforms;
      t9.$indexSet(0, "uTexture", new G.ImageTexture(e, "Utils::Particles", t2, 3553, t7, new G.TextureProperties(1, 9729, 9729)));
      t9.$indexSet(0, "uPointSize", 1000);
      md = R.Utils_MakeStarMesh(t3, 2000, 100);
      ...
      new Float32Array(3);
      new Float32Array(3);
      C.JSArray_methods.add$1(t5, new A.Node(mat, md, t8, new T.Matrix3(t2), t7, t9, new T.Vector3(t10), new T.Vector3(t11), md.name));
      C.JSArray_methods.add$1(t4, new A.Scene(t3, t6, t5, "stars"));
      t1._lastTimeMs = 0;
      new Y.main_animate(t1, orbit, phase, fps).call$1(0);
    },
  ...
  Y.main_animate.prototype = {
    call$1: function(timeMs) {
      var t1, t2, t3, t4, t5, t6, t7, rcp, t8, t9, up, z, x, y, t10, t11, t12, t13, t14, t15, t16, t17, len, c, s, $C, m11, m12, m13, m21, m22, m23, m31, m32, m33, stats, out, _i;
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "blurdVertexShader", "$get$blurdVertexShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("bluredV");
      t2 = [P.String];
      t1.AddAttributeVars$1(H.setRuntimeTypeInfo(["aPosition"], t2));
      t1.SetBody$1(H.setRuntimeTypeInfo(["void main() {\n  gl_Position = vec4(aPosition, 1.0);\n}\n"], t2));
      return t1;
    });
    _lazy($, "bluredFragmentShader", "$get$bluredFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("bluredF");
      t2 = [P.String];
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uColorAlpha"], t2));
