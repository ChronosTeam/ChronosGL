...
(function dartProgram() {
  ...
  T = {
    ...
    LightSourceVisualizerScene: function(cgl, uniforms) {
      var t1, t2, t3, scene, lightSourceMat, t4, t5, t6, t7, t8, t9, t10, t11, dl, t12, md, t13, t14, t15, t16, t17;
      H.assertSubtype(uniforms, "$isList", [G.UniformGroup], "$asList");
      ...
      for (t3 = $.$get$gLightSources(), t4 = new H.LinkedHashMapKeyIterable(t3, [H.getTypeArgumentByIndex(t3, 0)]), t4 = t4.get$iterator(t4), t5 = [P.int], t6 = t1._cgl, t1 = t1._shaderObjectV, t7 = P.String, t8 = P.Object, t9 = P.Float32List; t4.moveNext$0();) {
        ...
        new Float32Array(3);
        new Float32Array(3);
        t11.$indexSet(0, t10, new A.Node(lightSourceMat, md, t12, new T.Matrix3(t13), t14, t15, new T.Vector3(t16), new T.Vector3(t17), t10));
      }
    ...
    Dragon: function(cgl, prog) {
      var mat, node, f1, t1;
      mat = G.Material$("matDragon");
      mat._uniforms.$indexSet(0, "uShininess", 10);
      node = A.Node$Container("dragon", null);
      f1 = D.LoadImage("../asset/dragon/dragon.png").then$1$1(new T.Dragon_closure(mat, cgl), null);
      t1 = $.$get$gLoadables();
      C.JSArray_methods.add$1(t1, f1);
      C.JSArray_methods.add$1(t1, D.LoadRaw("../asset/dragon/dragon.obj").then$1$1(new T.Dragon_closure0(prog, mat, node), null));
      return node;
    },
    main: function() {
      var _box_0, t1, t2, text, t3, fps, canvas, cgl, t4, t5, t6, t7, t8, t9, orbit, perspective, illumination, sceneFixed, phaseBlinnPhong, phaseGourad, dragonNode, selectPhase, _i, e;
      _box_0 = {};
      t1 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(50, 10, 0, 0, new T.Vector3(t4), -0.02, t5, t6, t7, new T.Vector3(t8), new T.Vector3(t9), "camera:orbit");
      ...
      for (t2 = $.$get$gLightSources(), t2 = t2.get$values(t2), t5 = t2._iterable, t2 = new H.MappedIterator(t5.get$iterator(t5), t2._f, [H.getTypeArgumentByIndex(t2, 0), H.getTypeArgumentByIndex(t2, 1)]); t2.moveNext$0();)
        C.JSArray_methods.add$1(t4, t2._current);
      t2 = G.RenderProgram$("BlinnPhong", cgl, $.$get$lightVertexShaderBlinnPhong(), $.$get$lightFragmentShaderBlinnPhong());
      t4 = [G.UniformGroup];
      t5 = H.setRuntimeTypeInfo([perspective, illumination], t4);
      t6 = [A.Node];
      t7 = H.setRuntimeTypeInfo([], t6);
      t8 = G.RenderProgram$("Gourad", cgl, $.$get$lightVertexShaderGourad(), $.$get$lightFragmentShaderGourad());
      t9 = H.setRuntimeTypeInfo([perspective, illumination], t4);
      t6 = H.setRuntimeTypeInfo([], t6);
      sceneFixed = T.LightSourceVisualizerScene(cgl, H.setRuntimeTypeInfo([perspective], t4));
      phaseBlinnPhong = A.RenderPhase$("BlinnPhong", cgl);
      t4 = phaseBlinnPhong._scenes;
      C.JSArray_methods.add$1(t4, new A.Scene(t2, t5, t7, "BlinnPhong"));
      C.JSArray_methods.add$1(t4, sceneFixed);
      phaseGourad = A.RenderPhase$("Gourad", cgl);
      t4 = phaseGourad._scenes;
      C.JSArray_methods.add$1(t4, new A.Scene(t8, t9, t6, "Gourad"));
      C.JSArray_methods.add$1(t4, sceneFixed);
      dragonNode = T.Dragon(cgl, t2);
      C.JSArray_methods.add$1(t6, dragonNode);
      C.JSArray_methods.add$1(t7, dragonNode);
      ...
      for (t2 = t1.getElementsByTagName("input"), t4 = t2.length, _i = 0; _i < t2.length; t2.length === t4 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
        ...
        W._EventStreamSubscription$(t5._target, t5._eventType, H.functionTypeCheck(new T.main_closure(), {func: 1, ret: -1, args: [t6]}), false, t6);
      }
      for (t2 = t1.getElementsByTagName("input"), t4 = t2.length, _i = 0; _i < t2.length; t2.length === t4 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
      ...
      t1 = new T.main_resolutionChange(canvas, perspective, phaseGourad, phaseBlinnPhong);
      t1.call$1(null);
      t2 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(t1, {func: 1, ret: -1, args: [t2]}), false, t2);
      _box_0._lastTimeMs = 0;
      P.Future_wait($.$get$gLoadables(), t3).then$1$1(new T.main_closure0(new T.main_animate(_box_0, orbit, selectPhase, phaseBlinnPhong, phaseGourad, fps)), null);
    },
    Dragon_closure: function Dragon_closure(t0, t1) {
      this.mat = t0;
      this.cgl = t1;
    },
    Dragon_closure0: function Dragon_closure0(t0, t1, t2) {
      this.prog = t0;
      this.mat = t1;
      this.node = t2;
    },
  ...
  var holders = [C, H, J, P, W, G, R, A, D, T, Y];
  ...
  P.RenderingContext.prototype = {
    ...
    texImage2D$6: function(receiver, target, level, internalformat, format_OR_width, height_OR_type, bitmap_OR_border_OR_canvas_OR_image_OR_pixels_OR_video) {
      var t1;
      if (!!J.getInterceptor$(bitmap_OR_border_OR_canvas_OR_image_OR_pixels_OR_video).$isImageElement)
        t1 = true;
      else
        t1 = false;
      if (t1) {
  ...
  T.Dragon_closure.prototype = {
    call$1: function(img) {
      var t1, t2;
      H.interceptedTypeCheck(img, "$isImageElement");
      t1 = this.cgl;
      t2 = J.createTexture$0$x(t1._gl);
      J.bindTexture$2$x(t1._gl, 3553, t2);
      J.pixelStorei$2$x(t1._gl, 37440, 1);
      J.bindTexture$2$x(t1._gl, 3553, t2);
      J.texImage2D$6$x(t1._gl, 3553, 0, 6408, 6408, 5121, img);
      ...
      this.mat._uniforms.$indexSet(0, "uTexture", new G.ImageTexture(img, "../asset/dragon/dragon.png", t2, 3553, t1, new G.TextureProperties(1, 9729, 9729)));
    },
    $signature: 29
  };
  T.Dragon_closure0.prototype = {
    call$1: function($content) {
      var gb, t1, md, t2, t3, t4, t5, t6, n;
      gb = Y.ImportGeometryFromWavefront(H.stringTypeCheck($content));
      t1 = this.prog;
      md = G.MeshData$("../asset/dragon/dragon.obj", t1._cgl, 4, t1._shaderObjectV._canonicalToLayoutPos);
      ...
      new Float32Array(3);
      new Float32Array(3);
      n = A.Node$Container("wrapper", new A.Node(this.mat, md, t1, new T.Matrix3(t2), t3, t4, new T.Vector3(t5), new T.Vector3(t6), md.name));
      t1 = new T.Vector3(new Float32Array(3));
      t1.setValues$3(100, 0, 0);
      n.lookAt$1(t1);
      C.JSArray_methods.add$1(this.node.children, n);
    },
    $signature: 30
  };
  T.main_closure.prototype = {
    call$1: function(e) {
      ...
      $.$get$gLightSources().$index(0, input.id).enabled = input.checked;
      $.$get$gLightVisualizers().$index(0, input.id).enabled = input.checked;
    },
    $signature: 31
  };
  T.main_resolutionChange.prototype = {
    call$1: function(ev) {
      var t1, w, h;
      t1 = this.canvas;
      w = t1.clientWidth;
  ...
  T.main_animate.prototype = {
    call$1: function(timeMs) {
      var t1, t2, t3, t4, t5, t6, t7, rcp, len, x, y, z, c, s, $C, m11, m12, m13, m21, m22, m23, m31, m32, m33, t8, t9, t10, t11, t12, t13, t14, t15, t16;
      ...
      t15 = t5[7];
      t16 = t5[11];
      t5[0] = t2 * m11 + t6 * m21 + t7 * m31;
      t5[1] = t8 * m11 + t9 * m21 + t10 * m31;
      t5[2] = t11 * m11 + t12 * m21 + t13 * m31;
      t5[3] = t14 * m11 + t15 * m21 + t16 * m31;
      t5[4] = t2 * m12 + t6 * m22 + t7 * m32;
      t5[5] = t8 * m12 + t9 * m22 + t10 * m32;
      t5[6] = t11 * m12 + t12 * m22 + t13 * m32;
      t5[7] = t14 * m12 + t15 * m22 + t16 * m32;
      t5[8] = t2 * m13 + t6 * m23 + t7 * m33;
      t5[9] = t8 * m13 + t9 * m23 + t10 * m33;
      t5[10] = t11 * m13 + t12 * m23 + t13 * m33;
      t5[11] = t14 * m13 + t15 * m23 + t16 * m33;
  ...
  (function inheritance() {
    ...
    _inheritMany(W.EventTarget, [W.Node0, W.FileWriter, W.HttpRequestEventTarget, W.SourceBuffer, W._SourceBufferList_EventTarget_ListMixin, W.TextTrack, W.TextTrackCue, W._TextTrackList_EventTarget_ListMixin, W.VideoTrackList, W.Window, P.Request, P.AudioTrackList, P.BaseAudioContext]);
    _inheritMany(W.Node0, [W.Element, W.CharacterData, W.Document, W._Attr]);
    _inheritMany(W.Element, [W.HtmlElement, P.SvgElement]);
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.BaseElement, W.BodyElement, W.CanvasElement, W.DivElement, W.FormElement, W.ImageElement, W.InputElement, W.SelectElement, W.TableElement, W.TableRowElement, W.TableSectionElement, W.TemplateElement]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "ColorLiteGreen", "$get$ColorLiteGreen", function() {
      return T.Vector3_Vector3(0, 0.5, 0);
    });
    ...
    _lazy($, "gLightSources", "$get$gLightSources", function() {
      ...
      t1.Light$4("dir", 1, t2, t3);
      t2 = $.$get$posLight();
      t4 = $.$get$ColorLiteBlue();
      t5 = new G.PointLight(t2, 50, 3, T.Vector3$zero(), T.Vector3$zero(), "point");
      t5.Light$4("point", 3, t4, t3);
      t4 = $.$get$spotDirLight();
      t6 = $.$get$ColorLiteGreen();
      T.Matrix4$zero();
      T.Matrix4$zero();
      t4 = new G.SpotLight(t2, t4, 50, 0.4487989505128276, 2, 2, T.Vector3$zero(), T.Vector3$zero(), "spot");
      t4.Light$4("spot", 2, t6, t3);
      return P.LinkedHashMap_LinkedHashMap$_literal(["idDirectional", t1, "idPoint", t5, "idSpot", t4], P.String, G.Light);
    });
