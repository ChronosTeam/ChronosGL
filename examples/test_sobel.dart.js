...
["chronosgl", "package:chronosgl/chronosgl.dart", , B, {
  ...
  loadObj: function(url) {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new B.loadObj_closure(c, hr)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    hr.send("");
    return c.future;
  },
  doLoadObj: function(text) {
    var endResult, rawData, facemap, groups, currentGroup, lines, t1, index, t2, line, array, i, f, vtx, tex, nor, t3, t4, x, y, z, index0;
    endResult = B.MeshData2$empty();
    rawData = B.MeshData2$empty();
    ...
    for (t1 = new H.ListIterator(lines, lines.length, 0, null), index = 0; t1.moveNext$0();) {
      t2 = J.replaceAll$2$s(t1._current, "[ \t]+", " ");
      line = H.stringReplaceFirstUnchecked(t2, "ss*$", "");
      t2 = line.length;
      if (t2 !== 0) {
        if (0 >= t2)
      ...
      if (J.$eq(array[0], "g")) {
        ...
        if (J.$eq(array[0], "v")) {
          ...
          if (1 >= array.length)
            return H.ioore(array, 1);
          t2.push(H.Primitives_parseDouble(array[1], null));
          t2 = rawData.vertices;
          if (2 >= array.length)
            return H.ioore(array, 2);
          t2.push(H.Primitives_parseDouble(array[2], null));
          t2 = rawData.vertices;
          if (3 >= array.length)
            return H.ioore(array, 3);
          t2.push(H.Primitives_parseDouble(array[3], null));
        } else {
          if (0 >= array.length)
            return H.ioore(array, 0);
          if (J.$eq(array[0], "vt")) {
            ...
            if (J.$eq(array[0], "vn")) {
              ...
              if (J.$eq(array[0], "f")) {
                ...
                for (i = 1; i < 4; ++i) {
                  ...
                  if (i >= array.length)
                    return H.ioore(array, i);
                  t2.push(facemap.$index(0, array[i]));
  ...
  ChronosGL: {
    ...
    }, "run$0", "call$1", "call$0", "get$run", 0, 2, 14, 5],
  ...
  loadObj_closure: {
    ...
    call$1: function(e) {
      var result, t1;
      result = B.doLoadObj(W._convertNativeToDart_XHR_Response(this.hr_1.response));
      t1 = this.c_0.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
  ...
  Mesh: {
    ...
    draw2$1: function(program) {
      ...
      if (t3.normalAttribute != null) {
        J.bindBuffer$2$x(this.gl, 34962, this.normalsBuffer);
        J.vertexAttribPointer$6$x(this.gl, program.normalAttribute, 3, 5126, false, 0, 0);
      }
  ...
  MeshData2: {
    ...
    createMesh$0: function() {
      return B.Mesh$(new B.MeshData(new Float32Array(H._ensureNativeList(this.vertices)), new Float32Array(H._ensureNativeList(this.textureCoords)), new Float32Array(H._ensureNativeList(this.normals)), new Uint16Array(H._ensureNativeList(this.vertexIndices)), this.texture, this.texture2), false);
    },
  ...
  Node: {
    "^": "Spatial;name,type,enabled>,invert,children,mvMatrix,tempMatrix,matrix,_pos,_back,_up,_right",
    animate$1: function(_, elapsed) {
    },
    draw2$1: function(program) {
    },
  ...
  ShaderProgram: {
    ...
    draw$2: function(pMatrix, overrideMvMatrix) {
      ...
      if (t1.normalAttribute != null)
        J.enableVertexAttribArray$1$x(this.gl, this.normalAttribute);
      ...
      if (t1.normalAttribute != null)
        J.disableVertexAttribArray$1$x(this.gl, this.normalAttribute);
    },
    ...
    ShaderProgram$3: function(chronosGL, shaderObject, $name) {
      ...
      t1 = t2.normalAttribute;
      if (t1 != null)
        this.normalAttribute = J.getAttribLocation$2$x(this.gl, this.program, t1);
...
["", "test_sobel.dart", , U, {
  "^": "",
  main: [function() {
    var shaderObject, chronosGL, prg, camera, t1, t2;
    ...
    chronosGL = B.ChronosGL$("#webgl-canvas", 2520, shaderObject, 0.1, false, true);
    shaderObject = new B.ShaderObject(null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    shaderObject.modelViewMatrixUniform = "uMVMatrix";
    shaderObject.perpectiveMatrixUniform = "uPMatrix";
    prg = chronosGL.createProgram$2(0, "FixedVertexColor", shaderObject);
    ...
    if (t2 >= 16)
      return H.ioore(t1, t2);
    t1[t2] = 56;
    chronosGL.animatables.$indexSet(0, "flyingCamera", new B.FlyingCamera(camera, B.Vector$(0, 0, 0)));
    B.loadObj("ct_logo.obj").then$1(0, new U.main_closure(chronosGL, prg));
  }, "call$0", "main$closure", 0, 0, 2],
  main_closure: {
    "^": "Closure:26;chronosGL_0,prg_1",
    call$1: function(md) {
      var mesh, t1, s, c, t2, a10, a11, a12, a13, a20, a21, a22, a23, t3, a00, a01, a02, a03, t4, t5, t6, t7, t8, t9, up, x, y, z, len;
      ...
      new B.Matrix4(new Float32Array(16), B.Vector$(0, 0, 0), B.Vector$(0, 0, 0), B.Vector$(0, 0, 0)).identity$0();
      new B.Matrix4(new Float32Array(16), B.Vector$(0, 0, 0), B.Vector$(0, 0, 0), B.Vector$(0, 0, 0)).identity$0();
      t1 = new Float32Array(16);
      t3 = B.Vector$(0, 0, 0);
      t4 = B.Vector$(0, 0, 0);
      t5 = B.Vector$(0, 0, 0);
      t1 = new B.Matrix4(t1, t3, t4, t5);
      t1.identity$0();
      t6 = B.Vector$(0, 0, 0);
      B.Vector$(0, 0, 0);
      B.Vector$(0, 0, 0);
      ...
      t9[2] = t8[t7];
      up = B.Vector$(0, 1, 0);
      x = J.$sub$n(t6.array[0], t2.array[0]);
      y = J.$sub$n(t6.array[1], t2.array[1]);
      z = J.$sub$n(t6.array[2], t2.array[2]);
      t2 = J.getInterceptor$ns(x);
      t6 = J.getInterceptor$ns(y);
      t7 = J.getInterceptor$ns(z);
      t8 = J.$add$ns(J.$add$ns(t2.$mul(x, x), t6.$mul(y, y)), t7.$mul(z, z));
      if (typeof t8 !== "number")
        H.throwExpression(P.ArgumentError$(t8));
      len = Math.sqrt(t8);
      t8 = t3.array;
      if (len === 0) {
        t8[0] = 0;
        ...
        len = 1 / len;
        t8[0] = t2.$mul(x, len);
        t3.array[1] = t6.$mul(y, len);
        t3.array[2] = t7.$mul(z, len);
      }
      t5.cross2$2(up, t3);
      t2 = t5.array;
      x = t2[0];
      ...
      if (len === 0) {
        ...
        if (len === 1) {
          ...
          len = 1 / len;
          t8[0] = t2.$mul(x, len);
          t5.array[1] = t6.$mul(y, len);
          t5.array[2] = t7.$mul(z, len);
        }
      }
      t4.cross2$2(t3, t5);
      t1 = t1.array;
      ...
      t1[11] = 0;
      t1[15] = 1;
      this.prg_1.objects.push(mesh);
      this.chronosGL_0.run$0();
    }
  }
},
1],
...
B.MeshData2.$isMeshData2 = true;
B.MeshData2.$isObject = true;
...
{func: "dynamic__MeshData2", args: [B.MeshData2]},
];
$ = null;
...
//# sourceMappingURL=test_sobel.dart.js.map
//@ sourceMappingURL=test_sobel.dart.js.map
