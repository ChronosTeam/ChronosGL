...
["chronosgl", "package:chronosgl/chronosgl.dart", , B, {
  ...
  createTorusKnotInternal: function(heightScale, p, q, radius, segmentsR, segmentsT, texture, tube) {
    var vertices, uvs, indices, tang, n, bitan, grid, t1, i, t2, u, t3, t4, t5, t6, j, v, cx, cy, i0, ip, j0, jp, a, t7, b, c, d, uva, uvb, uvc, uvd;
    vertices = H.setRuntimeTypeInfo([], [P.$double]);
    uvs = H.setRuntimeTypeInfo([], [P.$double]);
    H.setRuntimeTypeInfo([], [P.$double]);
    indices = H.setRuntimeTypeInfo([], [P.$int]);
    tang = Q.Vector$(0, 0, 0);
    n = Q.Vector$(0, 0, 0);
    bitan = Q.Vector$(0, 0, 0);
    grid = H.setRuntimeTypeInfo(Array(segmentsR), [[P.List, P.$int]]);
    for (t1 = grid.length, i = 0; i < segmentsR; ++i) {
      t2 = Array(segmentsT);
      t2.$builtinTypeInfo = [P.$int];
      if (i >= t1)
        return H.ioore(grid, i);
      grid[i] = t2;
      u = i / segmentsR * 2 * p * 3.141592653589793;
      B.getTorusKnotPos(u, q, p, radius, heightScale, $.get$p1());
      B.getTorusKnotPos(u + 0.02, q, p, radius, heightScale, $.get$p2());
      t2 = $.get$p2().array;
      t3 = t2[0];
      t4 = $.get$p1().array;
      t5 = t4[0];
      ...
      t3[1] = t2[1] + t4[1];
      t3[2] = t2[2] + t4[2];
      bitan.cross2$2(tang, n).normalize$0(0);
      n.cross2$2(bitan, tang).normalize$0(0);
      for (j = 0; j < segmentsT; ++j) {
        ...
        t5 = t4[0];
        t6 = bitan.array;
        C.JSArray_methods.addAll$1(vertices, [t3 + cx * t5 + cy * t6[0], t2[1] + cx * t4[1] + cy * t6[1], t2[2] + cx * t4[2] + cy * t6[2]]);
        t6 = grid[i];
        t4 = C.JSInt_methods._tdivFast$1(vertices.length, 3);
        if (j >= t6.length)
          return H.ioore(t6, j);
        t6[j] = t4 - 1;
      }
    ...
    for (i = 0; i < segmentsR; i = i0)
      for (i0 = i + 1, t2 = i / segmentsR, t3 = i0 / segmentsR, j = 0; j < segmentsT; j = j0) {
        ip = C.JSInt_methods.$mod(i0, segmentsR);
        j0 = j + 1;
        jp = C.JSInt_methods.$mod(j0, segmentsT);
        if (i >= t1)
          return H.ioore(grid, i);
        t4 = grid[i];
        t5 = t4.length;
        ...
        b = t6[j];
        if (jp >= t7)
          return H.ioore(t6, jp);
        c = t6[jp];
        if (jp >= t5)
          return H.ioore(t4, jp);
        d = t4[jp];
        t4 = j / segmentsT;
        uva = [t2, t4];
        uvb = [t3, t4];
        ...
        uvc[0] = 1;
        uvd[0] = 0;
        C.JSArray_methods.addAll$1(indices, [a, b, c]);
        C.JSArray_methods.addAll$1(indices, [a, c, d]);
        C.JSArray_methods.addAll$1(uvs, uva);
        C.JSArray_methods.addAll$1(uvs, uvb);
        C.JSArray_methods.addAll$1(uvs, uvc);
        C.JSArray_methods.addAll$1(uvs, uvd);
        C.JSArray_methods.addAll$1(uvs, uvc);
        C.JSArray_methods.addAll$1(uvs, uvb);
      }
    return new B.MeshData(vertices, null, null, null, uvs, indices, texture, null, false);
  },
  getTorusKnotPos: function(u, in_q, in_p, radius, heightScale, vec) {
    var cu, su, quOverP, t1, t2;
    cu = Math.cos(u);
    su = Math.sin(u);
    quOverP = in_q / in_p * u;
    ...
    t2[1] = t1 * su * 0.5;
    t1 = Math.sin(quOverP);
    vec.array[2] = heightScale * radius * t1 * 0.5;
    return vec;
  },
  Animatable: {
    "^": "Object;"
  ...
  OrbitCamera: {
    ...
    animate$1: function(_, elapsed) {
      var t1, t2, t3, t4, rcp, t5, up, x, y, z, len;
      t1 = this.cpk;
      ...
      t4.setPos$3(rcp * Math.cos(H.checkNum(t3)), t2 * Math.sin(H.checkNum(t1)), rcp * Math.sin(H.checkNum(t3)));
      t3 = this.lookAt;
      t1 = t4.transform;
      t2 = $.Matrix4_POSX;
      t5 = t1.array;
      ...
      t5[t2] = C.JSNumber_methods.toDouble$0(t5[t2] + t3.array[0]);
      t2 = $.Matrix4_POSY;
      t5 = t1.array;
      if (t2 >= 16)
        return H.ioore(t5, t2);
      t5[t2] = C.JSNumber_methods.toDouble$0(t5[t2] + t3.array[1]);
      t2 = $.Matrix4_POSZ;
      t5 = t1.array;
      if (t2 >= 16)
        return H.ioore(t5, t2);
      t5[t2] = C.JSNumber_methods.toDouble$0(t5[t2] + t3.array[2]);
      t4 = t4.getPos$0();
      up = Q.Vector$(0, 1, 0);
      t2 = t1.newBack;
      t4 = t4.array;
    ...
    OrbitCamera$4: function(camera, radius, azimuth, polar) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new B.OrbitCamera_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = C.EventStreamProvider_mousemove.forTarget$1(document);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new B.OrbitCamera_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
  ...
  Instancer: {
    "^": "Object;mesh,count,enabled>,gl,instancedShader,translations,rotations,transformsBuffer,rotationsBuffer,q",
    draw$2: function(program, mvMatrix) {
      var extension, t1, transLocation, rotLocation, t2;
      extension = J.getExtension$1$x($.ChronosGL_globalGL, "ANGLE_instanced_arrays");
      t1 = this.mesh;
      t1.bindBuffers$1(program);
      t1.bindTextures$1(program);
      J.bindBuffer$2$x(this.gl, 34962, this.transformsBuffer);
      J.bufferDataTyped$3$x(this.gl, 34962, this.translations, 35044);
      transLocation = J.getAttribLocation$2$x(program.gl, program.program, "trans");
      J.enableVertexAttribArray$1$x(this.gl, transLocation);
      J.vertexAttribPointer$6$x(this.gl, transLocation, 3, 5126, false, 0, 0);
      J.vertexAttribDivisorAngle$2$x(extension, transLocation, 1);
      J.bindBuffer$2$x(this.gl, 34962, this.rotationsBuffer);
      J.bufferDataTyped$3$x(this.gl, 34962, this.rotations, 35044);
      rotLocation = J.getAttribLocation$2$x(program.gl, program.program, "rot");
      J.enableVertexAttribArray$1$x(this.gl, rotLocation);
      J.vertexAttribPointer$6$x(this.gl, rotLocation, 4, 5126, false, 0, 0);
      extension.vertexAttribDivisorANGLE(rotLocation, 1);
      J.uniformMatrix4fv$3$x(this.gl, program.modelViewMatrixUniform, false, mvMatrix.array);
      t2 = t1.vertexIndexBuffer;
      if (t2 == null) {
        P.print("arg");
        extension.drawArraysInstancedANGLE(4, 0, t1.numItems, this.count);
      } else {
        J.bindBuffer$2$x(this.gl, 34963, t2);
        t1 = t1.numItems;
        t2 = $.ChronosGL_useElementIndexUint ? 5125 : 5123;
        extension.drawElementsInstancedANGLE(4, t1, t2, 0, this.count);
      }
      extension.vertexAttribDivisorANGLE(transLocation, 0);
      extension.vertexAttribDivisorANGLE(rotLocation, 0);
      J.disableVertexAttribArray$1$x(this.gl, transLocation);
      J.disableVertexAttribArray$1$x(this.gl, rotLocation);
    },
    Instancer$2: function(mesh, count) {
      var shaderObject;
      this.gl = $.ChronosGL_globalGL;
      this.count = count;
      this.translations = new Float32Array(count * 3);
      this.rotations = new Float32Array(count * 4);
      shaderObject = new B.ShaderObject("Instanced", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, "", "", "", "");
      ...
      shaderObject.perpectiveMatrixUniform = "uPMatrix";
      shaderObject.modelViewMatrixUniform = "uMVMatrix";
      this.instancedShader = shaderObject;
      this.transformsBuffer = J.createBuffer$0$x(this.gl);
      this.rotationsBuffer = J.createBuffer$0$x(this.gl);
    }
  },
  Mesh: {
    ...
    bindTextures$1: function(program) {
      var t1 = program.shaderObject;
      if (t1.textureSamplerUniform != null) {
      ...
      t1.texture2SamplerUniform;
      t1.textureCubeSamplerUniform;
    },
  ...
  ShaderProgram: {
    ...
    drawInstancers$0: function() {
      var t1, t2, instancer;
      for (t1 = this.instancers, t1 = new H.ListIterator(t1, t1.length, 0, null), t2 = this.mvMatrix; t1.moveNext$0();) {
  ...
  Spatial: {
    "^": "Object;transform,_pos,_back,_up,_right",
    getPos$0: function() {
      var t1, t2, t3, t4;
      t1 = this._pos;
      t2 = $.Matrix4_POSX;
    ...
    setPos$3: function(x, y, z) {
      ...
      t2 = $.Matrix4_POSX;
      t3 = t1.array;
      t4 = C.JSNumber_methods.toDouble$0(x);
      if (t2 >= 16)
        return H.ioore(t3, t2);
      t3[t2] = t4;
      t4 = $.Matrix4_POSY;
      t2 = t1.array;
      t3 = C.JSNumber_methods.toDouble$0(y);
      if (t4 >= 16)
        return H.ioore(t2, t4);
      t2[t4] = t3;
      t3 = $.Matrix4_POSZ;
      t1 = t1.array;
      t4 = C.JSNumber_methods.toDouble$0(z);
      if (t3 >= 16)
...
["dart.dom.web_gl", "dart:web_gl", , P, {
  ...
  AngleInstancedArrays: {
    "^": "Interceptor;",
    vertexAttribDivisorAngle$2: function(receiver, index, divisor) {
      return receiver.vertexAttribDivisorANGLE(index, divisor);
    },
    "%": "ANGLEInstancedArrays"
  },
  RenderingContext: {
...
["", "instancer.dart", , U, {
  "^": "",
  main: [function() {
    var chronosGL, orbit, t1, m, t2, instancer, t3, spatial, n, x, t4, y, t5, z, t6, t7, t8, n0, t9, trace, root, i, j, k, t10, t11, t12, canvas, texture;
    chronosGL = B.ChronosGL$("#webgl-canvas", 1000, null, 0.1, false, false, false);
    orbit = B.OrbitCamera$(chronosGL._camera, 265, 0, 0);
    chronosGL.animateCallbacks.$indexSet(0, "rotateCamera", new U.main_closure(orbit));
    chronosGL.animatables.$indexSet(0, "orbitCam", orbit);
    chronosGL._utils.toString;
    t1 = B.createTorusKnotInternal(1, 2, 3, 12, 128, 16, null, 4);
    t1.optimize$0();
    m = B.Mesh$(t1, false);
    t1 = Q.Vector$(0, 0, 0);
    t2 = new Float32Array(9);
    t1 = new Q.Quaternion(null, t1, t2);
    t1.Quaternion$4(0, 0, 0, 1);
    instancer = new B.Instancer(m, null, true, null, null, null, null, null, null, t1);
    instancer.Instancer$2(m, 1000);
    t3 = new Q.Matrix4(new Float32Array(16), Q.Vector$(0, 0, 0), Q.Vector$(0, 0, 0), Q.Vector$(0, 0, 0));
    t3.identity$0();
    spatial = new B.Spatial(t3, Q.Vector$(0, 0, 0), Q.Vector$(0, 0, 0), Q.Vector$(0, 0, 0), Q.Vector$(0, 0, 0));
    for (n = 0, x = -5; x < 5; ++x)
      for (t4 = x * 40, y = -5; y < 5; ++y)
        for (t5 = y * 40, z = -5; z < 5; ++z, n = n0) {
          t6 = $.Matrix4_POSX;
          t7 = t3.array;
          t8 = C.JSInt_methods.toDouble$0(t4);
          if (t6 >= 16)
            return H.ioore(t7, t6);
          t7[t6] = t8;
          t8 = $.Matrix4_POSY;
          t6 = t3.array;
          t7 = C.JSInt_methods.toDouble$0(t5);
          if (t8 >= 16)
            return H.ioore(t6, t8);
          t6[t8] = t7;
          t7 = $.Matrix4_POSZ;
          t8 = t3.array;
          t6 = C.JSInt_methods.toDouble$0(z * 30);
          if (t7 >= 16)
            return H.ioore(t8, t7);
          t8[t7] = t6;
          n0 = n + 1;
          t6 = n * 3;
          J.setAll$2$ax(instancer.translations, t6, spatial.getPos$0().array);
          t7 = t3.array;
          t2[0] = t7[0];
          t2[1] = t7[1];
          t2[2] = t7[2];
          ...
          J.setAll$2$ax(instancer.rotations, t6, t7);
        }
    chronosGL.createProgram$1(0, instancer.instancedShader).instancers.push(instancer);
    t1 = chronosGL._utils;
    t2 = t1.chronosGL;
    canvas = t2._utils.createParticleCanvas$0();
    t2 = t2._utils;
    texture = J.createTexture$0$x(t2.gl);
    J.bindTexture$2$x(t2.gl, 3553, texture);
    J.texImage2DCanvas$6$x(t2.gl, 3553, 0, 6408, 6408, 5121, canvas);
    J.texParameteri$3$x(t2.gl, 3553, 10240, 9729);
    J.texParameteri$3$x(t2.gl, 3553, 10241, 9729);
    t1.addPointSprites$3(2000, texture, 100);
    chronosGL.run$0();
  }, "call$0", "main$closure", 0, 0, 1],
  main_closure: {
    "^": "Closure:28;orbit_0",
    call$2: function(elapsed, time) {
      var t1 = this.orbit_0;
      t1.azimuth = J.get$azimuth$x(t1) + 0.001;
    }
  }
},
1],
...
J.get$azimuth$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$azimuth(receiver);
};
...
J.vertexAttribDivisorAngle$2$x = function(receiver, a0, a1) {
  return J.getInterceptor$x(receiver).vertexAttribDivisorAngle$2(receiver, a0, a1);
};
