...
(function dartProgram() {
  ...
  L = {
    AddInstanceData: function(md, rand, count) {
      var scales, translations, rotations, t1, i, t2, t3, t4, t5, t;
      scales = new Float32Array(count);
      translations = new Float32Array(count * 3);
      rotations = new Float32Array(count * 4);
      for (t1 = [P.double], i = 0; i < count; ++i) {
        t2 = rand.nextDouble$0();
        t3 = rand.nextDouble$0();
        t4 = rand.nextDouble$0();
        ...
        t = new T.Vector3(t3);
        t.setFrom$1(new T.Vector3(t5));
        t.sub$1(0, new T.Vector3(t2));
        t.scale$1(0, 60);
        C.NativeFloat32List_methods.setAll$2(translations, i * 3, t3);
        t2 = rand.nextDouble$0();
        t3 = rand.nextDouble$0();
        t4 = rand.nextDouble$0();
        t5 = new Float32Array(3);
        ...
        new T.Quaternion(t2).setAxisAngle$2(new T.Vector3(t5), 2 * t4 * 3.141592653589793);
        C.NativeFloat32List_methods.setAll$2(rotations, i * 4, t2);
        C.NativeFloat32List_methods.setAll$2(scales, i, H.setRuntimeTypeInfo([2 + rand.nextDouble$0() * 4], t1));
      }
      md.AddAttribute$3("iaRotation", rotations, 4);
      md.AddAttribute$3("iaTranslation", translations, 3);
      md.AddAttribute$3("iaScale", scales, 1);
    },
    MakeNoiseTesture: function(cgl, rand) {
      var e, context, image, t1, i, v, t2, t3;
      e = document.createElement("canvas");
      e.width = 512;
      e.height = 512;
      context = e.getContext("2d");
      image = P.convertNativeToDart_ImageData(context.getImageData(0, 0, e.width, e.height));
      for (t1 = J.getInterceptor$x(image), i = 0; i < t1.get$data(image).length; i += 4) {
        v = 30 + rand.nextInt$1(225);
      ...
      t1 = $.$get$TexturePropertiesMipmap();
      if (t1 == null)
        t1 = new G.TextureProperties(1, 9729, 9729);
      ...
      t1.InstallLate$2(cgl, 3553);
      J.getError$0$x(cgl._gl);
      J.bindTexture$2$x(cgl._gl, 3553, null);
      return new G.ImageTexture(e, "noise", t2, 3553, cgl, t1);
    },
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, t10, t11, t12, orbit, perspective, width, height, rand, progPreparation, progInstanced, gb, md, desc, index, tex, depthTexture, err;
      t1 = {};
      t2 = document;
      ...
      J.clearColor$4$x(t4, 0.5, 0.5, 0.5, 1);
      t5 = H.setRuntimeTypeInfo([], [G.Light]);
      t6 = new Float32Array(64);
      ...
      t11.setFrom$1(t10);
      t12.setFrom$1(t9);
      C.JSArray_methods.add$1(t5, new G.DirectionalLight(t8, 1, t11, t12, "dir"));
      if (J.getExtension$1$x(t4, "EXT_color_buffer_float") == null)
        window.alert("extension not available: EXT_color_buffer_float");
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(100, 0, 0, 0, new T.Vector3(t4), -0.02, t8, t9, t10, new T.Vector3(t11), new T.Vector3(t12), "camera:orbit");
      t4 = new T.Matrix4(new Float32Array(16));
      t4.setIdentity$0();
      t8 = new T.Matrix4(new Float32Array(16));
      t8.setIdentity$0();
      perspective = new G.Perspective(orbit, 50, 1, 0.1, 1000, t4, t8, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), "perspective");
      ...
      rand = P._Random$(1);
      progPreparation = G.RenderProgram$("preparation", cgl, $.$get$preparationVertexShader(), $.$get$preparationFragmentShader());
      progInstanced = G.RenderProgram$("instanced", cgl, $.$get$instancedVertexShader(), $.$get$instancedFragmentShader());
      gb = B.CubeGeometry(1, 0, 1, 0, 1, 1, 1);
      t4 = progInstanced._cgl;
      t8 = progInstanced._shaderObjectV._canonicalToLayoutPos;
      t9 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t10 = J.createVertexArray$0$x(t4._gl);
      md = new G.MeshData(t4, t10, 4, t9, t8, -1, P.LinkedHashMap_LinkedHashMap$_empty(t2, P.Float32List), "meshdata:cube");
      t11 = G.FlattenVector3List(gb.vertices);
      t9.$indexSet(0, "aPosition", J.createBuffer$0$x(t4._gl));
      md._vertices = t11;
      md.ChangeAttribute$3("aPosition", t11, 3);
      desc = $.$get$_VarsDb().$index(0, "aPosition");
      if (desc == null)
        H.throwExpression("Unknown canonical aPosition");
      index = t8.$index(0, "aPosition");
      J.bindVertexArray$1$x(t4._gl, t10);
      t4.enableVertexAttribArray$2(0, index, 0);
      t4.vertexAttribPointer$7(0, t9.$index(0, "aPosition"), index, desc.GetSize$0(), 5126, false, 0, 0);
      t8 = H.assertSubtype(gb.GenerateFaceIndices$0(), "$isList", [P.int], "$asList");
      md._indexBuffer = J.createBuffer$0$x(t4._gl);
      t9 = md._vertices.length;
      if (t9 < 768) {
        md.set$_faces(new Uint8Array(H._ensureNativeList(t8)));
        md._indexBufferType = 5121;
      } else if (t9 < 196608) {
        md.set$_faces(new Uint16Array(H._ensureNativeList(t8)));
        md._indexBufferType = 5123;
      } else {
        md.set$_faces(new Uint32Array(H._ensureNativeList(t8)));
        md._indexBufferType = 5125;
      }
      J.bindVertexArray$1$x(t4._gl, t10);
      t8 = md._indexBuffer;
      t9 = md._faces;
      J.bindBuffer$2$x(t4._gl, 34963, t8);
      J.bufferData$3$x(t4._gl, 34963, t9, 35048);
      G._GeometryBuilderAttributesToMeshData(gb, md);
      L.AddInstanceData(md, rand, 80);
      P.print("instances: " + md.toString$0(0) + ".GetNumInstances()}");
      tex = G.TypedTexture$(cgl, "float", width, height, 34836, $.$get$TexturePropertiesFramebuffer());
      depthTexture = G.TypedTexture$(cgl, "frame::depth", width, height, 33190, $.$get$TexturePropertiesShadowMap());
      t4 = new G.Framebuffer(cgl, null, tex, depthTexture, null);
      t8 = J.createFramebuffer$0$x(cgl._gl);
      t4._framebuffer = t8;
      J.bindFramebuffer$2$x(cgl._gl, 36160, t8);
      J.framebufferTexture2D$5$x(cgl._gl, 36160, 36064, 3553, tex._texture, 0);
      J.framebufferTexture2D$5$x(cgl._gl, 36160, 36096, 3553, depthTexture._texture, 0);
      ...
      t9.setIdentity$0();
      t8._uniforms.$indexSet(0, "uModelMatrix", t9);
      t9 = G.Material$("mat");
      t10 = new T.Matrix4(new Float32Array(16));
      t10.setIdentity$0();
      t11 = t9._uniforms;
      t11.$indexSet(0, "uModelMatrix", t10);
      t11.$indexSet(0, "uShininess", 10);
      t11.$indexSet(0, "uTexture2", L.MakeNoiseTesture(cgl, rand));
      t11.$indexSet(0, "uTexture", tex);
      t1._lastTimeMs = 0;
      new L.main_animate(t1, orbit, new L.Phase(t4, t8, progPreparation, md), width, height, perspective, new L.Phase(new G.Framebuffer(cgl, null, null, null, null), t9, progInstanced, md), new G.Illumination(t5, t6, t7, P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), "illumination"), fps).call$1(0);
    },
    Phase: function Phase(t0, t1, t2, t3) {
      var _ = this;
      _.fb = t0;
      _.mat = t1;
      _.program = t2;
    ...
    main_animate: function main_animate(t0, t1, t2, t3, t4, t5, t6, t7, t8) {
      var _ = this;
      _._box_0 = t0;
      _.orbit = t1;
      _.prepare = t2;
  ...
  var holders = [C, H, J, P, W, G, R, D, A, T, L, B];
  ...
  G.TextureProperties.prototype = {
    InstallLate$2: function(cgl, type) {
      ...
      if (this.mipmap)
        J.generateMipmap$1$x(cgl._gl, type);
      if (this.shadow)
        J.texParameteri$3$x(cgl._gl, type, 34892, 34894);
    }
  };
  G.Texture.prototype = {
    toString$0: function(_) {
  ...
  L.Phase.prototype = {
    Run$3: function(width, height, extra) {
      var t1, t2, t3, uniforms;
      t1 = [G.UniformGroup];
      H.assertSubtype(extra, "$isList", t1, "$asList");
      t2 = this.fb;
      t3 = t2._cgl;
      t2 = t2._framebuffer;
      J.bindFramebuffer$2$x(t3._gl, 36160, t2);
      J.viewport$4$x(t3._gl, 0, 0, width, height);
      J.clear$1$x(t3._gl, 17664);
      uniforms = H.setRuntimeTypeInfo([this.mat], t1);
      C.JSArray_methods.addAll$1(uniforms, extra);
      this.program.Draw$2(this.md, uniforms);
    }
  };
  L.main_animate.prototype = {
    call$1: function(timeMs) {
      var t1, t2, t3, t4, t5, t6, t7, rcp, t8, t9, up, z, x, y, t10, t11, t12, t13, t14, t15, t16, t17, len, c, s, $C, m11, m12, m13, m21, m22, m23, m31, m32, m33;
      ...
      t7 = t9[7];
      t6 = t9[11];
      t9[0] = t2 * m11 + t12 * m21 + t10 * m31;
      t9[1] = t14 * m11 + t15 * m21 + t16 * m31;
      t9[2] = t17 * m11 + t8 * m21 + t11 * m31;
      t9[3] = t13 * m11 + t7 * m21 + t6 * m31;
      t9[4] = t2 * m12 + t12 * m22 + t10 * m32;
      t9[5] = t14 * m12 + t15 * m22 + t16 * m32;
      t9[6] = t17 * m12 + t8 * m22 + t11 * m32;
      t9[7] = t13 * m12 + t7 * m22 + t6 * m32;
      t9[8] = t2 * m13 + t12 * m23 + t10 * m33;
      t9[9] = t14 * m13 + t15 * m23 + t16 * m33;
      t9[10] = t17 * m13 + t8 * m23 + t11 * m33;
      t9[11] = t13 * m13 + t7 * m23 + t6 * m33;
      ...
      t3 = this.prepare;
      t3.mat._uniforms.$indexSet(0, "uTime", t1._lastTimeMs / 2000);
      t4 = this.width;
      t6 = this.height;
      t7 = this.perspective;
      t13 = [G.UniformGroup];
      t3.Run$3(t4, t6, H.setRuntimeTypeInfo([t7], t13));
      t3 = this.render;
      t3.mat._uniforms.$indexSet(0, "uTime", t1._lastTimeMs / 2000);
      t3.Run$3(t4, t6, H.setRuntimeTypeInfo([t7, this.illumination], t13));
  ...
  (function installTearOffs() {
    ...
    _static_1(W, "html_Element__determineMouseWheelEventType$closure", "Element__determineMouseWheelEventType", 28);
  ...
  (function inheritance() {
    ...
    _inheritMany(G.NamedEntity, [G.UniformGroup, G.Light, G.MeshData, G.RenderProgram, G.Spatial]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "TexturePropertiesMipmap", "$get$TexturePropertiesMipmap", function() {
      var t1 = G.TextureProperties$();
      t1.mipmap = true;
      t1.minFilter = 9987;
      t1.magFilter = 9729;
    ...
    _lazy($, "preparationFragmentShader", "$get$preparationFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("preparationF");
      t2 = [P.String];
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vNormal"], t2));
