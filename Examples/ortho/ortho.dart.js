...
(function dartProgram() {
  ...
  K = {
    main: function() {
      var _box_0, t1, t2, text, t3, fps, canvas, cgl, t4, t5, t6, t7, t8, orbit, prog, orthographic, phaseOrthograhic, perspective, phasePerspective, mat1, mat2, mat3, mat4, mat5, t9, t10, t11, t12, t13, nodes, _i, n;
      _box_0 = {};
      t1 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(25, 10, 0, 0, new T.Vector3(t3), -0.02, t4, t5, t6, new T.Vector3(t7), new T.Vector3(t8), "camera:orbit");
      prog = G.RenderProgram$("textured", cgl, $.$get$solidColorVertexShader(), $.$get$solidColorFragmentShader());
      t3 = new Float32Array(16);
      t4 = new Float32Array(16);
      t5 = new T.Matrix4(new Float32Array(16));
      t5.setIdentity$0();
      orthographic = new G.Orthographic(orbit, new T.Matrix4(t3), new T.Matrix4(t4), t5, 1, -20, 20, -20, -20, 100, P.LinkedHashMap_LinkedHashMap$_empty(t1, t2), "othrogrpahic");
      orthographic.Update$0();
      phaseOrthograhic = A.RenderPhase$("shadow", cgl);
      t5 = [G.UniformGroup];
      t4 = H.setRuntimeTypeInfo([orthographic], t5);
      t3 = [A.Node];
      t6 = H.setRuntimeTypeInfo([], t3);
      C.JSArray_methods.add$1(phaseOrthograhic._scenes, new A.Scene(prog, t4, t6, "objects"));
      t4 = new T.Matrix4(new Float32Array(16));
      t4.setIdentity$0();
      t7 = new T.Matrix4(new Float32Array(16));
      t7.setIdentity$0();
      perspective = new G.Perspective(orbit, 50, 1, 0.1, 1000, t4, t7, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t1, t2), "perspective");
      perspective.Update$0();
      phasePerspective = A.RenderPhase$("perspective", cgl);
      phasePerspective._clear_mode &= 4294950911;
      t1 = H.setRuntimeTypeInfo([perspective], t5);
      t2 = H.setRuntimeTypeInfo([], t3);
      C.JSArray_methods.add$1(phasePerspective._scenes, new A.Scene(prog, t1, t2, "objects"));
      ...
      mat4 = G.Material$("mat4");
      mat4._uniforms.$indexSet(0, "uColor", $.$get$ColorCyan());
      mat5 = G.Material$("plane");
      mat5._uniforms.$indexSet(0, "uColor", $.$get$ColorGray8());
      t1 = G.GeometryBuilderToMeshData("icosahedron-3", prog, B.IcosahedronGeometry(true, 1, 3));
      t4 = H.setRuntimeTypeInfo([], t3);
      ...
      new Float32Array(3);
      new Float32Array(3);
      t1 = new A.Node(mat1, t1, t4, new T.Matrix3(t5), t7, t8, new T.Vector3(t9), new T.Vector3(t10), "sphere");
      t1.setPos$3(0, 0, 0);
      t4 = R.ShapeCube(prog, 1, 1, 1);
      ...
      new Float32Array(3);
      new Float32Array(3);
      t4 = new A.Node(mat2, t4, t5, new T.Matrix3(t7), t8, t9, new T.Vector3(t10), new T.Vector3(t11), "cube");
      t4.setPos$3(-5, 0, -5);
      t5 = G.GeometryBuilderToMeshData("cylinder-32", prog, B.CylinderGeometry(3, 6, 2, 32, true));
      ...
      new Float32Array(3);
      new Float32Array(3);
      t5 = new A.Node(mat3, t5, t7, new T.Matrix3(t8), t9, t10, new T.Vector3(t11), new T.Vector3(t12), "cylinder");
      t5.setPos$3(5, 0, -5);
      t7 = G.GeometryBuilderToMeshData("torusknot", prog, B.TorusKnotGeometry(true, 1, 2, 3, 1, 128, 16, 0.4));
      ...
      new Float32Array(3);
      new Float32Array(3);
      t7 = new A.Node(mat4, t7, t8, new T.Matrix3(t9), t10, t11, new T.Vector3(t12), new T.Vector3(t13), "torus");
      t7.setPos$3(5, 0, 5);
      t8 = R.ShapeCube(prog, 20, 0.1, 20);
      ...
      new Float32Array(3);
      new Float32Array(3);
      t3 = new A.Node(mat5, t8, t3, new T.Matrix3(t9), t10, t11, new T.Vector3(t12), new T.Vector3(t13), "cube");
      t3.setPos$3(0, -10, 0);
      nodes = [t1, t4, t5, t7, t3];
      for (_i = 0; _i < 5; ++_i) {
        n = nodes[_i];
        C.JSArray_methods.add$1(t6, n);
        C.JSArray_methods.add$1(t2, n);
      }
      t1 = new K.main_resolutionChange(canvas, perspective, orthographic, phaseOrthograhic, phasePerspective);
      t1.call$1(null);
      t2 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(t1, {func: 1, ret: -1, args: [t2]}), false, t2);
      _box_0._lastTimeMs = 0;
      new K.main_animate(_box_0, orbit, phaseOrthograhic, phasePerspective, fps).call$1(0);
    },
    main_resolutionChange: function main_resolutionChange(t0, t1, t2, t3, t4) {
      var _ = this;
      _.canvas = t0;
      _.perspective = t1;
      _.orthographic = t2;
      _.phaseOrthograhic = t3;
      _.phasePerspective = t4;
    },
    main_animate: function main_animate(t0, t1, t2, t3, t4) {
      var _ = this;
      _._box_0 = t0;
      _.orbit = t1;
      _.phaseOrthograhic = t2;
      _.phasePerspective = t3;
      _.fps = t4;
    }
  };
  ...
  G.Orthographic.prototype = {
    ...
    Update$0: function() {
      var t1, t2, w, t3, t4, t5, t6, t7, tmb, fmn;
      t1 = this._r;
      t2 = this._l;
      w = t1 - t2;
      t3 = this._proj;
      t4 = this._d;
      t5 = t4 + w / this._aspect;
      t6 = this._lib$_f;
      t7 = this._b;
      tmb = t5 - t4;
      fmn = t7 - t6;
  ...
  G.Perspective.prototype = {
    ...
    Update$0: function() {
      var t1, t2, t3, t4, height, near_minus_far;
      t1 = this._mat;
      t2 = this._aspect;
      t3 = this._near;
      t4 = this._far;
      height = Math.tan(this._fov * 3.141592653589793 / 180 * 0.5);
      near_minus_far = t3 - t4;
      t1.setZero$0();
      t1 = t1._m4storage;
      t1[0] = 1 / (height * t2);
      t1[5] = 1 / height;
      t1[10] = (t4 + t3) / near_minus_far;
      t1[11] = -1;
      t1[14] = 2 * t3 * t4 / near_minus_far;
    },
    GetUniforms$0: function() {
      var t1, t2, t3;
      t1 = this._camera;
  ...
  A.RenderPhase.prototype = {
    Draw$0: function() {
      var t1, t2, t3, t4, t5, t6, _i, scene, uniforms, modelMatrix, t7, _i0;
      ...
      J.bindFramebuffer$2$x(t6._gl, 36160, t1);
      J.viewport$4$x(t6._gl, t3, this.viewPortY, t4, t5);
      if (t2 !== 0)
        J.clear$1$x(t6._gl, t2);
  ...
  K.main_resolutionChange.prototype = {
    call$1: function(ev) {
      ...
      this.orthographic.AdjustAspect$2(t1, h);
      t2 = this.phaseOrthograhic;
      t2.viewPortW = t1;
      t2.viewPortH = h;
      t3 = this.phasePerspective;
      t3.viewPortW = t1;
      t3.viewPortH = h;
      t2.viewPortX = t1;
    },
  ...
  K.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      this.phaseOrthograhic.Draw$0();
      this.phasePerspective.Draw$0();
  ...
  (function inheritance() {
    ...
    _inheritMany(G.UniformGroup, [G.Material, G.Orthographic, G.Perspective]);
