...
(function dartProgram() {
  ...
  Q = {
    main: function() {
      var _box_0, t1, t2, text, t3, fps, canvas, w, h, cgl, t4, t5, t6, t7, t8, orbit, perspective, phase, sceneBuilding, mat, md, t9, sx, sy, sz, t10, q, gb, uvs, i, house, x, z;
      _box_0 = {};
      t1 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(25, 0, 0, 0, new T.Vector3(t3), -0.02, t4, t5, t6, new T.Vector3(t7), new T.Vector3(t8), "camera:orbit");
      t3 = new T.Matrix4(new Float32Array(16));
      t3.setIdentity$0();
      t4 = new T.Matrix4(new Float32Array(16));
      t4.setIdentity$0();
      perspective = new G.Perspective(orbit, 50, 1, 0.1, 1000, t3, t4, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t1, t2), "perspective");
      ...
      t4 = G.RenderProgram$("building", cgl, $.$get$skyScraperVertexShader(), $.$get$skyScraperFragmentShader());
      t5 = [G.UniformGroup];
      t6 = H.setRuntimeTypeInfo([perspective], t5);
      t7 = [A.Node];
      t8 = H.setRuntimeTypeInfo([], t7);
      sceneBuilding = new A.Scene(t4, t6, t8, "building");
      C.JSArray_methods.add$1(t3, sceneBuilding);
      t4 = G.RenderProgram$("sky", cgl, $.$get$demoVertexShader(), $.$get$demoFragmentShader());
      t5 = H.setRuntimeTypeInfo([perspective], t5);
      t6 = H.setRuntimeTypeInfo([], t7);
      C.JSArray_methods.add$1(t3, new A.Scene(t4, t5, t6, "sky"));
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(t1, t2);
      mat = new G.Material(t1, "mat");
      ...
      md = G.GeometryBuilderToMeshData("icosahedron-3", t4, B.IcosahedronGeometry(true, 1, 3));
      ...
      t3[14] = t3[14];
      t3[15] = t3[15];
      C.JSArray_methods.add$1(t6, new A.Node(mat, md, t4, new T.Matrix3(t1), t2, t5, new T.Vector3(t8), new T.Vector3(t9), md.name));
      q = new T.Vector2(new Float32Array(2));
      q.setValues$2(0.01, 0.01);
      gb = B.CubeGeometry(0.99, 0.01, 0.99, 0.01, 1, 2, 1);
      uvs = gb.attributes.$index(0, "aTexUV");
      for (i = 8; i < 16; ++i) {
        if (i >= uvs.length)
          return H.ioore(uvs, i);
        uvs[i].setFrom$1(q);
      }
      house = G.GeometryBuilderToMeshData("house", sceneBuilding.program, gb);
      for (t1 = sceneBuilding.nodes, t2 = house.name, x = -10; x < 10; x += 4)
        for (z = -10; z < 10; z += 4) {
          ...
          t6[13] = 0;
          t6[14] = z;
          C.JSArray_methods.add$1(t1, new A.Node(mat, house, t3, new T.Matrix3(t4), t5, t8, new T.Vector3(t9), new T.Vector3(t10), t2));
        }
      _box_0._lastTimeMs = 0;
      new Q.main_animate(_box_0, orbit, phase, fps).call$1(0);
    },
  ...
  T.Matrix3.prototype = {
    setFrom$1: function(arg) {
      var argStorage, t1;
      argStorage = H.interceptedTypeCheck(arg, "$isMatrix3")._m3storage;
      t1 = this._m3storage;
      t1[8] = argStorage[8];
      t1[7] = argStorage[7];
      t1[6] = argStorage[6];
  ...
  T.Matrix4.prototype = {
    setFrom$1: function(arg) {
      var argStorage, t1;
      argStorage = H.interceptedTypeCheck(arg, "$isMatrix4")._m4storage;
      t1 = this._m4storage;
      t1[15] = argStorage[15];
      t1[14] = argStorage[14];
      t1[13] = argStorage[13];
  ...
  T.Vector3.prototype = {
    ...
    setFrom$1: function(other) {
      var otherStorage, t1;
      otherStorage = H.interceptedTypeCheck(other, "$isVector3")._v3storage;
      t1 = this._v3storage;
      t1[0] = otherStorage[0];
      t1[1] = otherStorage[1];
      t1[2] = otherStorage[2];
  ...
  T.Vector4.prototype = {
    setFrom$1: function(other) {
      var otherStorage, t1;
      otherStorage = H.interceptedTypeCheck(other, "$isVector4")._v4storage;
      t1 = this._v4storage;
      t1[3] = otherStorage[3];
      t1[2] = otherStorage[2];
      t1[1] = otherStorage[1];
  ...
  (function inheritance() {
    ...
    _inheritMany(W.Node0, [W.Element, W.CharacterData, W._Attr]);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "skyScraperVertexShader", "$get$skyScraperVertexShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("SkyScraperV");
      t2 = [P.String];
      t1.AddAttributeVars$1(H.setRuntimeTypeInfo(["aPosition", "aTexUV"], t2));
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vPosition", "vTexUV"], t2));
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uPerspectiveViewMatrix", "uModelMatrix"], t2));
      t1.SetBody$1(H.setRuntimeTypeInfo(["void main() {     \n    gl_Position = uPerspectiveViewMatrix * uModelMatrix * vec4(aPosition, 1.0);\n    vPosition = aPosition;\n    vTexUV = aTexUV;\n}\n"], t2));
      return t1;
    });
    _lazy($, "skyScraperFragmentShader", "$get$skyScraperFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("SkyScraperF");
      t2 = [P.String];
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vPosition", "vTexUV"], t2));
