...
["chronosgl", "package:chronosgl/chronosgl.dart", , B, {
  ...
  Mesh: {
    ...
    draw2$1: function(program) {
      ...
      if (t3.texture2SamplerUniform != null) {
        J.activeTexture$1$x(this.gl, 33985);
        J.bindTexture$2$x(this.gl, 3553, this.texture2);
        J.uniform1i$2$x(this.gl, program.sampler2Uniform, 1);
      }
  ...
  ShaderProgram: {
    ...
    ShaderProgram$3: function(chronosGL, shaderObject, $name) {
      ...
      t1 = t2.texture2SamplerUniform;
      if (t1 != null)
        this.sampler2Uniform = J.getUniformLocation$2$x(this.gl, this.program, t1);
      t1 = t2.cameraNear;
      if (t1 != null)
...
["", "test_ssao.dart", , K, {
  ...
  main: [function() {
    ...
    B.loadObj("ct_logo.obj").then$1(0, new K.main_closure(chronosGL, prg));
...
//# sourceMappingURL=test_ssao.dart.js.map
//@ sourceMappingURL=test_ssao.dart.js.map
