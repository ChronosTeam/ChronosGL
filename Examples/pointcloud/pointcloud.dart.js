...
(function dartProgram() {
  ...
  R = {
    ...
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, orbit, perspective, prog, bindingIndex, gb, md, out, out0;
      t1 = {};
      $.$get$_VarsDb().$indexSet(0, "aCurrentPosition", C.ShaderVarDesc_vec3_0);
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(7, 0, 0, 0, new T.Vector3(t5), -0.02, t6, t2, t7, new T.Vector3(t8), new T.Vector3(t9), "camera:orbit");
      t2 = new T.Matrix4(new Float32Array(16));
      t2.setIdentity$0();
      t5 = new T.Matrix4(new Float32Array(16));
      t5.setIdentity$0();
      perspective = new R.PerspectiveResizeAware(canvas, cgl, orbit, 50, 1, 0.1, 1000, t2, t5, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t3, t4), "perspective");
      perspective.Update$0();
      perspective.resolutionChange$1(null);
      t2 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(perspective.get$resolutionChange(), {func: 1, ret: -1, args: [t2]}), false, t2);
      prog = G.RenderProgram$("fireworks", cgl, $.$get$fireworksVertexShader(), $.$get$fireworksFragmentShader());
      t2 = prog._shaderObjectV;
      ...
      t3.setIdentity$0();
      t4.$indexSet(0, "uModelMatrix", t3);
      gb = B.TorusKnotGeometry(true, 1, 2, 3, 1, 2048, 128, 0.2);
      t3 = prog._cgl;
      t2 = t2._canonicalToLayoutPos;
      md = G.MeshData$("torusknot", t3, 4, t2);
      ...
      J.bindVertexArray$1$x(t6._gl, md._vao);
      t5 = md._indexBuffer;
      t7 = md._faces;
      J.bindBuffer$2$x(t6._gl, 34963, t5);
      J.bufferData$3$x(t6._gl, 34963, t7, 35048);
      G._GeometryBuilderAttributesToMeshData(gb, md);
      out = G.MeshData$(md.name, t3, 0, t2);
      out.AddVertices$1(md._vertices);
      out.AddAttribute$3("aNormal", md._attributes.$index(0, "aNormal"), 3);
      t5 = out._attributes;
      out.AddAttribute$3("aCurrentPosition", t5.$index(0, "aPosition"), 3);
      out0 = G.MeshData$("out", t3, 0, t2);
      out0.AddVertices$1(t5.$index(0, "aPosition"));
      J.bindBuffer$2$x(cgl._gl, 34962, null);
      J.bindBufferBase$3$x(cgl._gl, 35982, bindingIndex, null);
      t5 = out0._buffers.$index(0, "aPosition");
      J.bindBufferBase$3$x(cgl._gl, 35982, bindingIndex, t5);
      t1._lastTimeMs = 0;
      new R.main_animate(t1, orbit, new G.Material(t4, "torus-mat"), prog, out, perspective, cgl, out0, fps).call$1(0);
    },
  ...
  B = {
    TorusKnotGeometry: function(computeNormals, heightScale, p, q, radius, segmentsR, segmentsT, tubeRadius) {
      var pointsAndTangents, t1, h, bands, _i, b, w, t2, t3, t4, gb, lst, i, t5, desc, ts;
      ...
      switch (desc.type) {
        case "vec2":
          gb.attributes.$indexSet(0, "aNormal", H.setRuntimeTypeInfo([], [T.Vector2]));
          break;
        case "vec3":
          gb.attributes.$indexSet(0, "aNormal", H.setRuntimeTypeInfo([], t3));
          break;
        case "vec4":
          gb.attributes.$indexSet(0, "aNormal", H.setRuntimeTypeInfo([], [T.Vector4]));
          break;
        case "float":
          gb.attributes.$indexSet(0, "aNormal", H.setRuntimeTypeInfo([], [P.double]));
          break;
        case "uvec4":
          gb.attributes.$indexSet(0, "aNormal", H.setRuntimeTypeInfo([], [[P.List, P.int]]));
          break;
      }
  ...
  var holders = [C, H, J, P, W, G, R, B, D, A, T];
  ...
  G.ShaderObject.prototype = {
    ...
    AddUniformVars$1: function(names) {
      var t1, _i;
      H.assertSubtype(names, "$isList", [P.String], "$asList");
      for (t1 = this.uniformVars, _i = 0; _i < 4; ++_i)
  ...
  R.main_animate.prototype = {
    call$1: function(timeMs) {
      var _lastTimeMs, t1, t2, t3, t4, t5, t6, rcp, t7, t8, up, z, x, y, t9, t10, t11, t12, t13, t14, t15, t16, len, c, s, $C, m11, m12, m13, m21, m22, m23, m31, m32, m33;
      H.numTypeCheck(timeMs);
      if (typeof timeMs !== "number")
        return timeMs.$sub();
      _lastTimeMs = timeMs + 0;
      this._box_0._lastTimeMs = _lastTimeMs;
      t1 = this.orbit;
      t1.azimuth += 0.003;
      t2 = t1.mouse;
      ...
      t3 = this.points;
      this.prog.Draw$2(t3, H.setRuntimeTypeInfo([this.perspective, t2], [G.UniformGroup]));
      t2 = this.cgl;
      t7 = t3._buffers.$index(0, "aCurrentPosition");
      J.bindBuffer$2$x(t2._gl, 34962, t7);
      t7 = this.out._buffers.$index(0, "aPosition");
      J.bindBuffer$2$x(t2._gl, 35982, t7);
      t3 = t3.GetNumItems$0();
      J.copyBufferSubData$5$x(t2._gl, 35982, 34962, 0, 0, t3 * 3 * 4);
      C.Window_methods.get$animationFrame(window).then$1$1(this, -1);
      this.fps.UpdateFrameCount$1(_lastTimeMs);
    },
    $signature: 28
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(R.PerspectiveResizeAware.prototype, "get$resolutionChange", "resolutionChange$1", 24);
  })();
