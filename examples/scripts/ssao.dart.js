...
["chronosgl", "package:chronosgl/chronosgl.dart", , B, {
  ...
  Mesh: {
    ...
    draw2$1: function(program) {
      var t1, t2, t3, activeTextureCounter, t4;
      t1 = this.debug;
      if (t1) {
      ...
      if (t3.textureSamplerUniform != null) {
        ...
        activeTextureCounter = 1;
      } else
        activeTextureCounter = 0;
      if (t3.texture2SamplerUniform != null) {
        J.activeTexture$1$x(this.gl, 33984 + activeTextureCounter);
        J.bindTexture$2$x(this.gl, 3553, this.texture2);
        J.uniform1i$2$x(this.gl, program.texture2SamplerUniform, activeTextureCounter);
      }
  ...
  ShaderProgram: {
    ...
    ShaderProgram$3: function(chronosGL, shaderObject, $name) {
      ...
      if (t1 != null)
        this.texture2SamplerUniform = J.getUniformLocation$2$x(this.gl, this.program, t1);
...
["", "ssao.dart", , B, {
  ...
  main: [function() {
    ...
    shaderObject = new B.ShaderObject("SSAO", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, "", "", "", "");
    ...
    B.loadObj("ct_logo.obj").then$1(new B.main_closure(chronosGL, prg));
