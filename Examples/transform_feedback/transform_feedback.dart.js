...
(function dartProgram() {
  ...
  J = {
    ...
    bindBufferBase$3$x: function(receiver, a0, a1, a2) {
      return J.getInterceptor$x(receiver).bindBufferBase$3(receiver, a0, a1, a2);
    },
    bindTexture$2$x: function(receiver, a0, a1) {
      return J.getInterceptor$x(receiver).bindTexture$2(receiver, a0, a1);
    },
    bindTransformFeedback$2$x: function(receiver, a0, a1) {
      return J.getInterceptor$x(receiver).bindTransformFeedback$2(receiver, a0, a1);
    },
    ...
    copyBufferSubData$5$x: function(receiver, a0, a1, a2, a3, a4) {
      return J.getInterceptor$x(receiver).copyBufferSubData$5(receiver, a0, a1, a2, a3, a4);
    },
    ...
    createTransformFeedback$0$x: function(receiver) {
      return J.getInterceptor$x(receiver).createTransformFeedback$0(receiver);
    },
  ...
  G = {
    ...
    Material$Transparent: function($name, beq) {
      var t1 = P.LinkedHashMap_LinkedHashMap$_empty(P.String, P.Object);
      t1.$indexSet(0, "cDepthTest", true);
      t1.$indexSet(0, "cDepthWrite", false);
      t1.$indexSet(0, "cBlendEquation", beq);
  ...
  R = {
    Utils_createParticleCanvas: function() {
      var e, ctx, gradient;
  ...
  Z = {
    RandomVector: function(rng, d) {
      var t1, t2, t3, t4;
      t1 = rng.nextDouble$0();
      t2 = rng.nextDouble$0();
      t3 = rng.nextDouble$0();
      t4 = new T.Vector3(new Float32Array(3));
      t4.setValues$3(t1 - 0.5, t2 - 0.5, t3 - 0.5);
      t4.scale$1(0, d);
      return t4;
    },
    MakeRowOfPoles: function(xx, y, z, scale) {
      var out, _i, x, t1, t2;
      H.assertSubtype(xx, "$isList", [P.double], "$asList");
      out = H.setRuntimeTypeInfo([], [Z.Pole]);
      for (_i = 0; _i < 5; ++_i) {
        x = xx[_i];
        ...
        t2.setFrom$1(new T.Vector3(t1));
        t2.scale$1(0, scale);
        t1 = new T.Vector3(new Float32Array(3));
        t1.setFrom$1(t2);
        C.JSArray_methods.add$1(out, new Z.Pole(t1));
      }
      return out;
    },
    ExtractPolePos: function(poles) {
      var t1, out, t2, n, _i, t3, t4, t5;
      H.assertSubtype(poles, "$isList", [Z.Pole], "$asList");
      t1 = poles.length;
      out = new Float32Array(3 * t1);
      for (t1 = poles.length, t2 = out.length, n = 0, _i = 0; _i < t1; ++_i) {
        t3 = poles[_i]._pos._v3storage;
        t4 = t3[0];
        if (n >= t2)
          return H.ioore(out, n);
        out[n] = t4;
        t4 = n + 1;
        t5 = t3[1];
        if (t4 >= t2)
    ...
    ExtractIonPos: function(ions, out) {
      var t1, t2, n, _i, t3, t4, t5;
      H.assertSubtype(ions, "$isList", [Z.Ion], "$asList");
      for (t1 = ions.length, t2 = out.length, n = 0, _i = 0; _i < t1; ++_i) {
        t3 = ions[_i]._pos._v3storage;
        t4 = t3[0];
        if (n >= t2)
          return H.ioore(out, n);
        out[n] = t4;
    ...
    main: function() {
      var t1, t2, t3, text, t4, fps, rng, canvas, width, height, cgl, t5, t6, t7, t8, t9, orbit, perspective, programJS, programGPU, bindingIndex, srcPoles, dstPoles, ions, ionsPos, matJS, mdJS, matGPU, mdOut, mdIn, transform;
      t1 = {};
      t2 = $.$get$_VarsDb();
      t2.$indexSet(0, "uSources", C.ShaderVarDesc_vec3_5);
      t2.$indexSet(0, "uSinks", C.ShaderVarDesc_vec3_5);
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(15, 0.5, 0.5, 0, new T.Vector3(t4), -0.02, t5, t6, t7, new T.Vector3(t8), new T.Vector3(t9), "camera:orbit");
      ...
      programJS = G.RenderProgram$("CPU", cgl, $.$get$pointSpritesVertexShader(), $.$get$pointSpritesFragmentShader());
      programGPU = G.RenderProgram$("GPU", cgl, $.$get$particleVertexShader(), $.$get$particleFragmentShader());
      t2 = programGPU._shaderObjectV;
      bindingIndex = C.JSArray_methods.indexOf$1(t2.transformVars, "tPosition");
      P.print("@@@@ " + bindingIndex);
      t3 = [P.double];
      srcPoles = Z.MakeRowOfPoles(H.setRuntimeTypeInfo([2, 1, 0, -1, -2], t3), 0, 2, 3);
      dstPoles = Z.MakeRowOfPoles(H.setRuntimeTypeInfo([2, 1, 0, -1, -2], t3), 0, -2, 3);
      t3 = Z.RandomVector(rng, 10010);
      t4 = new T.Vector3(new Float32Array(3));
      t4.setFrom$1(t3);
      ions = H.setRuntimeTypeInfo([new Z.Ion(t4)], [Z.Ion]);
      t4 = ions.length;
      ionsPos = new Float32Array(3 * t4);
      t1.ionsPos = ionsPos;
      Z.ExtractIonPos(ions, ionsPos);
      t3 = $.$get$BlendEquationMix();
      matJS = G.Material$Transparent("stars", t3);
      t4 = matJS._uniforms;
      t4.$indexSet(0, "uTexture", G.ImageTexture$(cgl, "Utils::Particles", R.Utils_createParticleCanvas()));
      t5 = new T.Matrix4(new Float32Array(16));
      t5.setIdentity$0();
      t4.$indexSet(0, "uModelMatrix", t5);
      t4.$indexSet(0, "uPointSize", 200);
      mdJS = G.MeshData$("mdJS", programJS._cgl, 0, programJS._shaderObjectV._canonicalToLayoutPos);
      mdJS.AddVertices$1(ionsPos);
      matGPU = G.Material$Transparent("stars", t3);
      t3 = matGPU._uniforms;
      t3.$indexSet(0, "uTexture", G.ImageTexture$(cgl, "Utils::Particles", R.Utils_createParticleCanvas()));
      t4 = new T.Matrix4(new Float32Array(16));
      t4.setIdentity$0();
      t3.$indexSet(0, "uModelMatrix", t4);
      t3.$indexSet(0, "uPointSize", 200);
      t3.$indexSet(0, "uSources", Z.ExtractPolePos(srcPoles));
      t3.$indexSet(0, "uSinks", Z.ExtractPolePos(dstPoles));
      t3 = programGPU._cgl;
      t2 = t2._canonicalToLayoutPos;
      mdOut = G.MeshData$("ionsOut", t3, 0, t2);
      mdOut.AddVertices$1(ionsPos);
      mdIn = G.MeshData$("ionsIn", t3, 0, t2);
      mdIn.AddVertices$1(ionsPos);
      t2 = new Z.main_ResizeIons(t1, ions, rng, cgl, bindingIndex, mdOut, mdIn);
      transform = J.createTransformFeedback$0$x(cgl._gl);
      J.bindTransformFeedback$2$x(cgl._gl, 36386, transform);
      t2.call$1(null);
      t3 = $.$get$gParticles();
      t3.toString;
      t4 = W.Event;
      W._EventStreamSubscription$(t3, "change", H.functionTypeCheck(t2, {func: 1, ret: -1, args: [t4]}), false, t4);
      new Z.main_animate(orbit, new Z.main_UpdateIonsJS(t1, ions, srcPoles, dstPoles, rng, mdJS), programJS, mdJS, perspective, matJS, programGPU, mdIn, matGPU, cgl, mdOut, ions, fps).call$1(0);
    },
    Pole: function Pole(t0) {
      this._pos = t0;
    },
    Ion: function Ion(t0) {
      this._pos = t0;
    },
    main_ResizeIons: function main_ResizeIons(t0, t1, t2, t3, t4, t5, t6) {
      var _ = this;
      _._box_0 = t0;
      _.ions = t1;
      _.rng = t2;
    ...
    main_UpdateIonsJS: function main_UpdateIonsJS(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._box_0 = t0;
      _.ions = t1;
      _.srcPoles = t2;
    ...
    main_animate: function main_animate(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12) {
      var _ = this;
      _.orbit = t0;
      _.UpdateIonsJS = t1;
      _.programJS = t2;
  ...
  var holders = [C, H, J, P, W, G, R, D, A, T, Z];
  ...
  P.RenderingContext2.prototype = {
    ...
    bindBufferBase$3: function(receiver, target, index, buffer) {
      return receiver.bindBufferBase(target, index, buffer);
    },
    bindTransformFeedback$2: function(receiver, target, feedback) {
      return receiver.bindTransformFeedback(target, feedback);
    },
    bindVertexArray$1: function(receiver, vertexArray) {
      return receiver.bindVertexArray(vertexArray);
    },
    copyBufferSubData$5: function(receiver, readTarget, writeTarget, readOffset, writeOffset, size) {
      return receiver.copyBufferSubData(readTarget, writeTarget, readOffset, writeOffset, size);
    },
    createTransformFeedback$0: function(receiver) {
  ...
  G.MeshData.prototype = {
    ChangeVertices$1: function(data) {
      var t1, t2;
      this._vertices = data;
      this._attributes.$indexSet(0, "aPosition", data);
      t1 = this._cgl;
      t2 = this._buffers.$index(0, "aPosition");
    ...
    AddVertices$1: function(data) {
      ...
      J.enableVertexAttribArray$1$x(t2._gl, index);
      t1 = t1.$index(0, "aPosition");
      t3 = desc.GetSize$0();
      J.bindBuffer$2$x(t2._gl, 34962, t1);
      J.vertexAttribPointer$6$x(t2._gl, index, t3, 5126, false, 0, 0);
    },
    toString$0: function(_) {
      var lst, t1, t2, t3;
  ...
  G.ShaderObject.prototype = {
    ...
    AddTransformVars$1: function(names) {
      var t1, _i;
      H.assertSubtype(names, "$isList", [P.String], "$asList");
      for (t1 = this.transformVars, _i = 0; _i < 1; ++_i)
  ...
  D.Mouse.prototype = {
    Mouse$1: function(elem) {
      ...
      t2 = H.getTypeArgumentByIndex(t1, 0);
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new D.Mouse_closure(this), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = C.CanvasElement_methods.get$onMouseDown(elem);
      t1 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new D.Mouse_closure0(this), {func: 1, ret: -1, args: [t1]}), false, t1);
      t1 = C.CanvasElement_methods.get$onMouseUp(elem);
      t2 = H.getTypeArgumentByIndex(t1, 0);
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new D.Mouse_closure1(this), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = C.CanvasElement_methods.get$onMouseWheel(elem);
      t1 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new D.Mouse_closure2(this), {func: 1, ret: -1, args: [t1]}), false, t1);
    }
  };
  ...
  Z.Pole.prototype = {
    toString$0: function(_) {
      var t1 = this._pos._v3storage;
      return "POLE: " + (H.S(t1[0]) + " " + H.S(t1[1]) + " " + H.S(t1[2]));
    }
  };
  Z.Ion.prototype = {
    Update$4: function(srcs, dsts, rng, dt) {
      var t1, force, _i, pole, t2, t, dist, p, force0;
      t1 = [Z.Pole];
      H.assertSubtype(srcs, "$isList", t1, "$asList");
      H.assertSubtype(dsts, "$isList", t1, "$asList");
      force = new T.Vector3(new Float32Array(3));
      for (t1 = srcs.length, _i = 0; _i < srcs.length; srcs.length === t1 || (0, H.throwConcurrentModificationError)(srcs), ++_i) {
        pole = srcs[_i];
        t2 = this._pos;
        t = new T.Vector3(new Float32Array(3));
        t.setFrom$1(t2);
        t.sub$1(0, pole._pos);
        dist = Math.sqrt(t.get$length2());
        if (dist <= 0.2)
          continue;
        if (dist > 100.1) {
          t1 = rng.nextInt$1(srcs.length);
          if (t1 < 0 || t1 >= srcs.length)
            return H.ioore(srcs, t1);
          p = srcs[t1];
          t1 = Z.RandomVector(rng, 0.35);
          t2 = new T.Vector3(new Float32Array(3));
          t2.setFrom$1(p._pos);
          t2.add$1(0, t1);
          this._pos = t2;
        ...
        t2 = new T.Vector3(new Float32Array(3));
        t2.setFrom$1(t);
        t2.scale$1(0, 1 / (dist * dist));
        force0 = new T.Vector3(new Float32Array(3));
        force0.setFrom$1(force);
        force0.add$1(0, t2);
        force = force0;
      }
      for (t1 = dsts.length, _i = 0; _i < dsts.length; dsts.length === t1 || (0, H.throwConcurrentModificationError)(dsts), ++_i, force = force0) {
        pole = dsts[_i];
        t2 = this._pos;
        t = new T.Vector3(new Float32Array(3));
        t.setFrom$1(pole._pos);
        t.sub$1(0, t2);
        dist = Math.sqrt(t.get$length2());
        if (dist <= 0.2) {
          t1 = rng.nextInt$1(srcs.length);
      ...
      t2.setFrom$1(force);
      t2.normalize$0(0);
      this._pos = t1.$add(0, t2.scaled$1(dt));
    },
    toString$0: function(_) {
      var t1 = this._pos._v3storage;
      return "ION: " + (H.S(t1[0]) + " " + H.S(t1[1]) + " " + H.S(t1[2]));
    }
  };
  Z.main_ResizeIons.prototype = {
    call$1: function(ev) {
      var n, t1, t2, i, t3, t4, ionsPos;
      n = P.int_parse($.$get$gParticles().value);
      P.print("resize to " + H.S(n) + " ions");
      t1 = this.ions;
      ...
      i = 0;
      for (; i < n; ++i) {
        t3 = Z.RandomVector(t2, 10010);
        t4 = new T.Vector3(new Float32Array(3));
        t4.setFrom$1(t3);
        C.JSArray_methods.add$1(t1, new Z.Ion(t4));
      }
      ionsPos = new Float32Array(3 * n);
      t2 = this._box_0;
      t2.ionsPos = ionsPos;
      Z.ExtractIonPos(t1, ionsPos);
      t1 = this.cgl;
      J.bindBuffer$2$x(t1._gl, 34962, null);
      t3 = this.bindingIndex;
      J.bindBufferBase$3$x(t1._gl, 35982, t3, null);
      t4 = this.mdOut;
      t4.ChangeVertices$1(t2.ionsPos);
      this.mdIn.ChangeVertices$1(t2.ionsPos);
      t4 = t4._buffers.$index(0, "aPosition");
      J.bindBufferBase$3$x(t1._gl, 35982, t3, t4);
    },
    $signature: 26
  };
  Z.main_UpdateIonsJS.prototype = {
    call$1: function(t) {
      var t1, t2, t3, t4, t5, _i;
      for (t1 = this.ions, t2 = t1.length, t3 = this.srcPoles, t4 = this.dstPoles, t5 = this.rng, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
        t1[_i].Update$4(t3, t4, t5, t);
      t2 = this._box_0;
      Z.ExtractIonPos(t1, t2.ionsPos);
      this.mdJS.ChangeVertices$1(t2.ionsPos);
    },
    $signature: 27
  };
  Z.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      t6 = t8[7];
      t5 = t8[11];
      t8[0] = t1 * m11 + t11 * m21 + t9 * m31;
      t8[1] = t13 * m11 + t14 * m21 + t15 * m31;
      t8[2] = t16 * m11 + t7 * m21 + t10 * m31;
      t8[3] = t12 * m11 + t6 * m21 + t5 * m31;
      t8[4] = t1 * m12 + t11 * m22 + t9 * m32;
      t8[5] = t13 * m12 + t14 * m22 + t15 * m32;
      t8[6] = t16 * m12 + t7 * m22 + t10 * m32;
      t8[7] = t12 * m12 + t6 * m22 + t5 * m32;
      t8[8] = t1 * m13 + t11 * m23 + t9 * m33;
      t8[9] = t13 * m13 + t14 * m23 + t15 * m33;
      t8[10] = t16 * m13 + t7 * m23 + t10 * m33;
      t8[11] = t12 * m13 + t6 * m23 + t5 * m33;
      ...
      t1 = this.perspective;
      t2 = [G.UniformGroup];
      if ($.$get$gCpuCompute().checked) {
        this.UpdateIonsJS.call$1(0.06);
        this.programJS.Draw$2(this.mdJS, H.setRuntimeTypeInfo([t1, this.matJS], t2));
      } else {
        t3 = this.mdIn;
        this.programGPU.Draw$2(t3, H.setRuntimeTypeInfo([t1, this.matGPU], t2));
        t2 = this.cgl;
        t3 = t3._buffers.$index(0, "aPosition");
        J.bindBuffer$2$x(t2._gl, 34962, t3);
        t3 = this.mdOut._buffers.$index(0, "aPosition");
        J.bindBuffer$2$x(t2._gl, 35982, t3);
        t3 = this.ions.length;
        J.copyBufferSubData$5$x(t2._gl, 35982, 34962, 0, 0, t3 * 3 * 4);
      }
...
;
    ...
    C.ShaderVarDesc_vec3_5 = new G.ShaderVarDesc("vec3", 5);
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "gParticles", "$get$gParticles", function() {
      return H.interceptedTypeCheck(W.document().querySelector("#particles"), "$isSelectElement");
    });
    _lazy($, "gCpuCompute", "$get$gCpuCompute", function() {
      return H.interceptedTypeCheck(W.document().querySelector("#cpucompute"), "$isInputElement");
    });
    _lazy($, "particleVertexShader", "$get$particleVertexShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("ParticleV");
      t2 = [P.String];
      t1.AddAttributeVars$1(H.setRuntimeTypeInfo(["aPosition"], t2));
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uPerspectiveViewMatrix", "uModelMatrix", "uPointSize", "uSources", "uSinks"], t2));
      t1.AddTransformVars$1(H.setRuntimeTypeInfo(["tPosition"], t2));
      t1.SetBody$1(H.setRuntimeTypeInfo(["const float kMaxDistance = 100.1;\nconst float kMinDistance = 0.2;\nconst float dt = 0.06;  \n    \nfloat rand(vec2 seed){\n    return fract(sin(dot(seed, vec2(12.9898,78.233))) * 43758.5453);\n}      \n\nint irand(int n, vec2 seed) {\n    return int(floor(rand(seed) * float(n)));\n}\n\nvec3 vec3rand(vec3 seed) {\n    return vec3(rand(seed.yz) - 0.5, rand(seed.xz) - 0.5, rand(seed.xy) - 0.5);\n}\n\nvec3 RandomSource(vec3 seed) {\n    return uSources[irand(uSources.length(), seed.xy * seed.z)];\n}\n\nvec3 Update(vec3 pos, vec3 seed) {\n    vec3 force = vec3(0.0, 0.0, 0.0);\n    for (int i = 0; i < uSources.length(); ++i) {\n       vec3 d = pos - uSources[i];\n       float l = length(d);\n       if (l <= kMinDistance) continue;\n       if (l >= kMaxDistance) {\n           return RandomSource(seed) + vec3rand(seed) * 0.35;\n       }\n       force += d / (l * l); \n    } \n    \n    for (int i = 0; i < uSinks.length(); ++i) {\n       vec3 d = uSinks[i] - pos;\n       float l = length(d);\n       if (l <= kMinDistance) {\n          return RandomSource(seed) + vec3rand(seed) * 0.35;\n       }\n       force += d / (l * l); \n    } \n    return pos + normalize(force) * dt;\n}\n      \nvoid main() {        \n    gl_Position = uPerspectiveViewMatrix * uModelMatrix * \n                  vec4(aPosition, 1.0);\n    gl_PointSize = uPointSize/gl_Position.z;\n    \n    // new position for next round\n    tPosition = Update(aPosition, gl_Position.xyz);\n}\n"], t2));
      return t1;
    });
    _lazy($, "particleFragmentShader", "$get$particleFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("ParticleF");
      t2 = [P.String];
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uTexture"], t2));
