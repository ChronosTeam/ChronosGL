...
(function dartProgram() {
  ...
  G = {
    ...
    _ExtractWireframeNormals: function(out, vertices, normals, scale) {
      var t1, t2, v, t3, t4, i, t5, t6, t7, t8, t9, t10, n, lines;
      t1 = [P.double];
      H.assertSubtype(vertices, "$isList", t1, "$asList");
      H.assertSubtype(normals, "$isList", t1, "$asList");
      t1 = vertices.length;
      t2 = 2 * t1;
      v = new Float32Array(t2);
      for (t3 = v.length, t4 = normals.length, i = 0; i < t1; i += 3) {
        t5 = 2 * i;
        t6 = vertices[i];
        if (t5 >= t3)
          return H.ioore(v, t5);
        ...
        t8 = vertices[t7];
        if (t7 >= t4)
          return H.ioore(normals, t7);
        t7 = normals[t7];
        if (t10 >= t3)
          return H.ioore(v, t10);
        v[t10] = t8 + scale * t7;
        t5 += 5;
        t7 = vertices[t6];
        if (t6 >= t4)
      ...
      out.AddVertices$1(v);
      n = C.JSInt_methods._tdivFast$1(t2, 3);
      t1 = new Array(n);
      t1.fixed$length = Array;
      lines = H.setRuntimeTypeInfo(t1, [P.int]);
      for (i = 0; i < n; ++i)
        C.JSArray_methods.$indexSet(lines, i, i);
      out.AddFaces$1(lines);
      return out;
    },
  ...
  V = {
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, orbit, perspective, phase, scene, matWire, matNorm;
      t1 = {};
      t2 = document;
      ...
      t2 = H.setRuntimeTypeInfo([], [A.Scene]);
      phase = new R.RenderPhaseResizeAware(canvas, perspective, null, cgl, t2, 17664, "main");
      ...
      t5 = H.setRuntimeTypeInfo([perspective], [G.UniformGroup]);
      t6 = H.setRuntimeTypeInfo([], [A.Node]);
      scene = new A.Scene(t4, t5, t6, "solid");
      C.JSArray_methods.add$1(t2, scene);
      matWire = G.Material$("wire");
      matWire._uniforms.$indexSet(0, "uColor", $.$get$ColorYellow());
      matNorm = G.Material$("normal");
      matNorm._uniforms.$indexSet(0, "uColor", $.$get$ColorBlue());
      t1.nodeWire = null;
      t1.nodeNorm = null;
      t1._lastTimeMs = 0;
      P.Future_wait(H.setRuntimeTypeInfo([D.LoadRaw("../asset/dragon/dragon.obj")], [[P.Future, P.Object]]), t3).then$1$1(new V.main_closure(t1, scene, matWire, matNorm, new V.main_animate(t1, orbit, phase, fps)), null);
    },
    ...
    main_closure: function main_closure(t0, t1, t2, t3, t4) {
      var _ = this;
      _._box_0 = t0;
      _.scene = t1;
      _.matWire = t2;
  ...
  var holders = [C, H, J, P, W, G, R, A, D, T, V, Y];
  ...
  G.GeometryBuilder.prototype = {
    ...
    GenerateLineIndices$0: function() {
      var t1, t2, t3, lines, i, _i, f3, t4, t5, f4;
      t1 = this._faces3;
      t2 = this._faces4;
      t3 = new Array(t1.length * 6 + t2.length * 8);
      t3.fixed$length = Array;
      lines = H.setRuntimeTypeInfo(t3, [P.int]);
      for (t3 = t1.length, i = 0, _i = 0; _i < t1.length; t1.length === t3 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
        f3 = t1[_i];
        t4 = f3.a;
        C.JSArray_methods.$indexSet(lines, i, t4);
        t5 = f3.b;
        C.JSArray_methods.$indexSet(lines, i + 1, t5);
        C.JSArray_methods.$indexSet(lines, i + 2, t5);
        t5 = f3.c;
        C.JSArray_methods.$indexSet(lines, i + 3, t5);
        C.JSArray_methods.$indexSet(lines, i + 4, t5);
  ...
  V.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      t1.nodeNorm.enabled = $.$get$gShowNormals().checked;
      t1.nodeWire.enabled = $.$get$gShowWires().checked;
      this.phase.Draw$0();
  ...
  V.main_closure.prototype = {
    call$1: function(list) {
      var gb, t1, t2, t3, md, t4, t5, t6, t7, t8, t9, t10, t11, nodeWire, mdNorm, nodeNorm;
      gb = Y.ImportGeometryFromWavefront(H.stringTypeCheck(J.$index$asx(H.listTypeCheck(list), 0)));
      P.print(gb);
      t1 = this.scene;
      t2 = t1.program;
      t3 = t2._cgl;
      t2 = t2._shaderObjectV._canonicalToLayoutPos;
      md = G.MeshData$("../asset/dragon/dragon.obj", t3, 1, t2);
      t4 = gb.vertices;
      md.AddVertices$1(G.FlattenVector3List(t4));
      md.AddFaces$1(gb.GenerateLineIndices$0());
      ...
      new Float32Array(3);
      new Float32Array(3);
      nodeWire = new A.Node(this.matWire, md, t6, new T.Matrix3(t7), t8, t9, new T.Vector3(t10), new T.Vector3(t11), md.name);
      t6 = this._box_0;
      t6.nodeWire = nodeWire;
      t7 = new T.Vector3(new Float32Array(3));
      t7.setValues$3(100, 0, 0);
      nodeWire.lookAt$1(t7);
      t1 = t1.nodes;
      C.JSArray_methods.add$1(t1, t6.nodeWire);
      mdNorm = G._ExtractWireframeNormals(G.MeshData$("norm", t3, 1, t2), G.FlattenVector3List(t4), G.FlattenVector3List(H.subtypeCast(gb.attributes.$index(0, "aNormal"), "$isList", [T.Vector3], "$asList")), 0.05);
      ...
      new Float32Array(3);
      new Float32Array(3);
      nodeNorm = new A.Node(this.matNorm, mdNorm, t5, new T.Matrix3(t2), t3, t4, new T.Vector3(t7), new T.Vector3(t8), mdNorm.name);
      t6.nodeNorm = nodeNorm;
      t2 = new T.Vector3(new Float32Array(3));
      t2.setValues$3(100, 0, 0);
      nodeNorm.lookAt$1(t2);
      C.JSArray_methods.add$1(t1, t6.nodeNorm);
