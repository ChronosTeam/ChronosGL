...
(function dartProgram() {
  ...
  G = {
    ...
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, t10, orbit, perspective, programTexture, programPerlin, gb, md, matTexture, future, matPerlin, progStars, e, ctx, gradient, mdStars;
      t1 = {};
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(165, 0, 0, 0, new T.Vector3(t5), -0.02, t6, t7, t8, new T.Vector3(t9), new T.Vector3(t10), "camera:orbit");
      ...
      matTexture = G.Material$("texture");
      t5 = new T.Matrix4(new Float32Array(16));
      t5.setIdentity$0();
      t5.setTranslationRaw$3(-50, 0, 0);
      t6 = matTexture._uniforms;
      t6.$indexSet(0, "uModelMatrix", t5);
      t6.$indexSet(0, "uColor", new T.Vector3(new Float32Array(3)));
      future = D.LoadImage("../gradient.jpg");
      future.then$1$1(new G.main_closure(cgl, matTexture), null);
      t5 = $.$get$gLoadables();
      C.JSArray_methods.add$1(t5, future);
      matPerlin = G.Material$("perlin");
      t6 = matPerlin._uniforms;
      t6.$indexSet(0, "uTransformationMatrix", new T.Matrix4(new Float32Array(16)));
      t7 = new T.Matrix4(new Float32Array(16));
      t7.setIdentity$0();
      t7.setTranslationRaw$3(50, 0, 0);
      t6.$indexSet(0, "uModelMatrix", t7);
      ...
      ctx.fill();
      t3.$indexSet(0, "uTexture", G.ImageTexture$(cgl, "Utils::Particles", e));
      t3.$indexSet(0, "uPointSize", 1000);
      t2 = new T.Matrix4(new Float32Array(16));
      t2.setIdentity$0();
      t3.$indexSet(0, "uModelMatrix", t2);
      mdStars = R.Utils_MakeStarMesh(progStars, 2000, 200);
      t1._lastTimeMs = 0;
      P.Future_wait(t5, t4).then$1$1(new G.main_closure0(new G.main_animate(t1, orbit, matPerlin, programTexture, md, perspective, matTexture, programPerlin, progStars, mdStars, new G.Material(t3, "stars"), fps)), null);
    },
  ...
  G.main_closure.prototype = {
    call$1: function(img) {
      this.matTexture._uniforms.$indexSet(0, "uTexture", G.ImageTexture$(this.cgl, "../gradient.jpg", H.interceptedTypeCheck(img, "$isImageElement")));
    },
    $signature: 27
  };
  G.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      t8 = this.perspective;
      t7 = [G.UniformGroup];
      this.programTexture.Draw$2(t4, H.setRuntimeTypeInfo([t8, this.matTexture], t7));
      this.programPerlin.Draw$2(t4, H.setRuntimeTypeInfo([t8, t3], t7));
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(R.PerspectiveResizeAware.prototype, "get$resolutionChange", "resolutionChange$1", 9);
  })();
