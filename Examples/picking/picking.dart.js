...
(function dartProgram() {
  ...
  D = {
    ...
    Mouse: function Mouse(t0, t1, t2) {
      ...
      _.currentY = _.currentX = _.wheelDeltaY = _.moveDeltaY = _.moveDeltaX = 0;
    },
  ...
  U = {
    main: function() {
      var t1, t2, info, t3, text, t4, fps, canvas, cgl, t5, ext, t6, t7, t8, t9, orbit, perspective, phase, mat, t10, t11, t12, node, vertices, uvs, n, normals, gb, i, pixelData, pbo;
      t1 = {};
      t2 = document;
      info = H.interceptedTypeCheck(t2.querySelector("#info"), "$isDivElement");
      ...
      ext = J.getExtension$1$x(t4, "WEBGL_get_buffer_sub_data_async");
      P.print("Ext " + H.S(ext));
      t4 = new Float32Array(3);
      t5 = D.Keyboard$(null);
      t6 = D.Mouse$(canvas);
      ...
      phase = new A.RenderPhase(null, cgl, t3, 17664, "main");
      phase._framebuffer = new G.Framebuffer(cgl, null);
      t4 = G.RenderProgram$("prog", cgl, $.$get$solidColorVertexShader(), $.$get$solidColorFragmentShader());
      ...
      mat = G.Material$("sphere");
      mat._uniforms.$indexSet(0, "uColor", $.$get$ShapeToColor().$index(0, "sphere"));
      t3 = G.GeometryBuilderToMeshData("icosahedron-3", t4, B.IcosahedronGeometry(true, 1, 3));
      ...
      new Float32Array(3);
      new Float32Array(3);
      node = new A.Node(mat, t3, t5, new T.Matrix3(t8), t9, t10, new T.Vector3(t11), new T.Vector3(t12), "sphere");
      node.setPos$3(0, 0, 0);
      C.JSArray_methods.add$1(t7, node);
      mat = G.Material$("cube");
      mat._uniforms.$indexSet(0, "uColor", $.$get$ShapeToColor().$index(0, "cube"));
      t3 = G.GeometryBuilderToMeshData("cube", t4, B.CubeGeometry(1, 0, 1, 0, 1, 1, 1));
      t5 = H.setRuntimeTypeInfo([], t6);
      t8 = new Float32Array(9);
      t9 = new T.Matrix4(new Float32Array(16));
      t9.setIdentity$0();
      ...
      new Float32Array(3);
      new Float32Array(3);
      node = new A.Node(mat, t3, t5, new T.Matrix3(t8), t9, t10, new T.Vector3(t11), new T.Vector3(t12), "cube");
      node.setPos$3(-5, 0, -5);
      C.JSArray_methods.add$1(t7, node);
      mat = G.Material$("cylinder");
      mat._uniforms.$indexSet(0, "uColor", $.$get$ShapeToColor().$index(0, "cylinder"));
      t3 = G.GeometryBuilderToMeshData("cylinder-32", t4, B.CylinderGeometry(3, 6, 2, 32, true));
      t5 = H.setRuntimeTypeInfo([], t6);
      t8 = new Float32Array(9);
      t9 = new T.Matrix4(new Float32Array(16));
      t9.setIdentity$0();
      ...
      new Float32Array(3);
      new Float32Array(3);
      node = new A.Node(mat, t3, t5, new T.Matrix3(t8), t9, t10, new T.Vector3(t11), new T.Vector3(t12), "cylinder");
      node.setPos$3(5, 0, -5);
      C.JSArray_methods.add$1(t7, node);
      mat = G.Material$("quad");
      mat._uniforms.$indexSet(0, "uColor", $.$get$ShapeToColor().$index(0, "quad"));
      t3 = new T.Vector3(new Float32Array(3));
      t3.setValues$3(-2, -2, 0);
      t5 = new T.Vector3(new Float32Array(3));
      t5.setValues$3(2, -2, 0);
      t8 = new T.Vector3(new Float32Array(3));
      t8.setValues$3(2, 2, 0);
      t9 = new T.Vector3(new Float32Array(3));
      t9.setValues$3(-2, 2, 0);
      t10 = [T.Vector3];
      vertices = H.setRuntimeTypeInfo([t3, t5, t8, t9], t10);
      t3 = new T.Vector2(new Float32Array(2));
      t3.setValues$2(0, 0);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(1, 0);
      ...
      t9 = new T.Vector2(new Float32Array(2));
      t9.setValues$2(0, 1);
      uvs = H.setRuntimeTypeInfo([t3, t5, t8, t9], [T.Vector2]);
      ...
      gb = new G.GeometryBuilder(false, t3, t5, t8, P.LinkedHashMap_LinkedHashMap$_empty(t2, [P.List,,]));
      gb.EnableAttribute$1("aTexUV");
      ...
      t5 = G.GeometryBuilderToMeshData("quad", t4, gb);
      ...
      new Float32Array(3);
      new Float32Array(3);
      node = new A.Node(mat, t5, t8, new T.Matrix3(t2), t3, t9, new T.Vector3(t10), new T.Vector3(t11), "quad");
      node.setPos$3(-5, 0, 5);
      C.JSArray_methods.add$1(t7, node);
      mat = G.Material$("torus");
      mat._uniforms.$indexSet(0, "uColor", $.$get$ShapeToColor().$index(0, "torus"));
      t2 = G.GeometryBuilderToMeshData("torusknot", t4, B.TorusKnotGeometry(true, 1, 2, 3, 1, 128, 16, 0.4));
      ...
      new Float32Array(3);
      new Float32Array(3);
      node = new A.Node(mat, t2, t6, new T.Matrix3(t3), t4, t5, new T.Vector3(t8), new T.Vector3(t9), "torus");
      node.setPos$3(5, 0, 5);
      C.JSArray_methods.add$1(t7, node);
      t2 = new U.main_resolutionChange(canvas, perspective, phase);
      t2.call$1(null);
      t3 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(t2, {func: 1, ret: -1, args: [t3]}), false, t3);
      pixelData = new Uint8Array(4);
      pbo = J.createBuffer$0$x(cgl._gl);
      J.bindBuffer$2$x(cgl._gl, 35051, pbo);
      J.bufferData$3$x(cgl._gl, 35051, 4, 35049);
      J.bindBuffer$2$x(cgl._gl, 35051, null);
      t1._lastTimeMs = 0;
      new U.main_animate(t1, orbit, phase, info, new U.main_getShapeUnderCusorInfo(orbit, canvas, ext, cgl, pbo, pixelData), fps).call$1(0);
    },
    ...
    main_getShapeUnderCusorInfo: function main_getShapeUnderCusorInfo(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.orbit = t0;
      _.canvas = t1;
      _.ext = t2;
    ...
    main_animate: function main_animate(t0, t1, t2, t3, t4, t5) {
      ...
      _.phase = t2;
      _.info = t3;
      _.getShapeUnderCusorInfo = t4;
      _.fps = t5;
    }
  };
  var holders = [C, H, J, P, W, G, R, A, B, D, T, U];
  ...
  D.Mouse_closure.prototype = {
    call$1: function(e) {
      ...
      t1.currentX = H.intTypeCheck(t2.get$offset(e).x);
      t1.currentY = H.intTypeCheck(t2.get$offset(e).y);
  ...
  U.main_resolutionChange.prototype = {
    call$1: function(ev) {
      var t1, w, h;
      t1 = this.canvas;
      w = t1.clientWidth;
  ...
  U.main_getShapeUnderCusorInfo.prototype = {
    call$0: function() {
      var t1, t2, x, t3, y, t4, t5, pick, shape, dur;
      t1 = Date.now();
      t2 = this.orbit.mouse;
      x = t2.currentX;
      t3 = this.canvas.clientHeight;
      t2 = t2.currentY;
      if (typeof t3 !== "number")
        return t3.$sub();
      if (typeof t2 !== "number")
      ...
      y = t3 - t2;
      t2 = this.pixelData;
      J.readPixels$7$x(this.cgl._gl, x, y, 1, 1, 6408, 5121, t2);
      t3 = t2.length;
      if (0 >= t3)
        return H.ioore(t2, 0);
      t4 = t2[0];
      ...
      if (2 >= t3)
        return H.ioore(t2, 2);
      t3 = t2[2];
      pick = new T.Vector3(new Float32Array(3));
      pick.setValues$3(t4, t5, t3);
      pick.scale$1(0, 0.00392156862745098);
      t3 = $.$get$ShapeToColor();
      t3 = new H.LinkedHashMapKeyIterable(t3, [H.getTypeArgumentByIndex(t3, 0)]);
      ...
      while (true) {
        ...
        shape = t3._current;
        if (J.$eq$($.$get$ShapeToColor().$index(0, shape), pick))
          break;
      }
      dur = P.Duration$(Date.now() - new P.DateTime(t1, false)._value, 0);
      return H.S(shape) + "<br>" + H.S(x) + "." + y + "<br>" + H.S(t2) + "<br>" + dur._duration + "us";
    },
    $signature: 28
  };
  U.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      this.phase.Draw$0();
      t3 = this.info;
      t4 = this.getShapeUnderCusorInfo.call$0();
      t3.toString;
      (t3 && C.DivElement_methods).setInnerHtml$1(t3, H.stringTypeCheck(t4));
      t3 = t2.mouse;
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "ColorMagenta", "$get$ColorMagenta", function() {
      return T.Vector3_Vector3(1, 0, 1);
    });
    _lazy($, "ColorCyan", "$get$ColorCyan", function() {
      return T.Vector3_Vector3(0, 1, 1);
    });
