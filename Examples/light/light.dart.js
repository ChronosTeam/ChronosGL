...
(function dartProgram() {
  ...
  G = {
    ...
    DirectionalLight: function DirectionalLight(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.dir = t0;
      _.dim = t1;
      _.type = t2;
  ...
  A = {
    ...
    RenderPhase$: function($name, _cgl) {
      var t1 = new A.RenderPhase(null, _cgl, H.setRuntimeTypeInfo([], [A.Scene]), 17664, $name);
      t1._framebuffer = new G.Framebuffer(_cgl, null);
      return t1;
    },
    Node: function Node(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) {
      var _ = this;
      _._material = t0;
      _._meshData = t1;
      _.children = t2;
  ...
  B = {
    ...
    GridGeometry: function(xstrips, ystrips, xlen, ylen) {
      var xoffset, yoffset, xdelta, ydelta, normal, t1, t2, t3, t4, vertices, normals, uvs, index, x, y, ii, gb, x0, t5;
      xoffset = xlen * 0.5;
      yoffset = ylen * 0.5;
      xdelta = xlen / xstrips;
      ydelta = xlen / ystrips;
      normal = new T.Vector3(new Float32Array(3));
      normal.setValues$3(0, 0, 1);
      t1 = (xstrips + 1) * (ystrips + 1);
      t2 = new Array(t1);
      t2.fixed$length = Array;
      t3 = T.Vector3;
      t4 = [t3];
      vertices = H.setRuntimeTypeInfo(t2, t4);
      t2 = new Array(t1);
      t2.fixed$length = Array;
      normals = H.setRuntimeTypeInfo(t2, t4);
      t1 = new Array(t1);
      t1.fixed$length = Array;
      uvs = H.setRuntimeTypeInfo(t1, [T.Vector2]);
      index = new B.GridGeometry_index(xstrips);
      for (x = 0; x <= xstrips; ++x)
        for (t1 = x / xstrips, t2 = x * xdelta - xoffset, y = 0; y <= ystrips; ++y) {
          ii = index.call$2(x, y);
          t4 = new Float32Array(3);
          t4[0] = t2;
          t4[1] = y * ydelta - yoffset;
          t4[2] = 0;
          C.JSArray_methods.$indexSet(vertices, ii, new T.Vector3(t4));
          C.JSArray_methods.$indexSet(normals, ii, normal);
          t4 = new Float32Array(2);
          t4[0] = t1;
          t4[1] = y / ystrips;
          C.JSArray_methods.$indexSet(uvs, ii, new T.Vector2(t4));
        }
      t1 = H.setRuntimeTypeInfo([], [G.Face3]);
      t2 = H.setRuntimeTypeInfo([], [G.Face4]);
      gb = new G.GeometryBuilder(false, t1, t2, H.setRuntimeTypeInfo([], [t3]), P.LinkedHashMap_LinkedHashMap$_empty(P.String, [P.List,,]));
      gb.AddVertices$1(vertices);
      for (x = 0; x < xstrips; x = x0)
        for (x0 = x + 1, y = 0; y < ystrips;) {
          t1 = index.call$2(x, y);
          t3 = index.call$2(x0, y);
          ++y;
          t4 = index.call$2(x0, y);
          t5 = index.call$2(x, y);
          C.JSArray_methods.add$1(t2, new G.Face4(H.intTypeCheck(t1), H.intTypeCheck(t3), H.intTypeCheck(t4), H.intTypeCheck(t5)));
        }
      gb.EnableAttribute$1("aTexUV");
      gb.AddAttributesVector2$2("aTexUV", uvs);
      gb.EnableAttribute$1("aNormal");
    ...
    GridGeometry_index: function GridGeometry_index(t0) {
      this.xstrips = t0;
    }
  },
  D = {
    ...
    MakeSolidColorTextureRGB: function(cgl, url, rgb) {
      var t1, r, g, b, e, ctx;
      t1 = rgb._v3storage;
      r = C.JSNumber_methods.round$0(255 * t1[0]);
      g = C.JSNumber_methods.round$0(255 * t1[1]);
      b = C.JSNumber_methods.round$0(255 * t1[2]);
      t1 = "rgb(" + r + ", " + g + ", " + b + ")";
      ...
      return new G.ImageTexture(e, url, t1, 3553, cgl, new G.TextureProperties(1, 9729, 9729));
    },
    ...
    OrbitCamera: function OrbitCamera(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13) {
      var _ = this;
      _._radius = t0;
      _.azimuth = t1;
      _.polar = t2;
  ...
  K = {
    LightSourceVisualizerScene: function(cgl, uniforms) {
      var t1, t2, t3, scene, lightSourceMat, t4, t5, t6, t7, t8, t9, t10, t11, dl, t12, md, t13, t14, t15, t16, t17, t18;
      H.assertSubtype(uniforms, "$isList", [G.UniformGroup], "$asList");
      t1 = G.RenderProgram$("Fixed", cgl, $.$get$solidColorVertexShader(), $.$get$solidColorFragmentShader());
      t2 = [A.Node];
      t3 = H.setRuntimeTypeInfo([], t2);
      scene = new A.Scene(t1, uniforms, t3, "Fixed");
      lightSourceMat = G.Material$("light");
      lightSourceMat._uniforms.$indexSet(0, "uColor", $.$get$ColorYellow());
      for (t3 = $.$get$gLightSources(), t4 = new H.LinkedHashMapKeyIterable(t3, [H.getTypeArgumentByIndex(t3, 0)]), t4 = t4.get$iterator(t4), t5 = [P.int], t6 = t1._cgl, t1 = t1._shaderObjectV, t7 = P.String, t8 = P.Object, t9 = P.Float32List; t4.moveNext$0();) {
        t10 = t4.__js_helper$_current;
        t11 = $.$get$gLightVisualizers();
        dl = t3.$index(0, t10);
        t12 = t1._canonicalToLayoutPos;
        md = new G.MeshData(t6, J.createVertexArray$0$x(t6._gl), 1, P.LinkedHashMap_LinkedHashMap$_empty(t7, t8), t12, -1, P.LinkedHashMap_LinkedHashMap$_empty(t7, t9), "meshdata:dirLightViz");
        md.AddVertices$1(new Float32Array(3));
        t12 = H.assertSubtype(H.setRuntimeTypeInfo([0, 0], t5), "$isList", t5, "$asList");
        md._indexBuffer = J.createBuffer$0$x(t6._gl);
        md.ChangeFaces$1(t12);
        t12 = J.getInterceptor$(dl);
        if (!!t12.$isDirectionalLight) {
          t12 = dl.dim;
          R.UpdateDirectionalLightVisualizer(md, t12, t12 / 4, dl.dir);
        } else if (!!t12.$isSpotLight)
          R.UpdateSpotLightVisualizer(md, dl.pos, dl.dir, dl.range, dl.angle);
        else if (!!t12.$isPointLight)
          R.UpdatePointLightVisualizer(md, dl.pos, dl.range);
        t12 = H.setRuntimeTypeInfo([], t2);
        t13 = new Float32Array(9);
        ...
        t11.$indexSet(0, t10, new A.Node(lightSourceMat, md, t12, new T.Matrix3(t13), t14, t15, new T.Vector3(t16), new T.Vector3(t17), new T.Vector3(t18), new T.Vector3(new Float32Array(3)), t10));
      }
      for (t1 = $.$get$gLightVisualizers(), t1 = t1.get$values(t1), t2 = t1._iterable, t1 = new H.MappedIterator(t2.get$iterator(t2), t1._f, [H.getTypeArgumentByIndex(t1, 0), H.getTypeArgumentByIndex(t1, 1)]), t2 = scene.nodes; t1.moveNext$0();)
        C.JSArray_methods.add$1(t2, t1._current);
      return scene;
    },
    MakeSceneCubeSphere: function(cgl, prog, container) {
      var cubeMeshData, sphereMeshData, t1, t2, t3, t4, t5, mats, i, x, y, z, t6, t7, t8, t9, t10, t11, t12, t13, t14, grid, cosAngle, sinAngle;
      cubeMeshData = G.GeometryBuilderToMeshData("cube", prog, B.CubeGeometry(1, 0, 1, 0, 2, 2, 2));
      sphereMeshData = G.GeometryBuilderToMeshData("icosahedron-4", prog, B.IcosahedronGeometry(true, 1, 4));
      t1 = G.Material$("mat0");
      t2 = t1._uniforms;
      t2.$indexSet(0, "uTexture", D.MakeSolidColorTextureRGB(cgl, "blue", $.$get$ColorBlue().scaled$1(0.5)));
      t2.$indexSet(0, "uShininess", 50);
      t2 = G.Material$("mat1");
      t3 = t2._uniforms;
      t3.$indexSet(0, "uTexture", D.MakeSolidColorTextureRGB(cgl, "red", $.$get$ColorRed().scaled$1(0.5)));
      t3.$indexSet(0, "uShininess", 50);
      t3 = G.Material$("mat2");
      t4 = t3._uniforms;
      t4.$indexSet(0, "uTexture", D.MakeSolidColorTextureRGB(cgl, "white", $.$get$ColorWhite().scaled$1(0.5)));
      t4.$indexSet(0, "uShininess", 50);
      t4 = G.Material$("mat3");
      t5 = t4._uniforms;
      t5.$indexSet(0, "uTexture", D.MakeSolidColorTextureRGB(cgl, "green", $.$get$ColorGreen().scaled$1(0.5)));
      t5.$indexSet(0, "uShininess", 50);
      mats = [t1, t2, t3, t4];
      for (t1 = container.children, t2 = [A.Node], i = 0; i < 8; ++i) {
        x = (i & 1) === 0 ? -10 : 10;
        y = (i & 2) === 0 ? -10 : 10;
        z = (i & 4) === 0 ? -10 : 10;
        t3 = i % 2 === 0 ? cubeMeshData : sphereMeshData;
        t4 = mats[i % 4];
        ...
        t14 = new T.Vector3(t13);
        t12 = new A.Node(t4, t3, t5, new T.Matrix3(t6), t7, t9, new T.Vector3(t10), new T.Vector3(t11), new T.Vector3(t12), t14, "mesh");
        t8[12] = x;
        t8[13] = y;
        t8[14] = z;
        t13[0] = t8[0];
        ...
        t13[2] = t8[8];
        t9.rotate$2(0, t14, -1);
        t9.rotate$2(0, t12.getUp$0(), -0.7);
        C.JSArray_methods.add$1(t1, t12);
      }
      t3 = G.GeometryBuilderToMeshData("strips", prog, B.GridGeometry(20, 20, 80, 80));
      t4 = mats[2];
      ...
      t10 = new Float32Array(3);
      t11 = new Float32Array(3);
      grid = new A.Node(t4, t3, t2, new T.Matrix3(t5), t6, t8, new T.Vector3(t9), new T.Vector3(t10), new T.Vector3(t11), new T.Vector3(new Float32Array(3)), "grid");
      cosAngle = Math.cos(-1.5079644737231006);
      sinAngle = Math.sin(-1.5079644737231006);
      t2 = t7[4];
      t3 = t7[8];
      t4 = t7[5];
      t5 = t7[9];
      ...
      t10 = t7[11];
      t11 = -sinAngle;
      t7[4] = t2 * cosAngle + t3 * sinAngle;
      t7[5] = t4 * cosAngle + t5 * sinAngle;
      t7[6] = t6 * cosAngle + t8 * sinAngle;
      t7[7] = t9 * cosAngle + t10 * sinAngle;
      t7[8] = t2 * t11 + t3 * cosAngle;
      t7[9] = t4 * t11 + t5 * cosAngle;
      t7[10] = t6 * t11 + t8 * cosAngle;
      t7[11] = t9 * t11 + t10 * cosAngle;
      grid.setPos$3(0, -20, 20);
      C.JSArray_methods.add$1(t1, grid);
    },
    main: function() {
      var _box_0, t1, t2, text, t3, fps, canvas, cgl, t4, t5, t6, t7, t8, t9, t10, orbit, perspective, illumination, sceneFixed, phaseBlinnPhong, phaseGourad, t11, node, selectPhase, _i, e;
      _box_0 = {};
      t1 = document;
      ...
      t9 = new Float32Array(3);
      t10 = new Float32Array(3);
      orbit = new D.OrbitCamera(50, 10, 0, 0, new T.Vector3(t4), -0.02, t5, t6, t7, new T.Vector3(t8), new T.Vector3(t9), new T.Vector3(t10), new T.Vector3(new Float32Array(3)), "camera:orbit");
      orbit.setPos$3(0, 0, 56);
      t4 = new T.Matrix4(new Float32Array(16));
      t4.setIdentity$0();
      t5 = new T.Matrix4(new Float32Array(16));
      t5.setIdentity$0();
      perspective = new G.Perspective(orbit, 50, 1, 0.1, 10000, t4, t5, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), "perspective");
      ...
      for (t2 = $.$get$gLightSources(), t2 = t2.get$values(t2), t3 = t2._iterable, t2 = new H.MappedIterator(t3.get$iterator(t3), t2._f, [H.getTypeArgumentByIndex(t2, 0), H.getTypeArgumentByIndex(t2, 1)]); t2.moveNext$0();)
        C.JSArray_methods.add$1(t4, t2._current);
      t2 = [G.UniformGroup];
      sceneFixed = K.LightSourceVisualizerScene(cgl, H.setRuntimeTypeInfo([perspective], t2));
      t3 = G.RenderProgram$("BlinnPhong", cgl, $.$get$lightVertexShaderBlinnPhong(), $.$get$lightFragmentShaderBlinnPhong());
      t4 = H.setRuntimeTypeInfo([perspective, illumination], t2);
      t5 = [A.Node];
      t6 = H.setRuntimeTypeInfo([], t5);
      t7 = G.RenderProgram$("Gourad", cgl, $.$get$lightVertexShaderGourad(), $.$get$lightFragmentShaderGourad());
      t2 = H.setRuntimeTypeInfo([perspective, illumination], t2);
      t8 = H.setRuntimeTypeInfo([], t5);
      phaseBlinnPhong = A.RenderPhase$("BlinnPhong", cgl);
      t9 = phaseBlinnPhong._scenes;
      C.JSArray_methods.add$1(t9, new A.Scene(t3, t4, t6, "BlinnPhong"));
      C.JSArray_methods.add$1(t9, sceneFixed);
      phaseGourad = A.RenderPhase$("Gourad", cgl);
      t9 = phaseGourad._scenes;
      C.JSArray_methods.add$1(t9, new A.Scene(t7, t2, t8, "Gourad"));
      C.JSArray_methods.add$1(t9, sceneFixed);
      ...
      t10 = new Float32Array(3);
      t11 = new Float32Array(3);
      node = new A.Node(null, null, t5, new T.Matrix3(t2), t4, t7, new T.Vector3(t9), new T.Vector3(t10), new T.Vector3(t11), new T.Vector3(new Float32Array(3)), "scene");
      K.MakeSceneCubeSphere(cgl, t3, node);
      C.JSArray_methods.add$1(t8, node);
      C.JSArray_methods.add$1(t6, node);
      selectPhase = H.interceptedTypeCast(t1.querySelector("#phase"), "$isSelectElement");
      ...
      for (t2 = t1.getElementsByTagName("input"), t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
        t4 = J.get$onChange$x(H.interceptedTypeCheck(t2[_i], "$isElement"));
        t5 = H.getTypeArgumentByIndex(t4, 0);
        W._EventStreamSubscription$(t4._target, t4._eventType, H.functionTypeCheck(new K.main_closure(), {func: 1, ret: -1, args: [t5]}), false, t5);
      }
      for (t2 = t1.getElementsByTagName("input"), t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
      ...
      t1 = new K.main_resolutionChange(canvas, perspective, phaseGourad, phaseBlinnPhong);
      t1.call$1(null);
      t2 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(t1, {func: 1, ret: -1, args: [t2]}), false, t2);
      _box_0._lastTimeMs = 0;
      new K.main_animate(_box_0, orbit, node, selectPhase, phaseBlinnPhong, phaseGourad, fps).call$1(0);
    },
    ...
    main_animate: function main_animate(t0, t1, t2, t3, t4, t5, t6) {
      ...
      _.node = t2;
      _.selectPhase = t3;
      _.phaseBlinnPhong = t4;
      _.phaseGourad = t5;
      _.fps = t6;
    }
  };
  var holders = [C, H, J, P, W, G, R, A, B, D, T, K];
  ...
  H.MappedIterable.prototype = {
    ...
    get$length: function(_) {
      return this._iterable._map._length;
    },
  ...
  G.UniformGroup.prototype = {
    ...
    toString$0: function(_) {
      var out, t1, t2, t3;
      out = H.setRuntimeTypeInfo(["{" + new H.TypeImpl(H.getRti(this)).toString$0(0) + "}[" + H.S(this.name) + "]"], [P.String]);
  ...
  G.MeshData.prototype = {
    ...
    toString$0: function(_) {
      ...
      return "MESH[" + H.S(this.name) + "] " + C.JSArray_methods.join$1(lst, "  ");
    },
  ...
  G.RenderProgram.prototype = {
          ...
          case 117:
            if (t4.containsKey$1(0, t7)) {
              ...
              if (t5.containsKey$1(0, t7))
                H.printString("E:" + (H.S(t6) + ":  " + t7 + " : group [" + H.S(group) + "] overwrites [" + t7 + "] (" + H.S(t5.$index(0, t7)) + ")"));
    ...
    Draw$3: function(md, uniforms, stats) {
      ...
      if (uninitialized.length !== 0)
        P.print("E:" + (H.S(this.name) + " " + md._drawMode + ": uninitialized inputs: " + H.S(uninitialized)));
      t2 = md._cgl;
      t3 = md._vao;
  ...
  B.GridGeometry_index.prototype = {
    call$2: function(x, y) {
      return x * (this.xstrips + 1) + y;
    },
    $signature: 24
  };
  ...
  T.Matrix4.prototype = {
    ...
    rotate$2: function(_, axis, angle) {
      var len, axisStorage, x, y, z, c, s, $C, m11, t1, m12, t2, m13, m21, m22, m23, m31, m32, m33, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13;
  ...
  K.main_closure.prototype = {
    call$1: function(e) {
      var input, tag, t1, t2, v;
      input = H.interceptedTypeCast(J.get$target$x(e), "$isInputElement");
      tag = input.id;
      P.print(H.S(tag) + " toggle " + H.S(input.checked));
      if (tag === "lightDiffuse")
        for (t1 = $.$get$gLightSources(), t1 = t1.get$values(t1), t2 = t1._iterable, t1 = new H.MappedIterator(t2.get$iterator(t2), t1._f, [H.getTypeArgumentByIndex(t1, 0), H.getTypeArgumentByIndex(t1, 1)]); t1.moveNext$0();) {
          t2 = t1._current;
          v = input.checked ? 1 : 0;
          t2 = t2.colorDiffuse._v3storage;
          t2[0] = v;
          t2[1] = v;
          t2[2] = v;
        }
        ...
        for (t1 = $.$get$gLightSources(), t1 = t1.get$values(t1), t2 = t1._iterable, t1 = new H.MappedIterator(t2.get$iterator(t2), t1._f, [H.getTypeArgumentByIndex(t1, 0), H.getTypeArgumentByIndex(t1, 1)]); t1.moveNext$0();) {
          t2 = t1._current;
          v = input.checked ? 1 : 0;
          t2 = t2.colorSpecular._v3storage;
          t2[0] = v;
          t2[1] = v;
          t2[2] = v;
        }
      else {
        $.$get$gLightSources().$index(0, tag).enabled = input.checked;
        $.$get$gLightVisualizers().$index(0, tag).enabled = input.checked;
      }
    },
    $signature: 27
  };
  K.main_resolutionChange.prototype = {
    call$1: function(ev) {
      var t1, w, h;
      t1 = this.canvas;
      w = t1.clientWidth;
      ...
      this.perspective.AdjustAspect$2(w, h);
      t1 = this.phaseGourad;
      t1.viewPortW = w;
      t1.viewPortH = h;
      t1 = this.phaseBlinnPhong;
      t1.viewPortW = w;
      t1.viewPortH = h;
    },
    $signature: 28
  };
  K.main_animate.prototype = {
    call$1: function(timeMs) {
      var t1, t2, t3, t4, t5, t6, t7, t8, rcp, t9, up, t10, z, x, y, t11, t12, t13, t14, t15, t16, t17, t18, t19, _i, m;
      ...
      t3.azimuth += 0.001;
      t4 = t3.mouse;
      t5 = t4._currentlyPressedButtons;
      if (t5.contains$1(0, 0) || t5.contains$1(0, 1)) {
        t5 = t3.azimuth;
        t6 = t4.moveDeltaX;
        if (typeof t6 !== "number")
          return t6.$mul();
        t3.azimuth = t5 + t6 * 0.01;
        t6 = t3.polar;
        t5 = t4.moveDeltaY;
        if (typeof t5 !== "number")
          return t5.$mul();
      ...
      if (typeof t6 !== "number")
        return t6.$mul();
      t6 = t3._radius - t6 * t3.mouseWheelFactor;
      if (t6 > 0)
        t3._radius = t6;
      t6 = C.JSNumber_methods.clamp$2(t3.polar, -1.4707963267948965, 1.4707963267948965);
      t3.polar = t6;
      t7 = t3._radius;
      t8 = t3.azimuth;
      rcp = t7 * Math.cos(t6);
      t3.setPos$3(rcp * Math.cos(t8), t7 * Math.sin(t6), rcp * Math.sin(t8));
      t8 = t3._lookAtPos;
      t6 = t3.transform;
      t7 = t6._m4storage;
      t9 = t8._v3storage;
      ...
      t7[1] = t15;
      t7[0] = t13;
      t6.rotate$2(0, t3.getBack$0(), -t3.roll);
      t5._justReleasedKeys.clear$0(0);
      t5._justPressedKeys.clear$0(0);
      t4.moveDeltaY = 0;
      t4.moveDeltaX = 0;
      t4.wheelDeltaY = 0;
      t4._justReleasedButtons.clear$0(0);
      t4._justPressedButtons.clear$0(0);
      for (t3 = this.node.children, t4 = t3.length, t2 = -((timeMs - t2) * 0.0003), _i = 0; _i < t3.length; t3.length === t4 || (0, H.throwConcurrentModificationError)(t3), ++_i) {
        m = t3[_i];
        if (m.name !== "grid") {
          t5 = m.transform;
          t5.rotate$2(0, m.getBack$0(), t2);
          t5.rotate$2(0, m.getUp$0(), t2);
        }
      }
      (this.selectPhase.selectedIndex === 0 ? this.phaseBlinnPhong : this.phaseGourad).Draw$0();
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "ColorWhite", "$get$ColorWhite", function() {
      return T.Vector3_Vector3(1, 1, 1);
    });
    ...
    _lazy($, "ColorGreen", "$get$ColorGreen", function() {
      return T.Vector3_Vector3(0, 1, 0);
    });
    _lazy($, "ColorYellow", "$get$ColorYellow", function() {
      return T.Vector3_Vector3(1, 1, 0);
    });
    _lazy($, "lightVertexShaderGourad", "$get$lightVertexShaderGourad", function() {
      var t1, t2;
      t1 = G.ShaderObject$("LightGouradV");
      t2 = [P.String];
      ...
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uEyePosition", "uTexture"], t2));
    ...
    _lazy($, "lightFragmentShaderGourad", "$get$lightFragmentShaderGourad", function() {
      var t1, t2;
      t1 = G.ShaderObject$("LightGrouradV");
      t2 = [P.String];
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vColor"], t2));
      t1.SetBodyWithMain$1(H.setRuntimeTypeInfo(["oFragColor = vec4(vColor, 1.0 );"], t2));
      return t1;
    });
    _lazy($, "lightVertexShaderBlinnPhong", "$get$lightVertexShaderBlinnPhong", function() {
      var t1, t2;
    ...
    _lazy($, "lightFragmentShaderBlinnPhong", "$get$lightFragmentShaderBlinnPhong", function() {
      var t1, t2;
      ...
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uLightDescs", "uLightTypes", "uShininess"], t2));
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uEyePosition", "uTexture"], t2));
      t1.SetBodyWithMain$2$prolog(H.setRuntimeTypeInfo(["ColorComponents acc = CombinedLight(vPosition,\n                                    vNormal,\n                                    uEyePosition,\n                                    uLightDescs,\n                                    uLightTypes,\n                                    uShininess);\n\noFragColor.rgb = acc.diffuse +\n                    acc.specular +\n                    texture(uTexture, vTexUV).rgb;\noFragColor.a = 1.0;\n"], t2), H.setRuntimeTypeInfo(["// ============================================================\n// MISC\n// ============================================================\n\nvec3 ColorFromPosition(vec3 pos) {\n    return vec3( sin(pos.x) / 2.0 + 0.5,\n                 cos(pos.y) / 2.0 + 0.5,\n                 sin(pos.z) / 2.0 + 0.5);\n}\n\nvec3 RangeToGray(float f, float a, float b) {\n    if (f > a) return vec3(1.0);\n    if (f < b) return vec3(0.0);\n    return vec3 ((f - b) / (a-b));\n}\n\nfloat useValueButReturnZero(float x) {\n    return (x + 1.0) * (x + 1.0) - x * x - 2.0 * x - 1.0;\n}\n\n// ============================================================\n// LIGHT\n// ============================================================\n\nfloat GetDiffuse(vec3 lightDir, vec3 normal) {\n    return max(dot(normal, lightDir), 0.0);\n}\n\nfloat GetSpecular(vec3 lightDir, vec3 viewDir, vec3 normal, float glossiness) {\n    vec3 angleW = normalize(viewDir + lightDir);\n    float specComp = max(0., dot(normal, angleW));\n    return pow(specComp, max(1.0, glossiness));\n}\n\nstruct ColorComponents {\n   vec3 diffuse;\n   vec3 specular;\n};\n\n// ============================================================\n// Spot Light\n// ============================================================\n\nstruct SpotLightInfo {\n    vec3 pos;      // for spot and point\n    vec3 dir;      // for spot and dir light\n    vec3 diffuseColor;\n    vec3 specularColor;\n    float range;        // for spot and point\n    float spotCutoff;   // for spot\n    float spotFocus;    // for spot\n    // float glossiness;   // Oddball: this comes from the material\n};\n\nSpotLightInfo UnpackSpotLightInfo(mat4 m) {\n    SpotLightInfo info;\n    info.pos = m[0].xyz;\n    info.dir = normalize(m[1].xyz);\n    info.diffuseColor = m[2].xyz;\n    info.specularColor = m[3].xyz;\n    // info.glossiness = m[0].a;\n    info.range = m[1].a;\n    info.spotCutoff = m[2].a;\n    info.spotFocus = m[3].a;\n    return info;\n}\n\nColorComponents SpotLightGetDiffuseAndSpecular(SpotLightInfo light,\n                                               vec3 vertexPos,\n                                               vec3 vertexNormal,\n                                               vec3 eyePos,\n                                               float uShininess) {\n    vec3 toSpot = light.pos - vertexPos;\n    vec3 spotDir = normalize(toSpot);\n    vec3 lightDirNorm = -normalize(light.dir);\n    float cosAngle = max(0., dot(lightDirNorm, spotDir));\n\t  if (cosAngle < light.spotCutoff) {\n        return ColorComponents(vec3(0.0), vec3(0.0));\n    }\n\n    cosAngle = max(0.0, pow(cosAngle, light.spotFocus));\n\t  float attenuation = max(0.0, 1.0 - length(toSpot) / light.range) * cosAngle;\n\t  vec3 viewDirNorm = normalize(eyePos - vertexPos);\n\t  return ColorComponents(\n\t           attenuation *\n             GetDiffuse(lightDirNorm, vertexNormal) *\n             light.diffuseColor,\n             attenuation *\n             GetSpecular(lightDirNorm, viewDirNorm, vertexNormal, uShininess) *\n             light.specularColor);\n}\n\n// ============================================================\n// Point Light\n// ============================================================\n\nstruct PointLightInfo {\n    vec3 pos;\n    vec3 diffuseColor;\n    vec3 specularColor;\n    float range;\n    // float glossiness;\n};\n\nPointLightInfo UnpackPointLightInfo(mat4 m) {\n    PointLightInfo info;\n    info.pos = m[0].xyz;\n    info.diffuseColor = m[2].xyz;\n    info.specularColor = m[3].xyz;\n    info.range = m[1].a;\n    // info.glossiness = m[0].a;\n    return info;\n}\n\nColorComponents PointLightGetDiffuseAndSpecular(PointLightInfo info,\n                                     vec3 vertexPos,\n                                     vec3 vertexNormal,\n                                     vec3 eyePos,\n                                     float uShininess) {\n    vec3 lightDir = info.pos - vertexPos;\n    float attenuation = max(0.0, 1.0 - length(lightDir) / info.range);\n    vec3 lightDirNorm = normalize(lightDir);\n    vec3 viewDirNorm = normalize(eyePos - vertexPos);\n    return ColorComponents(\n              attenuation *\n              GetDiffuse(lightDirNorm, vertexNormal) *\n              info.diffuseColor,\n               attenuation *\n               GetSpecular(lightDirNorm, viewDirNorm, vertexNormal, uShininess) *\n               info.specularColor);\n}\n\n// ============================================================\n// Directional Light\n// ============================================================\n\nstruct DirectionalLightInfo {\n    vec3 dir;      // for spot and dir light\n    vec3 diffuseColor;\n    vec3 specularColor;\n    // float glossiness;   // Oddball: this comes from the material\n};\n\nDirectionalLightInfo UnpackDirectionalLightInfo(mat4 m) {\n    DirectionalLightInfo info;\n    info.dir = normalize(m[1].xyz);\n    info.diffuseColor = m[2].xyz;\n    info.specularColor = m[3].xyz;\n    // info.glossiness = m[0].a;\n    return info;\n}\n\nColorComponents DirectionalLightGetDiffuseAndSpecular(DirectionalLightInfo info,\n                                                      vec3 vertexPos,\n                                                      vec3 vertexNormal,\n                                                      vec3 eyePos,\n                                                      float uShininess) {\n    vec3 viewDirNorm = normalize(eyePos - vertexPos);\n    return ColorComponents(\n              GetDiffuse(-info.dir, vertexNormal) *\n              info.diffuseColor,\n              GetSpecular(-info.dir, viewDirNorm, vertexNormal, uShininess) *\n              info.specularColor);\n}\n\n\nColorComponents CombinedLightSpot(\n    vec3 vVertexPosition, vec3 vNormal, vec3 uEyePosition, mat4 lightDesc,\n    float shininess) {\n    SpotLightInfo info = UnpackSpotLightInfo(lightDesc);\n    return SpotLightGetDiffuseAndSpecular(\n        info, vVertexPosition, vNormal, uEyePosition, shininess);\n}\n\nColorComponents CombinedLightPoint(\n    vec3 vVertexPosition, vec3 vNormal, vec3 uEyePosition, mat4 lightDesc,\n    float shininess) {\n    PointLightInfo info = UnpackPointLightInfo(lightDesc);\n    return PointLightGetDiffuseAndSpecular(\n        info, vVertexPosition, vNormal, uEyePosition, shininess);\n}\n\nColorComponents CombinedLightDirectional(\n    vec3 vVertexPosition, vec3 vNormal, vec3 uEyePosition, mat4 lightDesc,\n    float shininess) {\n    DirectionalLightInfo info = UnpackDirectionalLightInfo(lightDesc);\n    return DirectionalLightGetDiffuseAndSpecular(\n        info, vVertexPosition, vNormal, uEyePosition, shininess);\n}\n\n// ============================================================\n// Combined Light\n// ============================================================\nColorComponents CombinedLight(vec3 vVertexPosition,\n                   vec3 vNormal,\n                   vec3 uEyePosition,\n                   const mat4 uLightDescs[4],\n                   const float uLightTypes[4],\n                   float uShininess) {\n    ColorComponents acc = ColorComponents(vec3(0.0), vec3(0.0));\n\n    for (int i = 0; i < 4; ++i) {\n        ColorComponents curr;\n        float type = uLightTypes[i];\n        if (type == 2.0) {\n            curr = CombinedLightSpot(\n                       vVertexPosition, vNormal, uEyePosition, uLightDescs[i], \n                       uShininess);\n        } else if (type == 3.0) {\n            curr = CombinedLightPoint(\n                       vVertexPosition, vNormal, uEyePosition, uLightDescs[i], \n                       uShininess);\n        } else if (type == 1.0) {\n            curr = CombinedLightDirectional(\n                       vVertexPosition, vNormal, uEyePosition, uLightDescs[i], \n                       uShininess);\n        } else {\n            continue;\n        }\n        acc.diffuse = acc.diffuse + curr.diffuse;\n        acc.specular = acc.specular + curr.specular;\n    }\n    return acc;\n}\n"], t2));
      return t1;
    });
    ...
    _lazy($, "dirLight", "$get$dirLight", function() {
      return T.Vector3_Vector3(0, -50, 0);
    });
    _lazy($, "spotDirLight", "$get$spotDirLight", function() {
      return T.Vector3_Vector3(-11, -30, 0);
    });
    _lazy($, "gLightSources", "$get$gLightSources", function() {
      var t1, t2, t3, t4, t5;
      t1 = $.$get$dirLight();
      t2 = $.$get$ColorWhite();
      T.Matrix4$zero();
      T.Matrix4$zero();
      t1 = new G.DirectionalLight(t1, 40, 1, T.Vector3$zero(), T.Vector3$zero(), "dir");
      t1.Light$4("dir", 1, t2, t2);
      t3 = $.$get$posLight();
      t4 = new G.PointLight(t3, 80, 3, T.Vector3$zero(), T.Vector3$zero(), "point");
      t4.Light$4("point", 3, t2, t2);
      t5 = $.$get$spotDirLight();
      T.Matrix4$zero();
      T.Matrix4$zero();
      t5 = new G.SpotLight(t3, t5, 80, 0.4487989505128276, 2, 2, T.Vector3$zero(), T.Vector3$zero(), "spot");
      t5.Light$4("spot", 2, t2, t2);
      return P.LinkedHashMap_LinkedHashMap$_literal(["idDirectional", t1, "idPoint", t4, "idSpot", t5], P.String, G.Light);
    });
    _lazy($, "gLightVisualizers", "$get$gLightVisualizers", function() {
      return P.LinkedHashMap_LinkedHashMap$_empty(P.String, A.Node);
    });
  })();
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: -1, args: [P.String,,]}, {func: 1, ret: P.Null, args: [W.MouseEvent]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, args: [,]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.Null, args: [W.KeyboardEvent]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [,], opt: [P.StackTrace]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: P.bool, args: [W.Node0]}, {func: 1, ret: -1, args: [P.String, P.String]}, {func: 1, ret: P.Null, args: [P.num]}, {func: 1, args: [W.Event]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: -1, args: [W.Node0, W.Node0]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, ret: P.Null, args: [W.WheelEvent]}, {func: 1, ret: P.int, args: [P.int, P.Object]}, {func: 1, ret: P.Null, args: [W.Event]}, {func: 1, ret: -1, args: [W.Event]}, {func: 1, ret: -1, args: [P.num]}, {func: 1, ret: P.int, args: [,,]}, {func: 1, ret: P.String, args: [W.EventTarget]}], interceptorsByTag: null, leafTags: null};
