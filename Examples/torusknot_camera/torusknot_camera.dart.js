...
(function dartProgram() {
  ...
  W = {
    ...
    _EventStreamSubscription$: function(_target, _eventType, onData, _useCapture, $T) {
      ...
      if (t1 != null && true)
        C.Window_methods.addEventListener$3(_target, _eventType, t1, false);
  ...
  G = {
    ...
    ImageTexture$: function(cgl, url, _element) {
      ...
      t2 = new G.ImageTexture(_element, url, t1, 3553, cgl, new G.TextureProperties(1, 9729, 9729));
      J.bindTexture$2$x(cgl._gl, 3553, t1);
      J.pixelStorei$2$x(cgl._gl, 37440, 1);
      t2.SetImageData$1(_element);
  ...
  B = {
    ...
    TorusKnotGeometry: function(computeNormals, computeUVs, segmentsR, segmentsT, wrap) {
      var pointsAndTangents, bands, t1, t2, t3, gb, _i, lst, i, t4;
      pointsAndTangents = B.ParametricCurvePointsAndTangents(new B.TorusKnotGeometry_curveFunc(3, 2, 20, 1), 0, 6.283185307179586, segmentsR, true);
      bands = B.TubeHullBands(pointsAndTangents, segmentsT, 4);
      t1 = H.setRuntimeTypeInfo([], [G.Face3]);
      t2 = H.setRuntimeTypeInfo([], [G.Face4]);
      t3 = H.setRuntimeTypeInfo([], [T.Vector3]);
      gb = new G.GeometryBuilder(false, t1, t2, t3, P.LinkedHashMap_LinkedHashMap$_empty(P.String, [P.List,,]));
      ...
      gb.GenerateRegularGridFaces$3(segmentsT, segmentsR, true);
      return gb;
    },
  ...
  M = {
    updateTorusTexture: function(time, canvas) {
      var ctx, n, t1, grad, cs1, cs2;
      ctx = H.interceptedTypeCheck((canvas && C.CanvasElement_methods).getContext$1(canvas, "2d"), "$isCanvasRenderingContext2D");
      n = (Math.sin(time) + 1) / 2;
      ctx.rect(0, 0, canvas.width, canvas.height);
      t1 = canvas.width;
      if (typeof t1 !== "number")
        return t1.$mul();
      grad = ctx.createLinearGradient(0, 0, t1 * n, canvas.height);
      cs1 = Math.floor(360 * n);
      cs2 = Math.floor(90 * n);
      grad.addColorStop(0, "hsla(" + H.S(cs1) + ", 100%, 40%, 1)");
      grad.addColorStop(0.2, "black");
      grad.addColorStop(0.3, "black");
      grad.addColorStop(0.5, "hsla(" + H.S(cs2) + ", 100%, 40%, 1)");
      grad.addColorStop(0.7, "black");
      grad.addColorStop(0.9, "black");
      grad.addColorStop(1, "hsla(" + H.S(cs1) + ", 100%, 40%, 1)");
      ctx.fillStyle = grad;
      ctx.fill();
    },
    TorusKnotWithCustumUV: function(program) {
      var gb, uvs, t1, n, md, t2, t3;
      gb = B.TorusKnotGeometry(false, false, 128, 17, true);
      gb.EnableAttribute$1("aTexUV");
      uvs = H.setRuntimeTypeInfo([], [T.Vector2]);
      for (t1 = gb.vertices, n = 0; n < t1.length; ++n)
        C.JSArray_methods.add$1(uvs, $.$get$T()[n % 3]);
      gb.AddAttributesVector2$2("aTexUV", uvs);
      md = G.MeshData$("torusknot", program._cgl, 4, program._shaderObjectV._canonicalToLayoutPos);
      md.AddVertices$1(G.FlattenVector3List(t1));
    ...
    main: function() {
      var t1, t2, canvas, cgl, t3, t4, t5, t6, t7, t8, tkc, perspective, phase, t9, t10, t11, mat, e, ctx, gradient, t12, md, t13, t14, t15, t16, canvas2d, generatedTexture;
      t1 = {};
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      tkc = new M.TorusKnotCamera(20, 2, 3, 1, 0.01, new T.Vector3(t5), new T.Vector3(t6), t7, new T.Vector3(t8), "camera:torusknot");
      t5 = new T.Matrix4(new Float32Array(16));
      t5.setIdentity$0();
      t6 = new T.Matrix4(new Float32Array(16));
      t6.setIdentity$0();
      perspective = new G.Perspective(tkc, 50, 1, 0.1, 1000, t5, t6, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t3, t4), "perspective");
      perspective.Update$0();
      t3 = G.RenderProgram$("textured", cgl, $.$get$texturedVertexShader(), $.$get$texturedFragmentShader());
      t4 = [G.UniformGroup];
      t5 = H.setRuntimeTypeInfo([perspective], t4);
      t6 = [A.Node];
      ...
      t9 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(phase.get$resolutionChange(), {func: 1, ret: -1, args: [t9]}), false, t9);
      t9 = G.RenderProgram$("stars", cgl, $.$get$pointSpritesVertexShader(), $.$get$pointSpritesFragmentShader());
      t4 = H.setRuntimeTypeInfo([perspective], t4);
      t10 = H.setRuntimeTypeInfo([], t6);
      t11 = $.$get$BlendEquationMix();
      mat = G.Material$Transparent("stars", t11);
      ...
      ctx.fill();
      t12 = mat._uniforms;
      t12.$indexSet(0, "uTexture", G.ImageTexture$(t9._cgl, "Utils::Particles", e));
      t12.$indexSet(0, "uPointSize", 1000);
      ...
      new Float32Array(3);
      new Float32Array(3);
      C.JSArray_methods.add$1(t10, new A.Node(mat, md, t12, new T.Matrix3(t13), t14, t15, new T.Vector3(t16), md.name));
      C.JSArray_methods.add$1(t8, new A.Scene(t9, t4, t10, "stars"));
      C.JSArray_methods.add$1(t8, new A.Scene(t3, t5, t7, "objects"));
      canvas2d = H.interceptedTypeCheck(t2.querySelector("#texture"), "$isCanvasElement");
      M.updateTorusTexture(0, canvas2d);
      generatedTexture = G.ImageTexture$(cgl, "gen", canvas2d);
      mat = G.Material$Transparent("torus", t11);
      t2 = mat._uniforms;
      t2.$indexSet(0, "uTexture", generatedTexture);
      t2.$indexSet(0, "uColor", new T.Vector3(new Float32Array(3)));
      t2 = M.TorusKnotWithCustumUV(t3);
      ...
      new Float32Array(3);
      new Float32Array(3);
      C.JSArray_methods.add$1(t7, new A.Node(mat, t2, t6, new T.Matrix3(t3), t4, t5, new T.Vector3(t8), "torus"));
      t1._lastTimeMs = 0;
      new M.main_animate(t1, tkc, canvas2d, generatedTexture, phase).call$1(0);
    },
    TorusKnotCamera: function TorusKnotCamera(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9) {
      var _ = this;
      _.radius = t0;
      _.p = t1;
      _.q = t2;
    ...
    main_animate: function main_animate(t0, t1, t2, t3, t4) {
      ...
      _.tkc = t1;
      _.canvas2d = t2;
      _.generatedTexture = t3;
      _.phase = t4;
    }
  };
  var holders = [C, H, J, P, W, G, R, A, B, T, M];
  ...
  P.RenderingContext.prototype = {
    ...
    texImage2D$6: function(receiver, target, level, internalformat, format_OR_width, height_OR_type, bitmap_OR_border_OR_canvas_OR_image_OR_pixels_OR_video) {
      var t1;
      if (!!J.getInterceptor$(bitmap_OR_border_OR_canvas_OR_image_OR_pixels_OR_video).$isCanvasElement)
        t1 = true;
      else
        t1 = false;
      if (t1) {
  ...
  G.GeometryBuilder.prototype = {
    ...
    GenerateRegularGridFaces$3: function(w, h, wrapped) {
      var t1, t2, t3, i, t4, ip, j, jp, jp0, t5;
      t1 = this._faces4;
      t2 = w - 0;
      t3 = h - 0;
      i = 0;
      while (true) {
        ...
        while (true) {
          ...
          jp0 = jp % w;
          t5 = ip % h * w;
          C.JSArray_methods.add$1(t1, new G.Face4(t4 + jp0, t5 + jp0, t5 + j, t4 + j));
          j = jp;
        }
        i = ip;
      }
  ...
  M.TorusKnotCamera.prototype = {};
  M.main_animate.prototype = {
    call$1: function(timeMs) {
      var _lastTimeMs, t1, u, t2, t3, t4, t5, t6, t7, z, x, y, t8, t9, t10, t11, t12, t13;
      ...
      t5 = t1.heightScale;
      t6 = t1.p1;
      B.TorusKnotGetPos(u, t2, t3, t4, t5, t6);
      t7 = t1.p2;
      B.TorusKnotGetPos(u + t1._TorusEpsilon, t2, t3, t4, t5, t7);
      t5 = t6._v3storage;
      ...
      t4[0] = t5;
      t5 = this.canvas2d;
      M.updateTorusTexture(timeMs / 1000, t5);
      this.generatedTexture.SetImageData$1(t5);
      this.phase.Draw$0();
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(R.RenderPhaseResizeAware.prototype, "get$resolutionChange", "resolutionChange$1", 16);
  })();
  (function inheritance() {
    ...
    _inheritMany(W.Node0, [W.Element, W.CharacterData]);
    ...
    _inheritMany(G.Spatial, [A.Node, M.TorusKnotCamera]);
