...
(function dartProgram() {
  ...
  A = {
    ...
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, t10, orbit, perspective, progSphere, gb, md, modelMat, matSphere, future, progStars, matStars, e, ctx, gradient, mdStars;
      t1 = {};
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(5, 10, 0, 0, new T.Vector3(t5), -0.02, t6, t7, t8, new T.Vector3(t9), new T.Vector3(t10), "camera:orbit");
      ...
      t3 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(perspective.get$resolutionChange(), {func: 1, ret: -1, args: [t3]}), false, t3);
      progSphere = G.RenderProgram$("spheres", cgl, $.$get$sphereVertexShader(), $.$get$sphereFragmentShader());
      gb = B.IcosahedronGeometry(true, 1, 3);
      md = G.MeshData$("icosahedron-3", progSphere._cgl, 4, progSphere._shaderObjectV._canonicalToLayoutPos);
      md.AddVertices$1(G.FlattenVector3List(gb.vertices));
      t3 = H.assertSubtype(gb.GenerateFaceIndices$0(), "$isList", [P.int], "$asList");
      t5 = md._cgl;
      md._indexBuffer = J.createBuffer$0$x(t5._gl);
      t6 = md._vertices.length;
      if (t6 < 768) {
        md.set$_faces(new Uint8Array(H._ensureNativeList(t3)));
        md._indexBufferType = 5121;
      } else if (t6 < 196608) {
        md.set$_faces(new Uint16Array(H._ensureNativeList(t3)));
        md._indexBufferType = 5123;
      } else {
        md.set$_faces(new Uint32Array(H._ensureNativeList(t3)));
        md._indexBufferType = 5125;
      }
      J.bindVertexArray$1$x(t5._gl, md._vao);
      t3 = md._indexBuffer;
      t6 = md._faces;
      J.bindBuffer$2$x(t5._gl, 34963, t3);
      J.bufferData$3$x(t5._gl, 34963, t6, 35048);
      G._GeometryBuilderAttributesToMeshData(gb, md);
      modelMat = new T.Matrix4(new Float32Array(16));
      modelMat.setIdentity$0();
      ...
      matSphere = G.Material$Transparent("sphere", t5);
      t6 = matSphere._uniforms;
      t6.$indexSet(0, "uNormalMatrix", new T.Matrix3(t3));
      t6.$indexSet(0, "uModelMatrix", modelMat);
      future = D.LoadImage($.textureFile);
      future.then$1$1(new A.main_closure(cgl, matSphere), null);
      t6 = $.$get$gLoadables();
      C.JSArray_methods.add$1(t6, future);
      progStars = G.RenderProgram$("stars", cgl, $.$get$pointSpritesVertexShader(), $.$get$pointSpritesFragmentShader());
      matStars = G.Material$Transparent("stars", t5);
      ...
      ctx.fill();
      t2 = matStars._uniforms;
      t2.$indexSet(0, "uTexture", G.ImageTexture$(cgl, "Utils::Particles", e));
      t2.$indexSet(0, "uPointSize", 1000);
      t3 = new T.Matrix4(new Float32Array(16));
      t3.setIdentity$0();
      t2.$indexSet(0, "uModelMatrix", t3);
      mdStars = R.Utils_MakeStarMesh(progStars, 2000, 100);
      t1._lastTimeMs = 0;
      P.Future_wait(t6, t4).then$1$1(new A.main_closure0(new A.main_animate(t1, orbit, modelMat, progSphere, md, matSphere, perspective, progStars, mdStars, matStars, fps)), null);
    },
  ...
  var holders = [C, H, J, P, W, G, R, D, A, T, B];
  ...
  A.main_closure.prototype = {
    call$1: function(img) {
      ...
      this.matSphere._uniforms.$indexSet(0, "uTexture", G.ImageTexture$(this.cgl, $.textureFile, img));
    },
    $signature: 28
  };
  A.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      t6 = this.perspective;
      t9 = [G.UniformGroup];
      t4.Draw$2(t8, H.setRuntimeTypeInfo([t7, t6], t9));
      t3 = t3._m4storage;
      t3[14] = 0;
      t3[13] = 0;
      t3[12] = 1.5;
      t4.Draw$2(t8, H.setRuntimeTypeInfo([t7, t6], t9));
      this.progStars.Draw$2(this.mdStars, H.setRuntimeTypeInfo([this.matStars, t6], t9));
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "sphereVertexShader", "$get$sphereVertexShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("sphereV");
      t2 = [P.String];
    ...
    _lazy($, "sphereFragmentShader", "$get$sphereFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("sphereF");
      t2 = [P.String];
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vTexUV"], t2));
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uTexture"], t2));
