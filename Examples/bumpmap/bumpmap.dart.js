...
(function dartProgram() {
  ...
  J = {
    ...
    generateMipmap$1$x: function(receiver, a0) {
  ...
  G = {
    ...
    Illumination__SetLightInfo: function(descs, types, lights) {
      var t1, t2, n, _i, l, t3, t4, t5, t6;
      H.assertSubtype(lights, "$isList", [G.Light], "$asList");
      t1 = descs.length;
      C.NativeFloat32List_methods.fillRange$3(descs, 0, t1, 0);
      C.NativeFloat32List_methods.fillRange$3(types, 0, 4, 0);
      for (t2 = lights.length, n = 0, _i = 0; _i < t2; ++_i) {
        l = lights[_i];
        t3 = n * 16;
        t4 = t3 + 4;
        t5 = l.dir._v3storage;
        ...
        t5 = t5[2];
        if (t6 >= t1)
          return H.ioore(descs, t6);
        descs[t6] = t5;
        t5 = t3 + 8;
        t6 = l.colorDiffuse._v3storage;
        t4 = t6[0];
        if (t5 >= t1)
          return H.ioore(descs, t5);
        descs[t5] = t4;
        t4 = t3 + 9;
        t5 = t6[1];
        if (t4 >= t1)
    ...
    DirectionalLight: function DirectionalLight(t0, t1, t2, t3, t4) {
      var _ = this;
      _.dir = t0;
      _.type = t1;
      _.colorDiffuse = t2;
  ...
  T = {
    ...
    Vector3_Vector3$all: function(value) {
  ...
  L = {
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, orbit, perspective, phase, sceneMain;
      t1 = {};
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(0.3, 0, 0, 0, new T.Vector3(t4), -0.02, t5, t6, t7, new T.Vector3(t8), new T.Vector3(t9), "camera:orbit");
      orbit.mouseWheelFactor = -0.001;
      t4 = new T.Matrix4(new Float32Array(16));
      t4.setIdentity$0();
      t5 = new T.Matrix4(new Float32Array(16));
      t5.setIdentity$0();
      perspective = new G.Perspective(orbit, 50, 1, 0.01, 1000, t4, t5, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), "perspective");
      ...
      t7.setFrom$1(t5);
      t8.setFrom$1(t6);
      t6 = H.setRuntimeTypeInfo([], [G.Light]);
      t5 = new Float32Array(64);
      t9 = new Float32Array(4);
      C.JSArray_methods.add$1(t6, new G.DirectionalLight(t4, 1, t7, t8, "dir"));
      t8 = H.setRuntimeTypeInfo([], [A.Scene]);
      phase = new R.RenderPhaseResizeAware(canvas, perspective, null, cgl, t8, 17664, "main");
      ...
      t7 = G.RenderProgram$("main", cgl, $.$get$vertexShader(), $.$get$fragmentShader());
      t2 = H.setRuntimeTypeInfo([perspective, new G.Illumination(t6, t5, t9, P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), "illumination")], [G.UniformGroup]);
      t9 = H.setRuntimeTypeInfo([], [A.Node]);
      sceneMain = new A.Scene(t7, t2, t9, "main");
      C.JSArray_methods.add$1(t8, sceneMain);
      t1._lastTimeMs = 0;
      P.Future_wait(H.setRuntimeTypeInfo([D.LoadJson("../asset/leeperrysmith/LeePerrySmith.js"), D.LoadImage("../asset/leeperrysmith/Infinite-Level_02_Disp_NoSmoothUV-4096.jpg")], [[P.Future, P.Object]]), t3).then$1$1(new L.main_closure(cgl, sceneMain, new L.main_animate(t1, orbit, phase, fps)), null);
    },
  ...
  var holders = [C, H, J, P, W, G, R, A, D, T, L, Y];
  ...
  G.ShaderObject.prototype = {
    AddAttributeVars$1: function(names) {
      ...
      for (t1 = this.attributeVars, t2 = this._canonicalToLayoutPos, _i = 0; _i < 3; ++_i) {
        n = names[_i];
    ...
    AddVaryingVars$1: function(names) {
      var t1, _i;
      H.assertSubtype(names, "$isList", [P.String], "$asList");
      for (t1 = this.varyingVars, _i = 0; _i < 3; ++_i)
  ...
  L.main_animate.prototype = {
    call$1: function(timeMs) {
      var t1, t2, t3, t4, t5, t6, t7, rcp, t8, t9, len, x, y, z, c, s, $C, m11, m12, m13, m21, m22, m23, m31, m32, m33, t10, t11, t12, t13, t14, t15, t16;
  ...
  L.main_closure.prototype = {
    call$1: function(list) {
      var tp, t1, t2, t3, t4, t5, t6, t7, gbs, t8, md, desc, index, t9, t10, t11, t12, t13, t14, n;
      H.listTypeCheck(list);
      tp = new G.TextureProperties(1, 9729, 9729);
      tp.mipmap = true;
      tp.minFilter = 9987;
      tp.clamp = true;
      t1 = this.cgl;
      ...
      t3 = t2.$index(list, 1);
      t4 = J.createTexture$0$x(t1._gl);
      J.bindTexture$2$x(t1._gl, 3553, t4);
      J.pixelStorei$2$x(t1._gl, 37440, 1);
      J.bindTexture$2$x(t1._gl, 3553, t4);
      J.texImage2D$6$x(t1._gl, 3553, 0, 6408, 6408, 5121, t3);
      t5 = tp.magFilter;
      J.texParameteri$3$x(t1._gl, 3553, 10240, t5);
      t5 = tp.minFilter;
      J.texParameteri$3$x(t1._gl, 3553, 10241, t5);
      if (tp.clamp) {
        J.texParameteri$3$x(t1._gl, 3553, 10242, 33071);
        J.texParameteri$3$x(t1._gl, 3553, 10243, 33071);
      }
      if (tp.mipmap)
        J.generateMipmap$1$x(t1._gl, 3553);
      J.getError$0$x(t1._gl);
      J.bindTexture$2$x(t1._gl, 3553, null);
      t5 = P.String;
      t6 = P.Object;
      t7 = P.LinkedHashMap_LinkedHashMap$_empty(t5, t6);
      t7.$indexSet(0, "cDepthTest", true);
      t7.$indexSet(0, "cDepthWrite", true);
      t7.$indexSet(0, "cBlendEquation", $.$get$BlendEquationNone());
      t7.$indexSet(0, "cStencilFunc", $.$get$StencilFunctionNone());
      t7.$indexSet(0, "uColor", $.$get$colSkin());
      t7.$indexSet(0, "uShininess", 10);
      t7.$indexSet(0, "uBumpMap", new G.ImageTexture(t3, "../asset/leeperrysmith/Infinite-Level_02_Disp_NoSmoothUV-4096.jpg", t4, 3553, t1, tp));
      t7.$indexSet(0, "uBumpScale", 0.01);
      gbs = Y.ImportGeometryFromThreeJsJson(H.interceptedTypeCheck(t2.$index(list, 0), "$isMap"));
      if (0 >= gbs.length)
        return H.ioore(gbs, 0);
      P.print(gbs[0]);
      t2 = this.sceneMain;
      t1 = t2.program;
      if (0 >= gbs.length)
      ...
      t4 = gbs[0];
      t3 = t1._cgl;
      t1 = t1._shaderObjectV._canonicalToLayoutPos;
      t6 = P.LinkedHashMap_LinkedHashMap$_empty(t5, t6);
      t8 = J.createVertexArray$0$x(t3._gl);
      md = new G.MeshData(t3, t8, 4, t6, t1, -1, P.LinkedHashMap_LinkedHashMap$_empty(t5, P.Float32List), "meshdata:../asset/leeperrysmith/LeePerrySmith.js");
      t5 = G.FlattenVector3List(t4.vertices);
      t6.$indexSet(0, "aPosition", J.createBuffer$0$x(t3._gl));
      md._vertices = t5;
      md.ChangeAttribute$3("aPosition", t5, 3);
      desc = $.$get$_VarsDb().$index(0, "aPosition");
      if (desc == null)
        H.throwExpression("Unknown canonical aPosition");
      index = t1.$index(0, "aPosition");
      J.bindVertexArray$1$x(t3._gl, t8);
      t3.enableVertexAttribArray$2(0, index, 0);
      t3.vertexAttribPointer$7(0, t6.$index(0, "aPosition"), index, desc.GetSize$0(), 5126, false, 0, 0);
      t1 = H.assertSubtype(t4.GenerateFaceIndices$0(), "$isList", [P.int], "$asList");
      md._indexBuffer = J.createBuffer$0$x(t3._gl);
      t5 = md._vertices.length;
      if (t5 < 768) {
      ...
      J.bufferData$3$x(t3._gl, 34963, t5, 35048);
      G._GeometryBuilderAttributesToMeshData(t4, md);
      t1 = [A.Node];
      ...
      new Float32Array(3);
      new Float32Array(3);
      n = new A.Node(null, null, t1, new T.Matrix3(t10), t11, t12, new T.Vector3(t13), new T.Vector3(t14), "wrapper");
      C.JSArray_methods.add$1(t1, new A.Node(new G.Material(t7, "mat"), md, t3, new T.Matrix3(t4), t5, t6, new T.Vector3(t8), new T.Vector3(t9), "meshdata:../asset/leeperrysmith/LeePerrySmith.js"));
      t1 = new T.Vector3(new Float32Array(3));
  ...
  (function installTearOffs() {
    ...
    _static_1(W, "html_Element__determineMouseWheelEventType$closure", "Element__determineMouseWheelEventType", 33);
    ...
    _instance_1_u(R.RenderPhaseResizeAware.prototype, "get$resolutionChange", "resolutionChange$1", 13);
  })();
  (function inheritance() {
    ...
    _inheritMany(W.EventTarget, [W.Node0, W.FileWriter, W.HttpRequestEventTarget, W.MessagePort, W.SourceBuffer, W._SourceBufferList_EventTarget_ListMixin, W.TextTrack, W.TextTrackCue, W._TextTrackList_EventTarget_ListMixin, W.VideoTrackList, W.Window, P.AudioTrackList, P.BaseAudioContext]);
    ...
    _inheritMany(G.NamedEntity, [G.UniformGroup, G.Light, G.MeshData, G.RenderProgram, G.Spatial, A.RenderPhase, A.Scene]);
    _inherit(G.DirectionalLight, G.Light);
