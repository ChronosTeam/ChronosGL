...
t.a=b
s=b}else s=b
if(!J.v(s).$isb)throw H.e(P.i7("Arguments to main must be a List: "+H.h(s)))
...
s.y=q
s.r=r&&p
s.f=new H.fs(P.hI(null,H.aH),0)
r=P.m
s.sd4(new H.a8(0,null,null,null,null,null,0,[r,H.aG]))
s.sd6(new H.a8(0,null,null,null,null,null,0,[r,null]))
if(s.x){q=new H.fL()
s.Q=q
...
p=new H.aQ(0,null,!1)
o=new H.aG(s,new H.a8(0,null,null,null,null,null,0,[r,H.aQ]),q,u.createNewIsolate(),p,new H.a6(H.hs()),new H.a6(H.hs()),!1,!1,[],P.az(null,null,null,null),null,null,!1,!0,P.az(null,null,null,null))
q.l(0,0)
o.aS(0,p)
u.globalState.e=o
...
u.globalState.f.a4()},
kj:function(a){var t=P.ay(["command","print","msg",a])
return new H.a2(!0,P.bq(null,P.m)).D(t)},
...
if(t==null)throw H.e(new P.o("No stack trace"))}s=t.match(new RegExp("^ *at [^(]*\\((.*):[0-9]*:[0-9]*\\)$","m"))
if(s!=null)return s[1]
s=t.match(new RegExp("^[^@]*@(.*):[0-9]*$","m"))
if(s!=null)return s[1]
throw H.e(new P.o('Cannot extract URI from "'+t+'"'))},
jP:function(a,b){var t,s,r,q,p,o,n,m,l,k,j,i,h
t=new H.aE(!0,[]).I(b.data)
s=J.a3(t)
switch(s.h(t,"command")){case"start":u.globalState.b=H.kI(s.h(t,"id"))
r=s.h(t,"functionName")
q=r==null?u.globalState.cx:u.staticFunctionNameToClosure(r)
p=s.h(t,"args")
o=new H.aE(!0,[]).I(s.h(t,"msg"))
n=s.h(t,"isSpawnUri")
m=s.h(t,"startPaused")
l=new H.aE(!0,[]).I(s.h(t,"replyTo"))
s=u.globalState.a++
k=P.m
j=P.az(null,null,null,k)
i=new H.aQ(0,null,!1)
h=new H.aG(s,new H.a8(0,null,null,null,null,null,0,[k,H.aQ]),j,u.createNewIsolate(),i,new H.a6(H.hs()),new H.a6(H.hs()),!1,!1,[],P.az(null,null,null,null),null,null,!1,!0,P.az(null,null,null,null))
j.l(0,0)
h.aS(0,i)
u.globalState.f.a.G(0,new H.aH(h,new H.dQ(q,p,o,n,m,l),"worker-start"))
u.globalState.d=h
u.globalState.f.a4()
break
...
k=new H.a2(!0,P.bq(null,P.m)).D(k)
s.toString
...
r=new H.a2(!0,P.bq(null,P.m)).D(r)
s.toString
self.postMessage(r)}else try{self.console.log(a)}catch(q){H.ar(q)
t=H.an(q)
s=P.bF(t)
throw H.e(s)}},
...
r=u.globalState.d.a
q=t.f
f.B(0,["spawned",new H.aS(s,r),q,t.r])
r=new H.dR(a,b,c,d,t)
if(e){t.ba(q,q)
u.globalState.f.a.G(0,new H.aH(t,r,"start isolate"))}else r.$0()},
k9:function(a,b){var t=new H.eX(!0,!1,null)
t.ci(a,b)
return t},
kk:function(a){return new H.aE(!0,[]).I(new H.a2(!1,P.bq(null,P.m)).D(a))},
...
if(b!=null){t=b.x
if(t!=null)return t}return!!J.v(a).$isl},
h:function(a){var t
...
if(q==null||t===C.z||!!J.v(a).$isaC){p=C.q(a)
if(p==="Object"){o=a.constructor
if(typeof o=="function"){n=String(o).match(/^\s*function\s*([\w$]*)\s*\(/)
m=n==null?null:n[1]
if(typeof m==="string"&&/^\w+$/.test(m))q=m}if(q==null)q=p}else q=p}q=q
if(q.length>1&&C.h.ag(q,0)===36)q=C.h.c1(q,1)
...
aK:function(a){throw H.e(new P.a_(a))},
...
q=r&65535
if((C.b.ao(r,16)&8191)===10)switch(q){case 438:return t.$1(H.hH(H.h(s)+" (Error "+q+")",null))
...
if(typeof a==="boolean")return!a
throw H.e(H.aj(a,"bool"))},
aJ:function(a){throw H.e(new H.fh(a))},
d:function(a){if(H.al(a))throw H.e(new P.bx(null))},
...
return a.$ti},
iV:function(a,b){return H.hW(a["$as"+H.h(b)],H.hc(a))},
...
q=q+p+H.aq(l[j],b)+(" "+H.h(j))}q+="}"}return"("+q+") => "+t},
...
if(a instanceof H.aM){t=H.iR(a)
if(t!=null)return H.aq(t,null)}s=J.v(a).constructor.name
if(a==null)return s
...
if('func' in a)return b.name==="hC"||b.name==="n"
t=typeof a==="object"&&a!==null&&a.constructor===Array
if(t){H.d(!0)
s=a[0]}else s=a
...
return b},
hV:function(a){return J.hq(a,!1,null,!!a.$isl)},
kN:function(a,b,c){var t=b.prototype
if(u.leafTags[a]===true)return J.hq(t,!1,null,!!t.$isl)
...
t=C.D()
t=H.aU(C.A,H.aU(C.F,H.aU(C.p,H.aU(C.p,H.aU(C.E,H.aU(C.B,H.aU(C.C(C.q),t)))))))
...
if(s===r)return t.i
if(t.e===r)throw H.e(new P.cH("Return interceptor for "+H.h(s(a,t))))}q=a.constructor
...
if(typeof q=="function"){Object.defineProperty(q,$.$get$hG(),{value:C.n,enumerable:false,writable:true,configurable:true})
return C.n}return C.n},
a3:function(a){if(typeof a=="string")return J.aw.prototype
if(a==null)return a
if(a.constructor==Array)return J.av.prototype
if(typeof a!="object"){if(typeof a=="function")return J.ax.prototype
return a}if(a instanceof P.n)return a
...
if(!(a instanceof P.n))return J.aC.prototype
return a},
kD:function(a){if(typeof a=="string")return J.aw.prototype
if(a==null)return a
if(!(a instanceof P.n))return J.aC.prototype
return a},
...
hY:function(a,b){return J.k(a).b9(a,b)},
hZ:function(a,b,c){return J.k(a).bb(a,b,c)},
j6:function(a,b){return J.k(a).cE(a,b)},
cS:function(a,b,c){return J.k(a).bc(a,b,c)},
i_:function(a,b,c){return J.k(a).bd(a,b,c)},
cT:function(a,b){return J.k(a).cH(a,b)},
j7:function(a,b){return J.k(a).be(a,b)},
j8:function(a,b,c){return J.k(a).bf(a,b,c)},
i0:function(a,b,c,d){return J.k(a).bg(a,b,c,d)},
j9:function(a,b,c,d,e){return J.k(a).bh(a,b,c,d,e)},
ja:function(a,b){return J.kC(a).R(a,b)},
hw:function(a){return J.k(a).bj(a)},
jb:function(a){return J.k(a).bk(a)},
jc:function(a){return J.k(a).cK(a)},
jd:function(a,b){return J.k(a).bm(a,b)},
je:function(a,b){return J.k(a).bn(a,b)},
jf:function(a,b,c,d){return J.k(a).bo(a,b,c,d)},
jg:function(a,b,c,d,e){return J.k(a).cQ(a,b,c,d,e)},
jh:function(a,b,c,d,e){return J.k(a).bp(a,b,c,d,e)},
ji:function(a,b,c,d,e,f){return J.k(a).cR(a,b,c,d,e,f)},
jj:function(a,b){return J.hR(a).p(a,b)},
cU:function(a,b){return J.k(a).bq(a,b)},
jk:function(a,b){return J.k(a).br(a,b)},
jl:function(a){return J.k(a).cS(a)},
...
jn:function(a){return J.k(a).gbN(a)},
hx:function(a){return J.k(a).gm(a)},
hy:function(a){return J.k(a).gn(a)},
i1:function(a){return J.k(a).gJ(a)},
jo:function(a){return J.k(a).ac(a)},
jp:function(a,b){return J.k(a).az(a,b)},
jq:function(a,b,c){return J.k(a).aA(a,b,c)},
i2:function(a,b,c){return J.k(a).aD(a,b,c)},
jr:function(a,b){return J.k(a).bu(a,b)},
js:function(a,b){return J.hR(a).bw(a,b)},
jt:function(a,b){return J.k(a).B(a,b)},
ju:function(a,b,c,d){return J.k(a).aI(a,b,c,d)},
aX:function(a){return J.v(a).k(a)},
jv:function(a,b,c,d){return J.k(a).di(a,b,c,d)},
jw:function(a,b,c){return J.k(a).bC(a,b,c)},
hz:function(a,b,c){return J.k(a).bD(a,b,c)},
i3:function(a,b,c){return J.k(a).bE(a,b,c)},
i4:function(a,b,c){return J.k(a).bF(a,b,c)},
i5:function(a,b,c){return J.k(a).bG(a,b,c)},
jx:function(a,b,c,d){return J.k(a).bH(a,b,c,d)},
jy:function(a,b,c,d){return J.k(a).bI(a,b,c,d)},
jz:function(a,b){return J.k(a).bK(a,b)},
jA:function(a,b,c){return J.k(a).dj(a,b,c)},
i6:function(a,b,c,d,e,f,g){return J.k(a).bM(a,b,c,d,e,f,g)},
a:function a(){},
dT:function dT(){},
co:function co(){},
ba:function ba(){},
...
kf:function(a){P.hK(C.o,a)},
ko:function(a,b){if(H.aV(a,{func:1,args:[P.aA,P.aA]})){b.toString
return a}else{b.toString
return a}},
kg:function(a,b){var t,s,r
H.d(b.a<4)
H.d(!(a instanceof P.aF))
H.d(b.a===0)
b.a=1
try{a.bB(new P.fw(b),new P.fx(b))}catch(r){t=H.ar(r)
s=H.an(r)
P.kR(new P.fy(b,t,s))}},
...
H.d(s!=null)
$.y=s}},
h6:function(a,b,c,d){var t=C.e!==c
if(t)d=!(!t||!1)?c.ar(d):c.cF(d)
P.iM(d)},
...
ay:function(a){return H.kB(a,new H.a8(0,null,null,null,null,null,0,[null,null]))},
...
C.a.l(b,o)
C.a.l(b,p)},
az:function(a,b,c,d){return new P.fI(0,null,null,null,null,null,0,[d])},
...
for(t=a.e,s=t.gF(t),s=s.gA(s),r=b.x,q=[[P.b,P.m]],p=[P.G],o=[T.bl],n=[T.J],m=[T.N];s.q();){l=s.gt()
...
break
default:if(H.al(!1))H.aJ("unknown type for "+H.h(l)+" ["+J.jm(j[0]).k(0)+"] ["+new H.ak(H.hd(j),null).k(0)+"] "+H.h(j))}}},
k5:function(a,b,c,d){var t,s,r,q,p,o,n
t=P.az(null,null,null,P.u)
s=c.b
r=d.b
q=c.f
p=J.jb(b.a)
...
n=G.iH(b.a,35632,r)
J.hZ(b.a,p,n)
if(q.length>0)J.jv(b.a,p,q,35980)
J.jr(b.a,p)
if(!J.jq(b.a,p,35714))H.z(J.jp(b.a,p))
t=new G.ez(b,c,d,p,P.jV(c.c,null),P.aa(),P.aa(),t,null,a,!1,!0)
t.cg(a,b,c,d)
return t},
ea:function ea(){},
...
t=C.y.d9(document,"#webgl-canvas")
s=t.clientWidth
r=t.clientHeight
t.width=s
t.height=r
q=new G.d5(null,t)
p=(t&&C.x).bQ(t,"webgl2",P.ay(["alpha",!1,"depth",!0,"stencil",!0,"antialias",!0,"premultipliedAlpha",!0,"preserveDrawingBuffer",!1,"failIfMajorPerformanceCaveat",!1]))
q.a=p
...
$ishC:1}
J.av.prototype={
at:function(a,b){if(!!a.immutable$list)throw H.e(new P.o(b))},
as:function(a,b){if(!!a.fixed$length)throw H.e(new P.o(b))},
...
throw H.e(new P.o("Result of truncating division is "+H.h(t)+": "+H.h(a)+" ~/ "+b))},
ao:function(a,b){var t
if(a>0)t=b>31?0:a>>>b
else{t=b>31?31:b
t=a>>t>>>0}return t},
...
H.aO.prototype={
gA:function(a){return new H.cp(this,this.gj(this),0,null,[H.am(this,"aO",0)])},
dh:function(a,b){var t,s
t=H.H([],[H.am(this,"aO",0)])
...
r=s+2
t.toString
if(typeof t!=="object"||t===null||!!t.fixed$length)H.z(new P.o("removeRange"))
...
t=this.cx
if(t!=null)t.H(0)
for(t=this.b,s=t.gbL(t),s=s.gA(s);s.q();)s.gt().cm()
t.H(0)
this.c.H(0)
...
r=new H.a2(!0,new P.cL(0,null,null,null,null,null,0,[null,P.m])).D(r)
s.toString
self.postMessage(r)}return!1}t.d8()
return!0},
b5:function(){if(self.window!=null)new H.ft(this).$0()
else for(;this.bz(););},
a4:function(){var t,s,r,q,p
if(!u.globalState.x)this.b5()
else try{this.b5()}catch(r){t=H.ar(r)
s=H.an(r)
q=u.globalState.Q
p=P.ay(["command","error","msg",H.h(t)+"\n"+H.h(s)])
p=new H.a2(!0,P.bq(null,P.m)).D(p)
q.toString
self.postMessage(p)}}}
H.ft.prototype={
...
break
case"add-ondone":t.cC(s.h(r,1),s.h(r,2))
break
case"remove-ondone":t.da(s.h(r,1))
break
case"set-errors-fatal":t.bY(s.h(r,1),s.h(r,2))
break
case"ping":t.cZ(s.h(r,1),s.h(r,2),s.h(r,3))
break
case"kill":t.cY(s.h(r,1),s.h(r,2))
break
...
t.dx.a3(0,s)
break}return}u.globalState.f.a.G(0,new H.aH(t,new H.fN(this,r),"receive"))},
...
s=new H.a2(!0,P.bq(null,P.m)).D(t)
...
t=u.globalState.f
s=u.globalState.d
t.a.G(0,new H.aH(s,new H.eY(this,b),"timer"))
...
if(!!t.$isj)return this.bU(a)
if(!!t.$isjN){r=this.gbR()
q=t.gF(a)
q=H.hJ(q,r,H.am(q,"a7",0),null)
q=P.im(q,!0,H.am(q,"a7",0))
t=t.gbL(a)
t=H.hJ(t,r,H.am(t,"a7",0),null)
return["map",q,P.im(t,!0,H.am(t,"a7",0))]}if(!!t.$isil)return this.bV(a)
if(!!t.$isa)this.bJ(a)
if(!!t.$isk3)this.a5(a,"RawReceivePorts can't be transmitted:")
if(!!t.$isaS)return this.bW(a)
...
if(!(a instanceof P.n))this.bJ(a)
return["dart",u.classIdExtractor(a),this.bT(u.classFieldsExtractor(a))]},
a5:function(a,b){throw H.e(new P.o((b==null?"Can't transmit:":b)+" "+H.h(a)))},
...
if(a==null||typeof a==="string"||typeof a==="number"||typeof a==="boolean")return a
if(typeof a!=="object"||a===null||a.constructor!==Array)throw H.e(P.i7("Bad serialized message: "+H.h(a)))
switch(C.a.gcU(a)){case"ref":H.d(J.A(a[0],"ref"))
...
o=p.bv(r)
if(o==null)return
n=new H.aS(o,s)}else n=new H.br(t,r,s)
C.a.l(this.b,n)
return n},
...
H.hv.prototype={
$1:function(a){if(!!J.v(a).$isaN)if(a.$thrownJsError==null)a.$thrownJsError=this.a
return a},
...
else s=typeof t!=="object"?J.a5(t):H.aB(t)
return(s^H.aB(this.b))>>>0},
k:function(a){var t=this.c
if(t==null)t=this.a
return"Closure '"+H.h(this.d)+"' of "+H.eu(t)}}
H.f5.prototype={
...
H.fh.prototype={
k:function(a){return C.h.K("Assertion failed: ",P.hB(this.a))}}
H.ak.prototype={
k:function(a){var t,s
t=this.b
if(t!=null)return t
...
if(s==null)return!1
return this.aZ(s,b)}else return this.d0(b)},
...
s=this.e
t=this.b.b
if(H.aV(s,{func:1,args:[P.n,P.eM]}))return t.dd(s,a.a,a.b)
else return t.ax(s,a.a)}}
P.aF.prototype={
bB:function(a,b){var t,s,r
t=$.y
if(t!==C.e){t.toString
if(b!=null)b=P.ko(b,t)}s=new P.aF(0,t,null,[null])
r=b==null?1:3
...
H.d(this.a<4)
t=this.$ti
if(H.h7(a,"$isdJ",t,"$asdJ"))if(H.h7(a,"$isaF",t,null))P.iI(a,this)
else P.kg(a,this)
else{s=this.b4()
H.d(this.a<4)
this.a=4
...
try{H.d(o)
H.d(p===8)
t=q.b.b.by(q.d)}catch(n){s=H.ar(n)
r=H.an(n)
...
p.a=!0
return}if(!!J.v(t).$isdJ){if(t instanceof P.aF&&t.gap()>=4){if(t.gap()===8){q=t
H.d(q.gap()===8)
p=this.b
p.b=q.gcz()
...
try{r=this.b
H.d((r.c&1)!==0)
this.a.b=r.b.b.ax(r.d,this.c)}catch(q){t=H.ar(q)
s=H.an(q)
r=this.a
r.b=new P.aL(t,s)
r.a=!0}},
...
try{if(C.e===$.y){a.$0()
return}P.iK(null,null,this,a)}catch(r){t=H.ar(r)
s=H.an(r)
P.h4(null,null,this,t,s)}},
df:function(a,b){var t,s,r
try{if(C.e===$.y){a.$1(b)
return}P.iL(null,null,this,a,b)}catch(r){t=H.ar(r)
s=H.an(r)
P.h4(null,null,this,t,s)}},
cF:function(a){return new P.fR(this,a)},
ar:function(a){return new P.fQ(this,a)},
cG:function(a){return new P.fS(this,a)},
h:function(a,b){return},
by:function(a){if($.y===C.e)return a.$0()
return P.iK(null,null,this,a)},
ax:function(a,b){if($.y===C.e)return a.$1(b)
return P.iL(null,null,this,a,b)},
dd:function(a,b,c){if($.y===C.e)return a.$2(b,c)
...
if(s==null)return!1
return s[b]!=null}else return this.cn(b)},
...
P.fG.prototype={}
P.p.prototype={
gA:function(a){return new H.cp(a,this.gj(a),0,null,[H.am(a,"p",0)])},
p:function(a,b){return this.h(a,b)},
bw:function(a,b){return new H.cr(a,b,[H.am(a,"p",0),null])},
...
P.au.prototype={
ae:function(a,b){return C.b.ae(this.a,b.gco())},
ad:function(a,b){return C.b.ad(this.a,b.gco())},
w:function(a,b){if(b==null)return!1
...
p=new P.df().$1(s%1e6)
return""+C.b.M(s,36e8)+":"+H.h(r)+":"+H.h(q)+"."+H.h(p)},
$isB:1,
...
return"Concurrent modification during iteration: "+H.h(P.hB(t))+"."}}
P.cF.prototype={
...
W.bz.prototype={
bQ:function(a,b,c){var t=this.cr(a,b,P.ky(c,null))
return t},
...
gJ:function(a){return a.z}}
W.bD.prototype={
k:function(a){return"Rectangle ("+H.h(a.left)+", "+H.h(a.top)+") "+H.h(this.gO(a))+" x "+H.h(this.gN(a))},
...
r=this.gO(a)
q=this.gN(a)
return W.iJ(W.aI(W.aI(W.aI(W.aI(0,t&0x1FFFFFFF),s&0x1FFFFFFF),r&0x1FFFFFFF),q&0x1FFFFFFF))},
...
gj:function(a){return a.length}}
W.eO.prototype={
h:function(a,b){return this.cs(a,b)},
gj:function(a){return a.length},
...
t=P.K
s=new P.aF(0,$.y,null,[t])
this.cq(a)
this.cw(a,W.ks(new W.ff(new P.fZ(s,[t]))))
return s},
cw:function(a,b){return a.requestAnimationFrame(H.cP(b,1))},
cq:function(a){if(!!(a.requestAnimationFrame&&a.cancelAnimationFrame))return;(function(b){var t=['ms','moz','webkit','o']
...
r=J.a5(a.width)
q=J.a5(a.height)
return W.iJ(W.aI(W.aI(W.aI(W.aI(0,t),s),r),q))},
$isC:1,
$asC:function(){},
gN:function(a){return a.height},
gaw:function(a){return a.left},
...
W.w.prototype={
gA:function(a){return new W.dG(a,this.gj(a),-1,null,[H.am(a,"w",0)])},
$isc:1,
$asc:null,
$isb:1,
$asb:null}
...
cQ:function(a,b,c,d,e){return a.drawArraysInstanced(b,c,d,e)},
cR:function(a,b,c,d,e,f){return a.drawElementsInstanced(b,c,d,e,f)},
cS:function(a){return a.endTransformFeedback()},
di:function(a,b,c,d){this.cA(a,b,c,d)
return},
...
C.a.l(t,H.h(q)+": "+H.h(s.h(0,q)))}return C.a.a2(t,"\n")}}
G.d5.prototype={
...
break
case"uvec4":t.i(0,a,H.H([],[[P.b,P.m]]))
break
default:if(H.al(!1))H.aJ("unknown type for "+a)}},
...
r[q+1]=o.gdq(o)
r[q+2]=o.gdr(o)
q+=3}for(s=t.length,p=0;n=t.length,p<n;n===s||(0,H.aK)(t),++p){m=t[p]
l=m.a
r[q]=l
r[q+1]=m.b
k=m.c
...
p=$.$get$O().h(0,q).a
C.a.l(t,H.h(q)+"["+p+","+s.h(0,q).length+"]")}return C.a.a2(t," ")}}
G.e7.prototype={
aK:function(a,b,c){var t,s
if(C.h.ag(a,0)===105){if(H.al(C.b.af(b.length,c)===this.z))H.aJ("ChangeAttribute "+this.z)}else{t=C.b.af(b.length,c)
if(H.al(t===(this.ch.length/3|0)))H.aJ("wrong size for attribute: "+a+" expected: "+(this.ch.length/3|0)+" got: "+t)}this.cy.i(0,a,b)
t=this.d
s=this.r.h(0,a)
J.cS(t.a,34962,s)
...
p=this.x
if(H.al(p.C(0,a)))H.aJ("unexpected attribute "+a)
o=p.h(0,a)
J.cT(r.a,this.e)
r.bs(0,o,t?1:0)
s=s.h(0,a)
...
for(t=this.cy,r=t.gF(t),r=r.gA(r);r.q();){q=r.gt()
C.a.l(s,H.h(q)+":"+t.h(0,q).length)}return"MESH["+this.a+"] "+C.a.a2(s,"  ")},
...
break
case"mat4":if(l.c===0){j=C.l.ga6(H.ao(m,"$isl0"))
J.jy(r.a,k,!1,j)}else if(H.al(!1))H.aJ("bad unform: "+n)
break
case"mat3":if(l.c===0){j=C.l.ga6(H.ao(m,"$isl_"))
J.jx(r.a,k,!1,j)}else if(H.al(!1))H.aJ("bad unform: "+n)
break
case"vec4":if(l.c===0){j=C.l.ga6(H.ao(m,"$isbl"))
J.i5(r.a,k,j)}else J.i5(r.a,k,m)
break
case"vec3":if(l.c===0){j=C.l.ga6(H.ao(m,"$isJ"))
J.i4(r.a,k,j)}else J.i4(r.a,k,m)
break
case"vec2":j=l.c
i=r.a
if(j===0)J.i3(i,k,H.ao(m,"$isN").a)
else J.i3(i,k,m)
break
...
break
case"cBlendEquation":H.ao(m,"$isl1")
m.gcT()
J.cU(r.a,3042)
j=m.gdm()
i=m.gds()
...
break}}s=Date.now()
""+o
new P.au(1000*(s-new P.b_(t,!1).a)).k(0)},
...
q.H(0)
for(p=a.cy,p=p.gF(p),p=p.gA(p);p.q();)q.l(0,p.gt())
o=this.cj()
if(o.length!==0)P.ap("E:"+(this.a+" "+a.f+": uninitialized inputs: "+H.h(o)))
J.cT(a.d.a,a.e)
n=this.e.f.length>0
q=a.f
p=a.cd()
...
if(n)J.j6(t.a,q)
if(m!==-1){k=t.a
if(l>1)J.ji(k,q,p,m,0,l)
else J.jh(k,q,p,m,0)}else{m=t.a
if(l>1)J.jg(m,q,0,p,l)
else J.jf(m,q,0,p)}if(n)J.jl(t.a)},
...
r.i(0,n,J.i2(q.a,p,n))}for(t=this.f.d,s=t.length,o=0;o<t.length;t.length===s||(0,H.aK)(t),++o){n=t[o]
r.i(0,n,J.i2(q.a,p,n))}}}
G.r.prototype={
...
if(H.al($.$get$O().C(0,r)))H.aJ("missing uniform "+r)
H.d(!C.a.Y(t,r))
C.a.l(t,r)}C.a.aH(t)},
...
this.c.ca(this.e,[t])
C.af.gcD(window).bA(this)},
$S:function(){return{func:1,v:true,args:[P.K]}}}
J.a.prototype.c2=J.a.prototype.k
J.ba.prototype.c3=J.ba.prototype.k;(function installTearOffs(){installTearOff(H.aG.prototype,"gd5",0,0,0,null,["$0"],["ab"],0)
installTearOff(H.a2.prototype,"gbR",0,0,0,null,["$1"],["D"],2)
installTearOff(H.aE.prototype,"gcM",0,0,0,null,["$1"],["I"],2)
...
installTearOff(L,"iY",1,0,0,null,["$0"],["kM"],0)})();(function inheritance(){inherit(P.n,null)
var t=P.n
inherit(H.hF,t)
inherit(J.a,t)
inherit(J.d_,t)
...
mixin(P.cb,W.w)
mixin(P.c0,P.p)
mixin(P.cc,W.w)})();(function constants(){C.x=W.bz.prototype
C.y=W.bH.prototype
C.z=J.a.prototype
C.a=J.av.prototype
C.b=J.cn.prototype
...
C.I=new G.r("vec3","vertex btangents",0)
C.c=new G.r("vec3","",0)
C.J=new G.r("vec4","delta from light",0)
C.m=new G.r("","",0)
C.t=new G.r("vec3","vertex coordinates",0)
C.K=new G.r("vec3","vertex binormals",0)
C.u=new G.r("vec4","for wireframe",0)
C.L=new G.r("vec4","per vertex color",0)
C.M=new G.r("float","for normal maps",0)
C.i=new G.r("mat4","",0)
C.O=new G.r("mat4","",4)
C.N=new G.r("mat4","",128)
C.d=new G.r("float","",0)
C.P=new G.r("float","",4)
C.Q=new G.r("float","depth for shadowmaps",0)
C.f=new G.r("sampler2D","",0)
C.R=new G.r("float","for bump maps",0)
C.S=new G.r("vec2","texture uvs",0)
C.T=new G.r("float","time since program start in sec",0)
C.j=new G.r("vec2","",0)
C.U=new G.r("samplerCube","",0)
C.k=new G.r("vec4","",0)
C.V=new G.r("vec3","vertex normals",0)
C.W=new G.r("sampler2DShadow","",0)
C.v=new G.r("vec3","per vertex color",0)
C.w=new G.r("mat3","",0)
C.X=new G.r("vec3","vertex tangents",0)
C.Y=H.E("kT")
C.Z=H.E("kU")
C.a_=H.E("kV")
C.a0=H.E("kW")
...
C.ac=H.E("G")
C.ad=H.E("m")
C.ae=H.E("K")})();(function staticFields(){$.ip="$cachedFunction"
$.iq="$cachedInvocation"
$.ic=null
$.ia=null
$.hN=!1
...
$.ih=t+1
t="expando$key$"+t}return new P.di(null,t,[P.m])})
...
return b},
mangledGlobalNames:{m:"int",G:"double",K:"num",u:"String",bv:"bool",aA:"Null",b:"List"},
mangledNames:{},
getTypeFromName:getGlobalFromName,
metadata:[],
types:[{func:1,v:true},{func:1,v:true,args:[{func:1,v:true}]},{func:1,args:[,]},{func:1,ret:P.m,args:[P.B,P.B]}],
