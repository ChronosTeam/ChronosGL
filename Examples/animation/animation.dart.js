...
(function dartProgram() {
  ...
  J = {
    ...
    texImage2D$9$x: function(receiver, a0, a1, a2, a3, a4, a5, a6, a7, a8) {
  ...
  P = {
    ...
    Future_wait: function(futures, $T) {
      var cleanUp, eagerError, result, handleError, future, pos, e, st, _box_0, t1, t2, t3, t4, _i, t5, exception;
      _box_0 = {};
      cleanUp = null;
      eagerError = false;
  ...
  L = {
    AnimatedSkeleton$: function($length) {
      var t1, t2, t3;
      t1 = new Array($length);
      ...
      t2 = new L.AnimatedSkeleton(t1, H.setRuntimeTypeInfo(t3, t2));
      t2.AnimatedSkeleton$1($length);
      return t2;
    },
    UpdateAnimatedSkeleton: function(skeleton, globalOffsetTransform, animation, posedSkeleton, time) {
      var t1, tmp, t2, t3, t4, t5, i, bone, t, t6, a, scaleIndex, positionIndex, rotationIndex, s, t7, arg1Storage, x, y, z, w, x2, y2, z2, xx, xy, xz, yy, yz, zz, wx, wy, wz, arg0Storage, sx, sy, sz;
      H.assertSubtype(skeleton, "$isList", [L.Bone], "$asList");
      t1 = new Float32Array(16);
      tmp = new T.Matrix4(t1);
      for (t2 = animation.animList, t3 = t2.length, t4 = posedSkeleton.globalTransforms, t5 = t4.length, i = 0; i < skeleton.length; ++i) {
        bone = skeleton[i];
        if (i >= t5)
          return H.ioore(t4, i);
        t = t4[i];
        ...
        a = t2[i];
        if (a != null) {
          scaleIndex = L.BoneAnimation__findTime(a._scaleTimes, time);
          positionIndex = L.BoneAnimation__findTime(a._positionTimes, time);
          rotationIndex = L.BoneAnimation__findTime(a._rotationTimes, time);
          t6 = a._scaleValues;
          if (scaleIndex >= t6.length)
            return H.ioore(t6, scaleIndex);
          s = t6[scaleIndex];
          t6 = a._positionValues;
          if (positionIndex >= t6.length)
            return H.ioore(t6, positionIndex);
          t6 = t6[positionIndex];
          t7 = a._rotationValues;
          if (rotationIndex >= t7.length)
            return H.ioore(t7, rotationIndex);
          arg1Storage = t7[rotationIndex]._qStorage;
          x = arg1Storage[0];
          y = arg1Storage[1];
          z = arg1Storage[2];
          w = arg1Storage[3];
          ...
          t.multiply$1(0, bone.localTransform);
      }
      for (t1 = posedSkeleton.skinningTransforms, t2 = t1.length, i = 0; i < skeleton.length; ++i) {
        if (i >= t2)
          return H.ioore(t1, i);
        t = t1[i];
        t.setFrom$1(globalOffsetTransform);
        if (i >= t5)
          return H.ioore(t4, i);
        t.multiply$1(0, t4[i]);
        if (i >= skeleton.length)
          return H.ioore(skeleton, i);
        t.multiply$1(0, skeleton[i].offsetTransform);
      }
    },
    CreateAnimationTable: function(skeleton, globalOffsetTransform, animation, time) {
      var posedSkeleton, t1, t2, data, t3, t4, pos, _i, _i0, m, i, t5, t6;
      H.assertSubtype(skeleton, "$isList", [L.Bone], "$asList");
      H.assertSubtype(time, "$isList", [P.double], "$asList");
      posedSkeleton = L.AnimatedSkeleton$(skeleton.length);
      t1 = skeleton.length;
      t2 = time.length;
      data = new Float32Array(t1 * 16 * t2);
      for (t1 = time.length, t2 = posedSkeleton.skinningTransforms, t3 = t2.length, t4 = data.length, pos = 0, _i = 0; _i < time.length; time.length === t1 || (0, H.throwConcurrentModificationError)(time), ++_i) {
        L.UpdateAnimatedSkeleton(skeleton, globalOffsetTransform, animation, posedSkeleton, time[_i]);
        for (_i0 = 0; _i0 < t3; ++_i0) {
          m = t2[_i0];
          for (i = 0; i < 16; ++i) {
            t5 = pos + i;
            t6 = m._m4storage[i];
    ...
    BoneAnimation__findTime: function(timeList, t) {
      var t1, i, i0, t2;
      H.assertSubtype(timeList, "$isList", [P.double], "$asList");
      for (t1 = timeList.length - 1, i = 0; i < t1; i = i0) {
        i0 = i + 1;
        t2 = timeList[i0];
        if (typeof t !== "number")
          return t.$lt();
    ...
    Bone: function Bone(t0, t1, t2, t3, t4) {
      var _ = this;
      _.boneName = t0;
      _.localTransform = t1;
      _.offsetTransform = t2;
      _.boneIndex = t3;
      _.parentNum = t4;
    },
    AnimatedSkeleton: function AnimatedSkeleton(t0, t1) {
      this.globalTransforms = t0;
      this.skinningTransforms = t1;
    },
    BoneAnimation: function BoneAnimation(t0, t1, t2, t3, t4, t5, t6) {
      var _ = this;
      _.bone = t0;
      _._positionTimes = t1;
      _._positionValues = t2;
      _._rotationTimes = t3;
      _._rotationValues = t4;
      _._scaleTimes = t5;
      _._scaleValues = t6;
    },
    SkeletalAnimation: function SkeletalAnimation(t0, t1, t2) {
      this.name = t0;
      this.animList = t1;
      this.duration = t2;
    }
  ...
  G = {
    ...
    LineEndPointsToMeshData: function($name, prog, points) {
      var md, t1, faces, i;
      H.assertSubtype(points, "$isList", [T.Vector3], "$asList");
      md = G.MeshData$($name, prog._cgl, 1, prog._shaderObjectV._canonicalToLayoutPos);
      md.AddVertices$1(G.FlattenVector3List(points));
    ...
    TypedTextureMutable: function TypedTextureMutable(t0, t1, t2, t3, t4, t5, t6, t7) {
      var _ = this;
      _._width = t0;
      _._height = t1;
  ...
  Y = {
    _Floatify: function(lst) {
      var t1, t2, out, i;
      t1 = J.getInterceptor$asx(lst);
      t2 = new Array(t1.get$length(lst));
      t2.fixed$length = Array;
      out = H.setRuntimeTypeInfo(t2, [P.double]);
      for (i = 0; i < t1.get$length(lst); ++i) {
        t2 = t1.$index(lst, i);
        if (typeof t2 === "number" && Math.floor(t2) === t2)
          C.JSArray_methods.$indexSet(out, i, J.toDouble$0$n(t1.$index(lst, i)));
        else {
          t2 = t1.$index(lst, i);
          if (typeof t2 === "number")
            C.JSArray_methods.$indexSet(out, i, H.doubleTypeCheck(t1.$index(lst, i)));
        }
      }
      return out;
    },
    _Intify: function(lst) {
      var t1, t2, out, i;
      t1 = J.getInterceptor$asx(lst);
      t2 = new Array(t1.get$length(lst));
      t2.fixed$length = Array;
      ...
      for (i = 0; i < t1.get$length(lst); ++i)
        C.JSArray_methods.$indexSet(out, i, H.intTypeCheck(t1.$index(lst, i)));
      return out;
    },
    _ListIntify: function(lst) {
      var t1, t2, out, i;
      t1 = J.getInterceptor$asx(lst);
      t2 = new Array(t1.get$length(lst));
      t2.fixed$length = Array;
      out = H.setRuntimeTypeInfo(t2, [[P.List, P.int]]);
      for (i = 0; i < t1.get$length(lst); ++i)
        C.JSArray_methods.$indexSet(out, i, Y._Intify(H.listTypeCheck(t1.$index(lst, i))));
      return out;
    },
    ImportGeometryFromAssimp2JsonMesh: function(mesh, skeleton) {
      var t1, t2, t3, t4, gb, t5, $name, faces, t6, _i, f, t7, t8, t9, name2bone, indices, weights, i, b, bone, boneIndex, vertex, pos;
      t1 = P.String;
      t2 = [t1, null];
      H.assertSubtype(mesh, "$isMap", t2, "$asMap");
      t3 = L.Bone;
      H.assertSubtype(skeleton, "$isList", [t3], "$asList");
      t4 = H.setRuntimeTypeInfo([], [G.Face3]);
      gb = new G.GeometryBuilder(false, t4, H.setRuntimeTypeInfo([], [G.Face4]), H.setRuntimeTypeInfo([], [T.Vector3]), P.LinkedHashMap_LinkedHashMap$_empty(t1, [P.List,,]));
      t5 = J.getInterceptor$asx(mesh);
      $name = H.stringTypeCheck(t5.$index(mesh, "name"));
      gb.AddVertices$1(Y.ConvertToVector3List(H.listTypeCheck(t5.$index(mesh, "vertices"))));
      if (t5.containsKey$1(mesh, "normals")) {
        gb.EnableAttribute$1("aNormal");
        gb.AddAttributesVector3$2("aNormal", Y.ConvertToVector3List(H.listTypeCheck(t5.$index(mesh, "normals"))));
      }
      if (t5.containsKey$1(mesh, "texturecoords")) {
        gb.EnableAttribute$1("aTexUV");
        gb.AddAttributesVector2$2("aTexUV", Y.ConvertToVector2List(H.listTypeCheck(J.$index$asx(t5.$index(mesh, "texturecoords"), 0))));
      }
      if (t5.containsKey$1(mesh, "tangents")) {
        gb.EnableAttribute$1("aTangent");
        gb.AddAttributesVector3$2("aTangent", Y.ConvertToVector3List(H.listTypeCheck(t5.$index(mesh, "tangents"))));
      }
      if (t5.containsKey$1(mesh, "bitangents")) {
        gb.EnableAttribute$1("aBitangent");
        gb.AddAttributesVector3$2("aBitangent", Y.ConvertToVector3List(H.listTypeCheck(t5.$index(mesh, "bitangents"))));
      }
      faces = Y._ListIntify(H.listTypeCheck(t5.$index(mesh, "faces")));
      for (t6 = faces.length, _i = 0; _i < t6; ++_i) {
        f = faces[_i];
        t7 = f.length;
        if (0 >= t7)
          return H.ioore(f, 0);
        ...
        if (2 >= t7)
          return H.ioore(f, 2);
        t7 = f[2];
        C.JSArray_methods.add$1(t4, new G.Face3(H.intTypeCheck(t8), H.intTypeCheck(t9), H.intTypeCheck(t7)));
      }
      name2bone = P.LinkedHashMap_LinkedHashMap$_empty(t1, t3);
      C.JSArray_methods.forEach$1(skeleton, new Y.ImportGeometryFromAssimp2JsonMesh_closure(name2bone));
      t1 = J.get$length$asx(t5.$index(mesh, "normals"));
      if (typeof t1 !== "number")
        return t1.$tdiv();
      t1 = C.JSNumber_methods._tdivFast$1(t1, 3);
      t3 = new Array(t1);
      t3.fixed$length = Array;
      t4 = [T.Vector4];
      indices = H.setRuntimeTypeInfo(t3, t4);
      t3 = new Array(t1);
      t3.fixed$length = Array;
      weights = H.setRuntimeTypeInfo(t3, t4);
      for (i = 0; i < t1; ++i) {
        C.JSArray_methods.$indexSet(indices, i, new T.Vector4(new Float32Array(4)));
        C.JSArray_methods.$indexSet(weights, i, new T.Vector4(new Float32Array(4)));
      }
      for (t1 = J.get$iterator$ax(H.listSuperNativeTypeCheck(t5.$index(mesh, "bones"), "$isIterable")), t3 = [P.double]; t1.moveNext$0();) {
        b = H.assertSubtype(t1.get$current(t1), "$isMap", t2, "$asMap");
        t4 = J.getInterceptor$asx(b);
        bone = name2bone.$index(0, t4.$index(b, "name"));
        t6 = bone.offsetTransform;
        t7 = H.assertSubtype(Y._Floatify(H.listTypeCheck(t4.$index(b, "offsetmatrix"))), "$isList", t3, "$asList");
        t8 = t6._m4storage;
        if (15 >= t7.length)
          return H.ioore(t7, 15);
        C.NativeFloat32List_methods.$indexSet(t8, 15, t7[15]);
        C.NativeFloat32List_methods.$indexSet(t8, 14, t7[14]);
        C.NativeFloat32List_methods.$indexSet(t8, 13, t7[13]);
        C.NativeFloat32List_methods.$indexSet(t8, 12, t7[12]);
        C.NativeFloat32List_methods.$indexSet(t8, 11, t7[11]);
        C.NativeFloat32List_methods.$indexSet(t8, 10, t7[10]);
        C.NativeFloat32List_methods.$indexSet(t8, 9, t7[9]);
        C.NativeFloat32List_methods.$indexSet(t8, 8, t7[8]);
        C.NativeFloat32List_methods.$indexSet(t8, 7, t7[7]);
        C.NativeFloat32List_methods.$indexSet(t8, 6, t7[6]);
        C.NativeFloat32List_methods.$indexSet(t8, 5, t7[5]);
        C.NativeFloat32List_methods.$indexSet(t8, 4, t7[4]);
        C.NativeFloat32List_methods.$indexSet(t8, 3, t7[3]);
        C.NativeFloat32List_methods.$indexSet(t8, 2, t7[2]);
        C.NativeFloat32List_methods.$indexSet(t8, 1, t7[1]);
        C.NativeFloat32List_methods.$indexSet(t8, 0, t7[0]);
        t6.transpose$0();
        if (t4.containsKey$1(b, "weights")) {
          boneIndex = bone.boneIndex;
          for (t4 = J.get$iterator$ax(H.listSuperNativeTypeCheck(t4.$index(b, "weights"), "$isIterable")); t4.moveNext$0();) {
            t6 = H.listTypeCheck(t4.get$current(t4));
            t7 = J.getInterceptor$asx(t6);
            vertex = H.intTypeCheck(t7.$index(t6, 0));
            for (pos = 0; pos < 4; ++pos)
              if (C.JSArray_methods.$index(weights, vertex)._v4storage[pos] === 0)
                break;
            t8 = C.JSArray_methods.$index(weights, vertex);
            t6 = J.toDouble$0$n(t7.$index(t6, 1));
            t8 = t8._v4storage;
            if (pos >= 4)
              return H.ioore(t8, pos);
            t8[pos] = t6;
            C.JSArray_methods.$index(indices, vertex)._v4storage[pos] = boneIndex;
          }
        }
      }
      gb.EnableAttribute$1("aBoneIndex");
      gb.EnableAttribute$1("aBoneWeight");
      gb.AddAttributesVector4$2("aBoneIndex", indices);
      gb.AddAttributesVector4$2("aBoneWeight", weights);
      P.print("mesh " + H.S($name) + " " + gb.toString$0(0) + " " + H.S(t5.get$keys(mesh)));
      return gb;
    },
    ImportSkeletonFromAssimp2Json: function(json) {
      var _box_0, t1, out, dfs, t2;
      _box_0 = {};
      t1 = [P.String, null];
      H.assertSubtype(json, "$isMap", t1, "$asMap");
      out = H.setRuntimeTypeInfo([], [L.Bone]);
      _box_0.count = 0;
      dfs = new Y.ImportSkeletonFromAssimp2Json_dfs(_box_0, out);
      for (t2 = J.get$iterator$ax(H.listSuperNativeTypeCheck(J.$index$asx(H.assertSubtype(J.$index$asx(json, "rootnode"), "$isMap", t1, "$asMap"), "children"), "$isIterable")); t2.moveNext$0();)
        dfs.call$2(H.assertSubtype(t2.get$current(t2), "$isMap", t1, "$asMap"), -1);
      return out;
    },
    ImportAnimationFromAssimp2Json: function(json, skeleton) {
      var t1, t2, t3, name2bone, $name, tickspersecond, duration, channels, t4, t5, t6, c, t7, bone, positionTimes, positionValues, t8, t9, t10, t11, t12, rotationTimes, rotationValues, q, t13, scaleTimes, scaleValues;
      t1 = P.String;
      t2 = [t1, null];
      H.assertSubtype(json, "$isMap", t2, "$asMap");
      t3 = L.Bone;
      H.assertSubtype(skeleton, "$isList", [t3], "$asList");
      name2bone = P.LinkedHashMap_LinkedHashMap$_empty(t1, t3);
      C.JSArray_methods.forEach$1(skeleton, new Y.ImportAnimationFromAssimp2Json_closure(name2bone));
      t3 = J.getInterceptor$asx(json);
      $name = H.stringTypeCheck(t3.$index(json, "name"));
      tickspersecond = J.toDouble$0$n(t3.$index(json, "tickspersecond"));
      duration = H.doubleTypeCheck(t3.$index(json, "duration"));
      channels = H.listTypeCheck(t3.$index(json, "channels"));
      t3 = new Array(skeleton.length);
      t3.fixed$length = Array;
      t3 = H.setRuntimeTypeInfo(t3, [L.BoneAnimation]);
      t1 = J.getInterceptor$asx(channels);
      P.print("animated bones: " + t1.get$length(channels));
      for (t1 = t1.get$iterator(channels), t4 = [P.double], t5 = [T.Vector3], t6 = [T.Quaternion]; t1.moveNext$0();) {
        c = H.assertSubtype(t1.get$current(t1), "$isMap", t2, "$asMap");
        t7 = J.getInterceptor$asx(c);
        bone = name2bone.$index(0, t7.$index(c, "name"));
        positionTimes = H.setRuntimeTypeInfo([], t4);
        positionValues = H.setRuntimeTypeInfo([], t5);
        for (t8 = J.get$iterator$ax(H.listSuperNativeTypeCheck(t7.$index(c, "positionkeys"), "$isIterable")); t8.moveNext$0();) {
          t9 = H.listTypeCheck(t8.get$current(t8));
          t10 = J.getInterceptor$asx(t9);
          C.JSArray_methods.add$1(positionTimes, H.doubleTypeCheck(J.$div$n(t10.$index(t9, 0), tickspersecond)));
          t9 = H.listTypeCheck(t10.$index(t9, 1));
          t10 = J.getInterceptor$asx(t9);
          t11 = J.toDouble$0$n(t10.$index(t9, 0));
          t12 = J.toDouble$0$n(t10.$index(t9, 1));
          t9 = J.toDouble$0$n(t10.$index(t9, 2));
          t10 = new Float32Array(3);
          t10[0] = t11;
          t10[1] = t12;
          t10[2] = t9;
          C.JSArray_methods.add$1(positionValues, new T.Vector3(t10));
        }
        rotationTimes = H.setRuntimeTypeInfo([], t4);
        rotationValues = H.setRuntimeTypeInfo([], t6);
        for (t8 = J.get$iterator$ax(H.listSuperNativeTypeCheck(t7.$index(c, "rotationkeys"), "$isIterable")); t8.moveNext$0();) {
          t9 = H.listTypeCheck(t8.get$current(t8));
          t10 = J.getInterceptor$asx(t9);
          C.JSArray_methods.add$1(rotationTimes, H.doubleTypeCheck(J.$div$n(t10.$index(t9, 0), tickspersecond)));
          q = Y._Floatify(H.listTypeCheck(t10.$index(t9, 1)));
          t9 = q.length;
          if (1 >= t9)
            return H.ioore(q, 1);
          t10 = q[1];
          ...
          C.NativeFloat32List_methods.$indexSet(t13, 0, t10);
          C.NativeFloat32List_methods.$indexSet(t13, 1, t11);
          C.NativeFloat32List_methods.$indexSet(t13, 2, t9);
          C.NativeFloat32List_methods.$indexSet(t13, 3, t12);
          C.JSArray_methods.add$1(rotationValues, new T.Quaternion(t13));
        }
        scaleTimes = H.setRuntimeTypeInfo([], t4);
        scaleValues = H.setRuntimeTypeInfo([], t5);
        for (t7 = J.get$iterator$ax(H.listSuperNativeTypeCheck(t7.$index(c, "scalingkeys"), "$isIterable")); t7.moveNext$0();) {
          t8 = H.listTypeCheck(t7.get$current(t7));
          t9 = J.getInterceptor$asx(t8);
          C.JSArray_methods.add$1(scaleTimes, H.doubleTypeCheck(J.$div$n(t9.$index(t8, 0), tickspersecond)));
          t8 = H.listTypeCheck(t9.$index(t8, 1));
          t9 = J.getInterceptor$asx(t8);
          t10 = J.toDouble$0$n(t9.$index(t8, 0));
          t11 = J.toDouble$0$n(t9.$index(t8, 1));
          t8 = J.toDouble$0$n(t9.$index(t8, 2));
          t9 = new Float32Array(3);
          t9[0] = t10;
          t9[1] = t11;
          t9[2] = t8;
          C.JSArray_methods.add$1(scaleValues, new T.Vector3(t9));
        }
        t7 = new L.BoneAnimation(bone, positionTimes, positionValues, rotationTimes, rotationValues, scaleTimes, scaleValues);
        t8 = positionTimes.length;
        if (t8 === 0) {
          t7.set$_positionTimes(H.setRuntimeTypeInfo([0], t4));
          t8 = new Float32Array(3);
          t8[0] = 0;
          t8[1] = 0;
          t8[2] = 0;
          t7.set$_positionValues(H.setRuntimeTypeInfo([new T.Vector3(t8)], t5));
        }
        t8 = t7._rotationTimes;
        if (t8 == null || t8.length === 0) {
          t7.set$_rotationTimes(H.setRuntimeTypeInfo([0], t4));
          t8 = new Float32Array(4);
          t8[0] = 0;
          t8[1] = 0;
          t8[2] = 0;
          t8[3] = 1;
          t7.set$_rotationValues(H.setRuntimeTypeInfo([new T.Quaternion(t8)], t6));
        }
        t8 = t7._scaleTimes;
        if (t8 == null || t8.length === 0) {
          t7.set$_scaleTimes(H.setRuntimeTypeInfo([0], t4));
          t8 = new Float32Array(3);
          t8[0] = 1;
          t8[1] = 1;
          t8[2] = 1;
          t7.set$_scaleValues(H.setRuntimeTypeInfo([new T.Vector3(t8)], t5));
        }
        C.JSArray_methods.$indexSet(t3, bone.boneIndex, t7);
      }
      return new L.SkeletalAnimation($name, t3, duration);
    },
    ConvertToVector3List: function(lst) {
      var t1, t2, out, i, t3, t4, t5, t6;
      t1 = J.getInterceptor$asx(lst);
      t2 = new Array(C.JSInt_methods._tdivFast$1(t1.get$length(lst), 3));
      t2.fixed$length = Array;
      out = H.setRuntimeTypeInfo(t2, [T.Vector3]);
      for (i = 0; i < t1.get$length(lst); i += 3) {
        t2 = C.JSInt_methods._tdivFast$1(i, 3);
        t3 = J.toDouble$0$n(t1.$index(lst, i));
        t4 = J.toDouble$0$n(t1.$index(lst, i + 1));
        t5 = J.toDouble$0$n(t1.$index(lst, i + 2));
        t6 = new Float32Array(3);
        t6[0] = t3;
        t6[1] = t4;
        t6[2] = t5;
        C.JSArray_methods.$indexSet(out, t2, new T.Vector3(t6));
      }
      return out;
    },
    ConvertToVector2List: function(lst) {
      var t1, t2, out, i, t3, t4, t5;
      t1 = J.getInterceptor$asx(lst);
      t2 = new Array(C.JSInt_methods._tdivFast$1(t1.get$length(lst), 2));
      t2.fixed$length = Array;
      out = H.setRuntimeTypeInfo(t2, [T.Vector2]);
      for (i = 0; i < t1.get$length(lst); i += 2) {
        ...
        t5[0] = t3;
        t5[1] = t4;
        C.JSArray_methods.$indexSet(out, t2, new T.Vector2(t5));
      }
      return out;
    },
    ImportGeometryFromAssimp2JsonMesh_closure: function ImportGeometryFromAssimp2JsonMesh_closure(t0) {
      this.name2bone = t0;
    },
    ImportSkeletonFromAssimp2Json_dfs: function ImportSkeletonFromAssimp2Json_dfs(t0, t1) {
      this._box_0 = t0;
      this.out = t1;
    },
    ImportAnimationFromAssimp2Json_closure: function ImportAnimationFromAssimp2Json_closure(t0) {
      this.name2bone = t0;
    }
  },
  R = {
    BonePosFromAnimatedSkeleton: function(bones, posed) {
      var out, t1, t2, i, $parent, t3, z, y, x, t4;
      H.assertSubtype(bones, "$isList", [L.Bone], "$asList");
      out = H.setRuntimeTypeInfo([], [T.Vector3]);
      for (t1 = posed.globalTransforms, t2 = t1.length, i = 0; i < bones.length; ++i) {
        $parent = bones[i].parentNum;
        if ($parent === -1)
          continue;
        if (i >= t2)
          return H.ioore(t1, i);
        ...
        t4.setFrom$1(new T.Vector3(t3));
        t4.scale$1(0, 1);
        C.JSArray_methods.add$1(out, t4);
        if ($parent < 0 || $parent >= t2)
          return H.ioore(t1, $parent);
        t4 = t1[$parent]._m4storage;
        z = t4[14];
        y = t4[13];
        x = t4[12];
        t3 = new Float32Array(3);
    ...
    BoneVisualizer: function BoneVisualizer(t0, t1, t2) {
      var _ = this;
      _._globalOffsetTransform = t0;
      _._mdWire = null;
      _._skeleton = t1;
      _._anim = t2;
      _.mesh = _._animatedSkeleton = null;
    },
  ...
  A = {
    Node$Container: function($name, child) {
      var t1, t2, t3, t4, t5, t6;
      t1 = H.setRuntimeTypeInfo([], [A.Node]);
      ...
      return new A.Node(null, null, t1, new T.Matrix3(t2), t3, t4, new T.Vector3(t5), new T.Vector3(t6), $name);
    },
    drawRecursively: function(prog, node, $parent, stats, uniforms) {
      ...
      t1.multiply$1(0, t2);
      t3 = node._material;
      if (t3 != null && node._meshData != null) {
        H.S(node);
      ...
      for (t2 = node.children, t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, H.throwConcurrentModificationError)(t2), ++_i)
  ...
  D = {
    LoadJson: function(url) {
      ...
      t3 = W.ProgressEvent;
      W._EventStreamSubscription$(hr, "loadend", H.functionTypeCheck(new D.LoadJson_closure(new P._AsyncCompleter(t2, [t1]), hr), {func: 1, ret: -1, args: [t3]}), false, t3);
      hr.send("");
      return t2;
    },
    ...
    LoadJson_closure: function LoadJson_closure(t0, t1) {
      this.c = t0;
      this.hr = t1;
    },
  ...
  X = {
    main: function() {
      var _box_0, t1, t2, text, t3, fps, canvas, cgl, t4, t5, t6, t7, t8, t9, orbit, perspective, sceneAnim, sceneSkeleton, sceneDemo, phase, matWire, mat, programMap, _i, e;
      _box_0 = {};
      t1 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(5000, 0, 0, 0, new T.Vector3(t4), -0.02, t5, t6, t7, new T.Vector3(t8), new T.Vector3(t9), "camera:orbit");
      t4 = new T.Matrix4(new Float32Array(16));
      t4.setIdentity$0();
      t5 = new T.Matrix4(new Float32Array(16));
      t5.setIdentity$0();
      perspective = new G.Perspective(orbit, 50, 1, 1, 10000, t4, t5, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), "perspective");
      perspective.Update$0();
      t4 = G.RenderProgram$("animation", cgl, $.$get$animationVertexShader(), $.$get$animationFragmentShader());
      t5 = [G.UniformGroup];
      t6 = H.setRuntimeTypeInfo([perspective], t5);
      t7 = [A.Node];
      t8 = H.setRuntimeTypeInfo([], t7);
      sceneAnim = new A.Scene(t4, t6, t8, "animation");
      t6 = G.RenderProgram$("solid", cgl, $.$get$solidColorVertexShader(), $.$get$solidColorFragmentShader());
      t8 = H.setRuntimeTypeInfo([perspective], t5);
      t9 = H.setRuntimeTypeInfo([], t7);
      sceneSkeleton = new A.Scene(t6, t8, t9, "solid");
      t8 = G.RenderProgram$("demo", cgl, $.$get$demoVertexShader(), $.$get$demoFragmentShader());
      t5 = H.setRuntimeTypeInfo([perspective], t5);
      t7 = H.setRuntimeTypeInfo([], t7);
      sceneDemo = new A.Scene(t8, t5, t7, "demo");
      ...
      t7 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(phase.get$resolutionChange(), {func: 1, ret: -1, args: [t7]}), false, t7);
      C.JSArray_methods.add$1(t5, sceneSkeleton);
      C.JSArray_methods.add$1(t5, sceneAnim);
      C.JSArray_methods.add$1(t5, sceneDemo);
      matWire = G.Material$("wire");
      matWire._uniforms.$indexSet(0, "uColor", $.$get$ColorYellow());
      mat = G.Material$("mat");
      _box_0.animationTable = null;
      _box_0.animationSteps = null;
      _box_0.boneVisualizer = null;
      programMap = P.LinkedHashMap_LinkedHashMap$_literal(["idSkeleton", t6, "idStatic", t8, "idAnimation", t4], t2, G.RenderProgram);
      for (t2 = t1.getElementsByTagName("input"), t4 = t2.length, _i = 0; _i < t2.length; t2.length === t4 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
        t5 = J.get$onChange$x(H.interceptedTypeCheck(t2[_i], "$isElement"));
        t6 = H.getTypeArgumentByIndex(t5, 0);
        W._EventStreamSubscription$(t5._target, t5._eventType, H.functionTypeCheck(new X.main_closure(programMap), {func: 1, ret: -1, args: [t6]}), false, t6);
      }
      for (t2 = t1.getElementsByTagName("input"), t4 = t2.length, _i = 0; _i < t2.length; t2.length === t4 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
        t5 = H.interceptedTypeCheck(t2[_i], "$isElement");
        H.printString("initialize inputs " + H.S(t5.id));
        e = t1.createEvent("Event");
        e.initEvent("change", true, true);
        t5.dispatchEvent(e);
      }
      _box_0._lastTimeMs = 0;
      mat._uniforms.$indexSet(0, "uTime", 0);
      P.Future_wait(H.setRuntimeTypeInfo([D.LoadJson("../asset/monster/monster.json"), D.LoadImage("../asset/monster/monster.jpg")], [[P.Future, P.Object]]), t3).then$1$1(new X.main_closure0(_box_0, cgl, mat, sceneAnim, sceneDemo, sceneSkeleton, matWire, new X.main_animate(_box_0, orbit, phase, fps, mat)), null);
    },
  ...
  var holders = [C, H, J, P, W, L, G, Y, R, A, D, T, X];
  ...
  W._ChildNodeListLazy.prototype = {
    ...
    $indexSet: function(_, index, value) {
      ...
      H.intTypeCheck(index);
      t1 = this._this;
      t1.replaceChild(H.interceptedTypeCheck(value, "$isNode0"), C.NodeList_methods.$index(t1.childNodes, index));
    },
    get$iterator: function(_) {
  ...
  W.VideoElement.prototype = {$isVideoElement: 1};
  ...
  P.RenderingContext.prototype = {
    ...
    texImage2D$9: function(receiver, target, level, internalformat, format_OR_width, height_OR_type, bitmap_OR_border_OR_canvas_OR_image_OR_pixels_OR_video, format, type, pixels) {
      ...
      if (!!t2.$isImageData && format == null && t1 && pixels == null) {
      ...
      if (!!t2.$isImageElement && format == null && t1 && pixels == null) {
      ...
      if (!!t2.$isCanvasElement && format == null && t1 && pixels == null) {
      ...
      if (!!t2.$isVideoElement && format == null && t1 && pixels == null) {
        this._texImage2D_5$6(receiver, target, level, internalformat, format_OR_width, height_OR_type, bitmap_OR_border_OR_canvas_OR_image_OR_pixels_OR_video);
        return;
      }
      if (!!t2.$isImageBitmap && format == null && t1 && pixels == null) {
        this._texImage2D_6$6(receiver, target, level, internalformat, format_OR_width, height_OR_type, bitmap_OR_border_OR_canvas_OR_image_OR_pixels_OR_video);
        return;
      }
    ...
    _texImage2D_6$6: function(receiver, target, level, internalformat, format, type, bitmap) {
      return receiver.texImage2D(target, level, internalformat, format, type, bitmap);
    },
  ...
  L.Bone.prototype = {
    toString$0: function(_) {
      return "BONE[" + this.boneIndex + "] (" + this.parentNum + ") " + H.S(this.boneName) + "\ntrans:\n" + this.localTransform.toString$0(0) + "offset:\n" + this.offsetTransform.toString$0(0);
    }
  };
  L.AnimatedSkeleton.prototype = {
    AnimatedSkeleton$1: function($length) {
      var t1, t2, i;
      for (t1 = this.skinningTransforms, t2 = this.globalTransforms, i = 0; i < $length; ++i) {
        C.JSArray_methods.$indexSet(t2, i, new T.Matrix4(new Float32Array(16)));
        C.JSArray_methods.$indexSet(t1, i, new T.Matrix4(new Float32Array(16)));
      }
    }
  };
  L.BoneAnimation.prototype = {
    toString$0: function(_) {
      var s = H.setRuntimeTypeInfo([], [P.String]);
      C.JSArray_methods.add$1(s, H.S(this.bone.boneName));
      C.JSArray_methods.add$1(s, "" + this._positionTimes.length + ": " + H.S(this._positionValues));
      C.JSArray_methods.add$1(s, "" + this._rotationTimes.length + ": " + H.S(this._rotationValues));
      C.JSArray_methods.add$1(s, "" + this._scaleTimes.length + ": " + H.S(this._scaleValues));
      return C.JSArray_methods.join$1(s, "\n");
    },
    set$_positionTimes: function(_positionTimes) {
      this._positionTimes = H.assertSubtype(_positionTimes, "$isList", [P.double], "$asList");
    },
    set$_positionValues: function(_positionValues) {
      this._positionValues = H.assertSubtype(_positionValues, "$isList", [T.Vector3], "$asList");
    },
    set$_rotationTimes: function(_rotationTimes) {
      this._rotationTimes = H.assertSubtype(_rotationTimes, "$isList", [P.double], "$asList");
    },
    set$_rotationValues: function(_rotationValues) {
      this._rotationValues = H.assertSubtype(_rotationValues, "$isList", [T.Quaternion], "$asList");
    },
    set$_scaleTimes: function(_scaleTimes) {
      this._scaleTimes = H.assertSubtype(_scaleTimes, "$isList", [P.double], "$asList");
    },
    set$_scaleValues: function(_scaleValues) {
      this._scaleValues = H.assertSubtype(_scaleValues, "$isList", [T.Vector3], "$asList");
    }
  };
  L.SkeletalAnimation.prototype = {
    toString$0: function(_) {
      return "SkeletalAnimation[" + H.S(this.name) + ", duration: " + H.S(this.duration) + ", frames: " + this.animList.length + "]";
    }
  };
  ...
  G.GeometryBuilder.prototype = {
    ...
    AddVertices$1: function(vs) {
      ...
      for (t1 = vs.length, t2 = this.vertices, _i = 0; _i < t1; ++_i) {
        v = vs[_i];
        v.toString;
    ...
    AddAttributesVector2$2: function(canonical, lst) {
      ...
      for (t1 = lst.length, t2 = ts && C.JSArray_methods, _i = 0; _i < t1; ++_i) {
        v = lst[_i];
        v.toString;
    ...
    AddAttributesVector4$2: function(canonical, lst) {
      var t1, ts, t2, _i, v, t3;
      t1 = [T.Vector4];
      H.assertSubtype(lst, "$isList", t1, "$asList");
      ts = H.assertSubtype(this.attributes.$index(0, canonical), "$isList", t1, "$asList");
    ...
    GenerateFaceIndices$0: function() {
      var t1, t2, faces, i, _i, f3, f4;
      t1 = this._faces3;
      t2 = new Array(t1.length * 3);
      t2.fixed$length = Array;
      faces = H.setRuntimeTypeInfo(t2, [P.int]);
      for (t2 = t1.length, i = 0, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
        f3 = t1[_i];
      ...
      for (t1 = this._faces4, _i = 0; false; ++_i) {
        if (_i >= 0)
          return H.ioore(t1, _i);
        f4 = t1[_i];
        C.JSArray_methods.$indexSet(faces, i, f4.get$a(f4));
        C.JSArray_methods.$indexSet(faces, i + 1, f4.get$b(f4));
        C.JSArray_methods.$indexSet(faces, i + 2, f4.get$c(f4));
        C.JSArray_methods.$indexSet(faces, i + 3, f4.get$a(f4));
        C.JSArray_methods.$indexSet(faces, i + 4, f4.get$c(f4));
        C.JSArray_methods.$indexSet(faces, i + 5, f4.get$d(f4));
        i += 6;
      }
      return faces;
    },
    toString$0: function(_) {
      var s, t1, t2, t3, type;
      s = H.setRuntimeTypeInfo(["GB:", "V[" + this.vertices.length + "]", "f3[" + this._faces3.length + "]", "f4[0]"], [P.String]);
  ...
  G.MeshData.prototype = {
    ...
    AddFaces$1: function(faces) {
      ...
      t1 = this._cgl;
      this._indexBuffer = J.createBuffer$0$x(t1._gl);
      t2 = this._vertices.length;
      if (t2 < 768) {
  ...
  G.RenderProgram.prototype = {
    ...
    Draw$3: function(md, uniforms, stats) {
      ...
      this._uniformsInitialized.clear$0(0);
      ...
      t2 = md._cgl;
      t3 = md._vao;
      J.bindVertexArray$1$x(t2._gl, t3);
      ...
      t5 = md._instances;
      if (hasTransforms)
        J.beginTransformFeedback$1$x(t1._gl, t3);
      if (t4 !== -1) {
        t6 = t1._gl;
        if (t5 > 1)
          J.drawElementsInstanced$5$x(t6, t3, t2, t4, 0, t5);
        else
          J.drawElements$4$x(t6, t3, t2, t4, 0);
      } else {
        t4 = t1._gl;
        if (t5 > 1)
          J.drawArraysInstanced$4$x(t4, t3, 0, t2, t5);
        else
          J.drawArrays$3$x(t4, t3, 0, t2);
      }
      if (hasTransforms)
  ...
  G.ShaderObject.prototype = {
    ...
    SetBodyWithMain$2$prolog: function(body, prolog) {
      var t1 = [P.String];
      this.shader = this._CreateShader$3(true, H.assertSubtype(body, "$isList", t1, "$asList"), H.assertSubtype(prolog, "$isList", t1, "$asList"));
    },
    SetBodyWithMain$1: function(body) {
      return this.SetBodyWithMain$2$prolog(body, null);
    },
  ...
  G.Spatial.prototype = {
    ...
    lookAt$1: function(target) {
      var up, t1, t2, z, argStorage, x, y, t3, t4, t5, t6;
      ...
      z = new T.Vector3(t2);
      z.setFrom$1(t1);
      argStorage = target._v3storage;
      t2[0] = t2[0] - argStorage[0];
      t2[1] = t2[1] - argStorage[1];
      t2[2] = t2[2] - argStorage[2];
      z.normalize$0(0);
      x = up.cross$1(z);
      x.normalize$0(0);
      y = z.cross$1(x);
      ...
      t5 = x._v3storage;
      t6 = y._v3storage;
      this.transform.setValues$16(t5[0], t6[0], t2[0], 0, t5[1], t6[1], t2[1], 0, t5[2], t6[2], t2[2], 0, -t3, -t4, -t1, 1);
    }
  };
  G.TextureProperties.prototype = {
    InstallLate$2: function(cgl, type) {
      var t1 = this.anisotropicFilterLevel;
      if (t1 !== 1)
        J.texParameterf$3$x(cgl._gl, type, 34046, t1);
      t1 = this.magFilter;
      J.texParameteri$3$x(cgl._gl, type, 10240, t1);
      t1 = this.minFilter;
      J.texParameteri$3$x(cgl._gl, type, 10241, t1);
      if (this.clamp) {
        J.texParameteri$3$x(cgl._gl, type, 10242, 33071);
        J.texParameteri$3$x(cgl._gl, type, 10243, 33071);
      }
    }
  };
  G.Texture.prototype = {
  ...
  G.TypedTextureMutable.prototype = {
    toString$0: function(_) {
      return "TypedTextureMutable[" + this._url + ", " + this._internalFormat + ", " + this._width + " X " + this._height + "]";
    }
  };
  G.ImageTexture.prototype = {};
  Y.ImportGeometryFromAssimp2JsonMesh_closure.prototype = {
    call$1: function(b) {
      H.interceptedTypeCheck(b, "$isBone");
      this.name2bone.$indexSet(0, b.boneName, b);
      return b;
    },
    $signature: 12
  };
  Y.ImportSkeletonFromAssimp2Json_dfs.prototype = {
    call$2: function(node, $parent) {
      var t1, t2, $name, t3, transform, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, offset;
      t1 = [P.String, null];
      H.assertSubtype(node, "$isMap", t1, "$asMap");
      t2 = J.getInterceptor$asx(node);
      $name = H.stringTypeCheck(t2.$index(node, "name"));
      t3 = Y._Floatify(H.listTypeCheck(t2.$index(node, "transformation")));
      transform = new T.Matrix4(new Float32Array(16));
      t4 = t3.length;
      if (0 >= t4)
        return H.ioore(t3, 0);
      t5 = t3[0];
      ...
      transform.setValues$16(t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t3[15]);
      transform.transpose$0();
      offset = new T.Matrix4(new Float32Array(16));
      offset.setIdentity$0();
      t3 = this._box_0;
      t4 = t3.count;
      t3.count = t4 + 1;
      C.JSArray_methods.add$1(this.out, new L.Bone($name, transform, offset, t4, $parent));
      if (t2.containsKey$1(node, "children"))
        for (t2 = J.get$iterator$ax(H.listSuperNativeTypeCheck(t2.$index(node, "children"), "$isIterable")); t2.moveNext$0();)
          this.call$2(H.assertSubtype(t2.get$current(t2), "$isMap", t1, "$asMap"), t4);
    },
    $signature: 37
  };
  Y.ImportAnimationFromAssimp2Json_closure.prototype = {
    call$1: function(b) {
      H.interceptedTypeCheck(b, "$isBone");
      this.name2bone.$indexSet(0, b.boneName, b);
      return b;
  ...
  D.LoadJson_closure.prototype = {
    call$1: function(e) {
      H.interceptedTypeCheck(e, "$isProgressEvent");
      this.c.complete$1(0, H.futureOrCheck(C.JsonCodec_null.decode$1(0, H.stringTypeCheck(W._convertNativeToDart_XHR_Response(this.hr.response))), {futureOr: 1, type: [P.Map,,,]}));
    },
    $signature: 27
  };
  ...
  T.Matrix4.prototype = {
    setValues$16: function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15) {
      ...
      C.NativeFloat32List_methods.$indexSet(t1, 15, arg15);
      C.NativeFloat32List_methods.$indexSet(t1, 14, arg14);
      C.NativeFloat32List_methods.$indexSet(t1, 13, arg13);
      C.NativeFloat32List_methods.$indexSet(t1, 12, arg12);
      C.NativeFloat32List_methods.$indexSet(t1, 11, arg11);
      C.NativeFloat32List_methods.$indexSet(t1, 10, arg10);
      C.NativeFloat32List_methods.$indexSet(t1, 9, arg9);
      C.NativeFloat32List_methods.$indexSet(t1, 8, arg8);
      C.NativeFloat32List_methods.$indexSet(t1, 7, arg7);
      C.NativeFloat32List_methods.$indexSet(t1, 6, arg6);
      C.NativeFloat32List_methods.$indexSet(t1, 5, arg5);
      C.NativeFloat32List_methods.$indexSet(t1, 4, arg4);
      C.NativeFloat32List_methods.$indexSet(t1, 3, arg3);
      C.NativeFloat32List_methods.$indexSet(t1, 2, arg2);
      C.NativeFloat32List_methods.$indexSet(t1, 1, arg1);
      C.NativeFloat32List_methods.$indexSet(t1, 0, arg0);
    },
    setFrom$1: function(arg) {
      var argStorage, t1;
  ...
  X.main_closure.prototype = {
    call$1: function(e) {
      ...
      P.print(H.S(input.id) + " toggle " + H.S(input.checked));
      this.programMap.$index(0, input.id).enabled = input.checked;
    },
    $signature: 31
  };
  X.main_animate.prototype = {
    call$1: function(timeMs) {
      var t1, t2, t3, t4, t5, t6, t7, rcp, t8, t9, len, x, y, z, c, s, $C, m11, m12, m13, m21, m22, m23, m31, m32, m33, t10, t11, t12, t13, t14, t15, t16, bonePos;
      ...
      t15 = t9[7];
      t16 = t9[11];
      t9[0] = t2 * m11 + t5 * m21 + t7 * m31;
      t9[1] = t6 * m11 + t8 * m21 + t10 * m31;
      t9[2] = t11 * m11 + t12 * m21 + t13 * m31;
      t9[3] = t14 * m11 + t15 * m21 + t16 * m31;
      t9[4] = t2 * m12 + t5 * m22 + t7 * m32;
      t9[5] = t6 * m12 + t8 * m22 + t10 * m32;
      t9[6] = t11 * m12 + t12 * m22 + t13 * m32;
      t9[7] = t14 * m12 + t15 * m22 + t16 * m32;
      t9[8] = t2 * m13 + t5 * m23 + t7 * m33;
      t9[9] = t6 * m13 + t8 * m23 + t10 * m33;
      t9[10] = t11 * m13 + t12 * m23 + t13 * m33;
      t9[11] = t14 * m13 + t15 * m23 + t16 * m33;
      ...
      this.fps.UpdateFrameCount$1(t1._lastTimeMs);
      t3 = timeMs / 1000;
      this.mat._uniforms.$indexSet(0, "uTime", C.JSInt_methods.$mod(C.JSDouble_methods.floor$0(t3 / 0.0333), t1.animationSteps.length));
      t1 = t1.boneVisualizer;
      t4 = t1._skeleton;
      t16 = t1._globalOffsetTransform;
      t15 = t1._anim;
      t14 = t1._animatedSkeleton;
      t9 = t15.duration;
      if (typeof t9 !== "number")
        return H.iae(t9);
      L.UpdateAnimatedSkeleton(t4, t16, t15, t14, C.JSDouble_methods.$mod(t3, t9));
      bonePos = R.BonePosFromAnimatedSkeleton(t4, t1._animatedSkeleton);
      t1._mdWire.ChangeVertices$1(G.FlattenVector3List(bonePos));
    },
    $signature: 32
  };
  X.main_closure0.prototype = {
    call$1: function(list) {
      var t1, t2, t3, t4, t5, t6, t7, meshJson, animJson, globalOffsetTransform, skeleton, gb, anim, md, t8, t9, t10, t11, n, t, animationData, animationTable, boneVisualizer;
      H.listTypeCheck(list);
      t1 = this.cgl;
      t2 = J.getInterceptor$asx(list);
      t3 = t2.$index(list, 1);
      t4 = new G.TextureProperties(1, 9729, 9729);
      t5 = J.createTexture$0$x(t1._gl);
      J.bindTexture$2$x(t1._gl, 3553, t5);
      t6 = t4.flipY ? 1 : 0;
      J.pixelStorei$2$x(t1._gl, 37440, t6);
      J.bindTexture$2$x(t1._gl, 3553, t5);
      J.texImage2D$6$x(t1._gl, 3553, 0, 6408, 6408, 5121, t3);
      t4.InstallLate$2(t1, 3553);
      J.getError$0$x(t1._gl);
      J.bindTexture$2$x(t1._gl, 3553, null);
      t6 = this.mat;
      t7 = t6._uniforms;
      t7.$indexSet(0, "uTexture", new G.ImageTexture(t3, "../asset/monster/monster.jpg", t5, 3553, t1, t4));
      t4 = [P.String, null];
      meshJson = H.assertSubtype(J.$index$asx(J.$index$asx(t2.$index(list, 0), "meshes"), 0), "$isMap", t4, "$asMap");
      animJson = H.assertSubtype(J.$index$asx(J.$index$asx(t2.$index(list, 0), "animations"), 0), "$isMap", t4, "$asMap");
      globalOffsetTransform = new T.Matrix4(new Float32Array(16));
      globalOffsetTransform.setIdentity$0();
      skeleton = Y.ImportSkeletonFromAssimp2Json(H.assertSubtype(t2.$index(list, 0), "$isMap", t4, "$asMap"));
      gb = Y.ImportGeometryFromAssimp2JsonMesh(meshJson, skeleton);
      anim = Y.ImportAnimationFromAssimp2Json(animJson, skeleton);
      P.print("Imnported " + anim.toString$0(0));
      t2 = this.sceneAnim;
      t3 = t2.program;
      md = G.MeshData$("../asset/monster/monster.json", t3._cgl, 4, t3._shaderObjectV._canonicalToLayoutPos);
      ...
      new Float32Array(3);
      t9.rotateX$1(-0.785);
      n = A.Node$Container("wrapper", new A.Node(t6, md, t4, new T.Matrix3(t5), t8, t9, new T.Vector3(t10), new T.Vector3(t11), md.name));
      t4 = new T.Vector3(new Float32Array(3));
      t4.setValues$3(100, 0, 0);
      n.lookAt$1(t4);
      C.JSArray_methods.add$1(this.sceneDemo.nodes, n);
      C.JSArray_methods.add$1(t2.nodes, n);
      t2 = this._box_0;
      t2.animationSteps = H.setRuntimeTypeInfo([], [P.double]);
      t4 = anim.duration;
      if (typeof t4 !== "number")
        return H.iae(t4);
      t = 0;
      for (; t < t4; t += 0.0333) {
        t5 = t2.animationSteps;
        (t5 && C.JSArray_methods).add$1(t5, t);
      }
      animationData = L.CreateAnimationTable(skeleton, globalOffsetTransform, anim, t2.animationSteps);
      t4 = skeleton.length * 4;
      t5 = t2.animationSteps.length;
      t6 = $.$get$TexturePropertiesFramebuffer();
      t8 = J.createTexture$0$x(t1._gl);
      animationTable = new G.TypedTextureMutable(t4, t5, 34836, "anim", t8, 3553, t1, t6);
      J.bindTexture$2$x(t1._gl, 3553, t8);
      J.texImage2D$9$x(t1._gl, 3553, 0, 34836, t4, t5, 0, 6408, 5126, animationData);
      t6.InstallLate$2(t1, 3553);
      J.getError$0$x(t1._gl);
      J.bindTexture$2$x(t1._gl, 3553, null);
      t2.animationTable = animationTable;
      t7.$indexSet(0, "uAnimationTable", animationTable);
      t7 = this.sceneSkeleton;
      t1 = new T.Matrix4(new Float32Array(16));
      t1.setIdentity$0();
      boneVisualizer = new R.BoneVisualizer(t1, skeleton, anim);
      t4 = L.AnimatedSkeleton$(skeleton.length);
      boneVisualizer._animatedSkeleton = t4;
      L.UpdateAnimatedSkeleton(skeleton, t1, anim, t4, 0);
      t4 = G.LineEndPointsToMeshData("wire", t7.program, R.BonePosFromAnimatedSkeleton(skeleton, t4));
      boneVisualizer._mdWire = t4;
      ...
      new Float32Array(3);
      new Float32Array(3);
      t1 = new A.Node(this.matWire, t4, t3, new T.Matrix3(t1), t5, t6, new T.Vector3(t8), new T.Vector3(t9), t4.name);
      boneVisualizer.mesh = t1;
      t2.boneVisualizer = boneVisualizer;
      t6.rotateX$1(0.785);
      n = A.Node$Container("wrapper", t1);
      t1 = new T.Vector3(new Float32Array(3));
      t1.setValues$3(100, 0, 0);
      n.lookAt$1(t1);
      C.JSArray_methods.add$1(t7.nodes, n);
  ...
  (function installTearOffs() {
    ...
    _static_1(W, "html_Element__determineMouseWheelEventType$closure", "Element__determineMouseWheelEventType", 36);
    ...
    _instance_1_u(R.RenderPhaseResizeAware.prototype, "get$resolutionChange", "resolutionChange$1", 14);
  })();
  (function inheritance() {
    ...
    _inheritMany(W.EventTarget, [W.Node0, W.FileWriter, W.HttpRequestEventTarget, W.MessagePort, W.SourceBuffer, W._SourceBufferList_EventTarget_ListMixin, W.TextTrack, W.TextTrackCue, W._TextTrackList_EventTarget_ListMixin, W.VideoTrackList, W.Window, P.Request, P.AudioTrackList, P.BaseAudioContext]);
    _inheritMany(W.Node0, [W.Element, W.CharacterData, W.Document, W._Attr]);
    _inheritMany(W.Element, [W.HtmlElement, P.SvgElement]);
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.BaseElement, W.BodyElement, W.CanvasElement, W.DivElement, W.FormElement, W.ImageElement, W.InputElement, W.MediaElement, W.SelectElement, W.TableElement, W.TableRowElement, W.TableSectionElement, W.TemplateElement]);
    ...
    _inheritMany(G.Texture, [G.TypedTextureMutable, G.ImageTexture]);
...
;
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: -1, args: [P.String,,]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [W.MouseEvent]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [,]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: -1, args: [,]}, {func: 1, ret: L.Bone, args: [L.Bone]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: -1, args: [W.Event]}, {func: 1, ret: P.Null, args: [W.KeyboardEvent]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [, P.StackTrace]}, {func: 1, ret: P.Null, args: [,], opt: [P.StackTrace]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: -1, args: [P.String, P.String]}, {func: 1, ret: P.Null, args: [P.num]}, {func: 1, args: [W.Event]}, {func: 1, ret: P.bool, args: [W.Node0]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: -1, args: [W.Node0, W.Node0]}, {func: 1, args: [,,]}, {func: 1, ret: P.Null, args: [W.ProgressEvent]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [W.WheelEvent]}, {func: 1, ret: P.int, args: [P.int, P.Object]}, {func: 1, ret: P.Null, args: [W.Event]}, {func: 1, ret: -1, args: [P.num]}, {func: 1, ret: P.Null, args: [[P.List,,]]}, {func: 1, ret: P.int, args: [,,]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.String, args: [W.EventTarget]}, {func: 1, ret: -1, args: [[P.Map, P.String,,], P.int]}], interceptorsByTag: null, leafTags: null};
