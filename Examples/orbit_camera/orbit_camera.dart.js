...
(function dartProgram() {
  ...
  V = {
    main: function() {
      var t1, t2, canvas, cgl, t3, t4, t5, t6, t7, t8, t9, t10, orbit, perspective, gb, md, t11, t12, headMat, t13, t14, t15, eyeMat, t16, t17, t18, t19, t20, t21, leftEye, rightEye, noseMat, nose, phase, e, ctx, gradient;
      t1 = {};
      t2 = document;
      ...
      t5 = G.RenderProgram$("solid", cgl, $.$get$solidColorVertexShader(), $.$get$solidColorFragmentShader());
      t6 = [G.UniformGroup];
      t7 = H.setRuntimeTypeInfo([perspective], t6);
      t8 = [A.Node];
      t9 = H.setRuntimeTypeInfo([], t8);
      gb = B.IcosahedronGeometry(true, 1, 4);
      md = G.MeshData$("icosahedron-4", t5._cgl, 4, t5._shaderObjectV._canonicalToLayoutPos);
      md.AddVertices$1(G.FlattenVector3List(gb.vertices));
      t10 = H.assertSubtype(gb.GenerateFaceIndices$0(), "$isList", [P.int], "$asList");
      t11 = md._cgl;
      md._indexBuffer = J.createBuffer$0$x(t11._gl);
      t12 = md._vertices.length;
      if (t12 < 768) {
        md.set$_faces(new Uint8Array(H._ensureNativeList(t10)));
        md._indexBufferType = 5121;
      } else if (t12 < 196608) {
        md.set$_faces(new Uint16Array(H._ensureNativeList(t10)));
        md._indexBufferType = 5123;
      } else {
        md.set$_faces(new Uint32Array(H._ensureNativeList(t10)));
        md._indexBufferType = 5125;
      }
      J.bindVertexArray$1$x(t11._gl, md._vao);
      t10 = md._indexBuffer;
      t12 = md._faces;
      J.bindBuffer$2$x(t11._gl, 34963, t10);
      J.bufferData$3$x(t11._gl, 34963, t12, 35048);
      G._GeometryBuilderAttributesToMeshData(gb, md);
      headMat = G.Material$("head");
      t10 = new T.Vector3(new Float32Array(3));
      t10.setValues$3(0.94, 0.72, 0.63);
      headMat._uniforms.$indexSet(0, "uColor", t10);
      t10 = H.setRuntimeTypeInfo([], t8);
      ...
      new Float32Array(3);
      new Float32Array(3);
      eyeMat = G.Material$("eye");
      eyeMat._uniforms.$indexSet(0, "uColor", $.$get$ColorBlue());
      t16 = H.setRuntimeTypeInfo([], t8);
      t17 = new Float32Array(9);
      ...
      new Float32Array(3);
      new Float32Array(3);
      leftEye = new A.Node(eyeMat, md, t16, new T.Matrix3(t17), t18, t19, new T.Vector3(t20), new T.Vector3(t21), "leftEye");
      leftEye.setPos$3(-0.2, 0.4, -0.8);
      t19.scale$1(0, 0.2);
      C.JSArray_methods.add$1(t10, leftEye);
      t16 = H.setRuntimeTypeInfo([], t8);
      t17 = new Float32Array(9);
      t18 = new T.Matrix4(new Float32Array(16));
      t18.setIdentity$0();
      ...
      new Float32Array(3);
      new Float32Array(3);
      rightEye = new A.Node(eyeMat, md, t16, new T.Matrix3(t17), t18, t19, new T.Vector3(t20), new T.Vector3(t21), "rightEye");
      t19.scale$1(0, 0.2);
      rightEye.setPos$3(0.2, 0.4, -0.8);
      C.JSArray_methods.add$1(t10, rightEye);
      noseMat = G.Material$("nose");
      t16 = new T.Vector3(new Float32Array(3));
      t16.setValues$3(0.9, 0.7, 0.6);
      noseMat._uniforms.$indexSet(0, "uColor", t16);
      t16 = H.setRuntimeTypeInfo([], t8);
      t17 = new Float32Array(9);
      t18 = new T.Matrix4(new Float32Array(16));
      t18.setIdentity$0();
      ...
      new Float32Array(3);
      new Float32Array(3);
      nose = new A.Node(noseMat, md, t16, new T.Matrix3(t17), t18, t19, new T.Vector3(t20), new T.Vector3(t21), "nose");
      t19.scale$1(0, 0.3);
      nose.setPos$3(0, 0, -0.9);
      C.JSArray_methods.add$1(t10, nose);
      C.JSArray_methods.add$1(t9, new A.Node(headMat, md, t10, new T.Matrix3(t11), t12, t13, new T.Vector3(t14), new T.Vector3(t15), "head"));
      t10 = H.setRuntimeTypeInfo([], [A.Scene]);
      phase = new R.RenderPhaseResizeAware(canvas, perspective, null, cgl, t10, 17664, "main");
      phase.RenderPhase$3("main", cgl, null);
      phase.resolutionChange$1(null);
      t11 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(phase.get$resolutionChange(), {func: 1, ret: -1, args: [t11]}), false, t11);
      C.JSArray_methods.add$1(t10, new A.Scene(t5, t7, t9, "objects"));
      t9 = G.RenderProgram$("stars", cgl, $.$get$pointSpritesVertexShader(), $.$get$pointSpritesFragmentShader());
      t6 = H.setRuntimeTypeInfo([perspective], t6);
      t7 = H.setRuntimeTypeInfo([], t8);
      t5 = t9._cgl;
      t11 = $.$get$BlendEquationMix();
      t4 = P.LinkedHashMap_LinkedHashMap$_empty(t3, t4);
      t4.$indexSet(0, "cDepthTest", true);
      t4.$indexSet(0, "cDepthWrite", false);
      t4.$indexSet(0, "cBlendEquation", t11);
      ...
      ctx.fill();
      t2 = J.createTexture$0$x(t5._gl);
      J.bindTexture$2$x(t5._gl, 3553, t2);
      J.pixelStorei$2$x(t5._gl, 37440, 1);
      J.bindTexture$2$x(t5._gl, 3553, t2);
      J.texImage2D$6$x(t5._gl, 3553, 0, 6408, 6408, 5121, e);
      J.texParameteri$3$x(t5._gl, 3553, 10240, 9729);
      J.texParameteri$3$x(t5._gl, 3553, 10241, 9729);
      J.getError$0$x(t5._gl);
      J.bindTexture$2$x(t5._gl, 3553, null);
      t4.$indexSet(0, "uTexture", new G.ImageTexture(e, "Utils::Particles", t2, 3553, t5, new G.TextureProperties(1, 9729, 9729)));
      t4.$indexSet(0, "uPointSize", 1000);
      md = R.Utils_MakeStarMesh(t9, 2000, 100);
      ...
      new Float32Array(3);
      new Float32Array(3);
      C.JSArray_methods.add$1(t7, new A.Node(new G.Material(t4, "stars"), md, t2, new T.Matrix3(t3), t5, t8, new T.Vector3(t11), new T.Vector3(t12), md.name));
      C.JSArray_methods.add$1(t10, new A.Scene(t9, t6, t7, "stars"));
      t1._lastTimeMs = 0;
      new V.main_animate(t1, orbit, phase).call$1(0);
    },
  ...
  var holders = [C, H, J, P, W, G, R, A, D, T, V, B];
  ...
  G.GeometryBuilder.prototype = {
    ...
    AddVertices$1: function(vs) {
      ...
      for (t1 = this.vertices, _i = 0; _i < 3; ++_i) {
        v = vs[_i];
    ...
    AddAttributesVector2$2: function(canonical, lst) {
      ...
      for (t1 = ts && C.JSArray_methods, _i = 0; _i < 3; ++_i) {
        v = lst[_i];
  ...
  V.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      t6 = t1.transform._m4storage;
      t4 = t1._lookAtPos._v3storage;
      t6[12] = t6[12] + t4[0];
      t6[13] = t6[13] + t4[1];
      t6[14] = t6[14] + t4[2];
      ...
      t4 = t6[7];
      t8 = t6[11];
      t6[0] = t1 * m11 + t12 * m21 + t10 * m31;
      t6[1] = t13 * m11 + t14 * m21 + t15 * m31;
      t6[2] = t16 * m11 + t9 * m21 + t11 * m31;
      t6[3] = t7 * m11 + t4 * m21 + t8 * m31;
      t6[4] = t1 * m12 + t12 * m22 + t10 * m32;
      t6[5] = t13 * m12 + t14 * m22 + t15 * m32;
      t6[6] = t16 * m12 + t9 * m22 + t11 * m32;
      t6[7] = t7 * m12 + t4 * m22 + t8 * m32;
      t6[8] = t1 * m13 + t12 * m23 + t10 * m33;
      t6[9] = t13 * m13 + t14 * m23 + t15 * m33;
      t6[10] = t16 * m13 + t9 * m23 + t11 * m33;
      t6[11] = t7 * m13 + t4 * m23 + t8 * m33;
  ...
  (function installTearOffs() {
    ...
    _static_1(W, "html_Element__determineMouseWheelEventType$closure", "Element__determineMouseWheelEventType", 23);
    _instance_1_u(R.RenderPhaseResizeAware.prototype, "get$resolutionChange", "resolutionChange$1", 18);
  })();
