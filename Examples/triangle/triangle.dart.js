...
(function dartProgram() {
  ...
  G = {
    ...
    Orthographic: function Orthographic(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11) {
      var _ = this;
      _._camera = t0;
      _._proj = t1;
      _._viewMatrix = t2;
      _._projViewMatrix = t3;
      _._aspect = t4;
      _._l = t5;
      _._r = t6;
      _._d = t7;
  ...
  F = {
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, orbit, orthographic, phase, mat1, mat2, mat3, t10, t11, t12, side1, side2, side3a, vertices3, t13, t14, t15, t16, t17, t18, vertices4, uvs3, t19, uvs4, gb, side3b, cosAngle, sinAngle;
      t1 = {};
      t2 = document;
      ...
      t6.setIdentity$0();
      orthographic = new G.Orthographic(orbit, new T.Matrix4(t4), new T.Matrix4(t5), t6, 1, -40, 40, -40, -40, 100, P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), "othrogrpahic");
      orthographic.Update$0();
      t3 = H.setRuntimeTypeInfo([], [A.Scene]);
      phase = new A.RenderPhase(null, cgl, t3, 17664, "shadow");
      phase._framebuffer = new G.Framebuffer(cgl, null);
      t4 = G.RenderProgram$("textured", cgl, $.$get$solidColorVertexShader(), $.$get$solidColorFragmentShader());
      t5 = H.setRuntimeTypeInfo([orthographic], [G.UniformGroup]);
      t6 = [A.Node];
      t7 = H.setRuntimeTypeInfo([], t6);
      C.JSArray_methods.add$1(t3, new A.Scene(t4, t5, t7, "objects"));
      mat1 = G.Material$("mat1");
      mat1._uniforms.$indexSet(0, "uColor", $.$get$ColorBlue());
      mat2 = G.Material$("mat2");
      mat2._uniforms.$indexSet(0, "uColor", $.$get$ColorRed());
      mat3 = G.Material$("mat3");
      mat3._uniforms.$indexSet(0, "uColor", $.$get$ColorGreen());
      t3 = R.ShapeCube(t4, 15, 3, 3);
      ...
      new Float32Array(3);
      new Float32Array(3);
      side1 = new A.Node(mat1, t3, t5, new T.Matrix3(t8), t9, t10, new T.Vector3(t11), new T.Vector3(t12), "side1");
      side1.setPos$3(-3, 0, 0);
      t3 = R.ShapeCube(t4, 3, 3, 15);
      t5 = H.setRuntimeTypeInfo([], t6);
      t8 = new Float32Array(9);
      t9 = new T.Matrix4(new Float32Array(16));
      t9.setIdentity$0();
      ...
      new Float32Array(3);
      new Float32Array(3);
      side2 = new A.Node(mat2, t3, t5, new T.Matrix3(t8), t9, t10, new T.Vector3(t11), new T.Vector3(t12), "side2");
      side2.setPos$3(-15, 0, 18);
      t3 = R.ShapeCube(t4, 3, 12, 3);
      t5 = H.setRuntimeTypeInfo([], t6);
      t8 = new Float32Array(9);
      t9 = new T.Matrix4(new Float32Array(16));
      t9.setIdentity$0();
      ...
      new Float32Array(3);
      new Float32Array(3);
      side3a = new A.Node(mat3, t3, t5, new T.Matrix3(t8), t9, t10, new T.Vector3(t11), new T.Vector3(t12), "side3a");
      side3a.setPos$3(15, 9, 0);
      t3 = new T.Vector3(new Float32Array(3));
      t3.setValues$3(-3, -3, 3);
      t5 = new T.Vector3(new Float32Array(3));
      t5.setValues$3(3, -3, 3);
      t8 = new T.Vector3(new Float32Array(3));
      t8.setValues$3(-3, 3, 3);
      t9 = new T.Vector3(new Float32Array(3));
      t9.setValues$3(-3, -3, -3);
      t10 = new T.Vector3(new Float32Array(3));
      t10.setValues$3(-3, 3, -3);
      t11 = new T.Vector3(new Float32Array(3));
      t11.setValues$3(3, -3, -3);
      t12 = [T.Vector3];
      vertices3 = H.setRuntimeTypeInfo([t3, t5, t8, t9, t10, t11], t12);
      t3 = new T.Vector3(new Float32Array(3));
      t3.setValues$3(-3, 3, -3);
      t5 = new T.Vector3(new Float32Array(3));
      t5.setValues$3(-3, 3, 3);
      ...
      t13.setValues$3(-3, -3, -3);
      t14 = new T.Vector3(new Float32Array(3));
      t14.setValues$3(3, -3, -3);
      t15 = new T.Vector3(new Float32Array(3));
      t15.setValues$3(-3, -3, -3);
      t16 = new T.Vector3(new Float32Array(3));
      t16.setValues$3(-3, -3, 3);
      t17 = new T.Vector3(new Float32Array(3));
      t17.setValues$3(-3, 3, 3);
      t18 = new T.Vector3(new Float32Array(3));
      t18.setValues$3(-3, 3, -3);
      vertices4 = H.setRuntimeTypeInfo([t3, t5, t8, t9, t10, t11, t13, t14, t15, t16, t17, t18], t12);
      ...
      t11.setValues$2(0, 1);
      t13 = [T.Vector2];
      uvs3 = H.setRuntimeTypeInfo([t3, t5, t8, t9, t10, t11], t13);
      t3 = new T.Vector2(new Float32Array(2));
      t3.setValues$2(0, 1);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0, 0);
      ...
      t19.setValues$2(0, 1);
      uvs4 = H.setRuntimeTypeInfo([t3, t5, t8, t9, t10, t11, t14, t15, t16, t17, t18, t19], t13);
      gb = new G.GeometryBuilder(false, H.setRuntimeTypeInfo([], [G.Face3]), H.setRuntimeTypeInfo([], [G.Face4]), H.setRuntimeTypeInfo([], t12), P.LinkedHashMap_LinkedHashMap$_empty(t2, [P.List,,]));
      ...
      t2 = G.GeometryBuilderToMeshData("wedge", t4, gb);
      t3 = H.setRuntimeTypeInfo([], t6);
      ...
      new Float32Array(3);
      new Float32Array(3);
      side3b = new A.Node(mat3, t2, t3, new T.Matrix3(t4), t5, t9, new T.Vector3(t10), new T.Vector3(t11), "side3b");
      ...
      t12 = t8[3];
      t13 = t8[11];
      t8[0] = t2 * cosAngle + t3 * t4;
      t8[1] = t5 * cosAngle + t9 * t4;
      t8[2] = t10 * cosAngle + t11 * t4;
      t8[3] = t12 * cosAngle + t13 * t4;
      t8[8] = t2 * sinAngle + t3 * cosAngle;
      t8[9] = t5 * sinAngle + t9 * cosAngle;
      t8[10] = t10 * sinAngle + t11 * cosAngle;
      t8[11] = t12 * sinAngle + t13 * cosAngle;
      side3b.setPos$3(15, 24, 0);
      ...
      new Float32Array(3);
      new Float32Array(3);
      C.JSArray_methods.add$1(t6, side1);
      C.JSArray_methods.add$1(t6, side2);
      C.JSArray_methods.add$1(t6, side3a);
      C.JSArray_methods.add$1(t6, side3b);
      t4[12] = t4[12] + t4[1] * -20;
      t4[13] = t4[13] + t4[5] * -20;
      t4[14] = t4[14] + t4[9] * -20;
      C.JSArray_methods.add$1(t7, new A.Node(null, null, t6, new T.Matrix3(t2), t3, t5, new T.Vector3(t8), new T.Vector3(t9), "triangle"));
      t2 = new F.main_resolutionChange(canvas, orthographic, phase);
      t2.call$1(null);
      t3 = W.Event;
      W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(t2, {func: 1, ret: -1, args: [t3]}), false, t3);
      orbit.polar = 0.6108652381980153;
      orbit.azimuth = -0.7853981633974483;
      t1._lastTimeMs = 0;
      new F.main_animate(t1, orbit, phase, fps).call$1(0);
    },
    main_resolutionChange: function main_resolutionChange(t0, t1, t2) {
      this.canvas = t0;
      this.orthographic = t1;
      this.phase = t2;
    },
  ...
  var holders = [C, H, J, P, W, G, R, A, D, T, F, B];
  ...
  G.Orthographic.prototype = {
    GetUniforms$0: function() {
      var t1, t2;
      t1 = this._viewMatrix;
      t1.setFrom$1(this._camera.transform);
      t2 = this._projViewMatrix;
      t2.setFrom$1(this._proj);
      t2.multiply$1(0, t1);
      t1 = this._uniforms;
      t1.$indexSet(0, "uPerspectiveViewMatrix", t2);
      return t1;
    },
    Update$0: function() {
      var t1, t2, w, t3, t4, t5, t6, tmb, fmn, t7;
      t1 = this._r;
      t2 = this._l;
      w = t1 - t2;
      t3 = this._d;
      t4 = t3 + w / this._aspect;
      t5 = this._lib$_f;
      t6 = this._b;
      tmb = t4 - t3;
      fmn = t6 - t5;
      t7 = this._proj._m4storage;
      t7[0] = 0;
      t7[1] = 0;
      t7[2] = 0;
      t7[3] = 0;
  ...
  F.main_resolutionChange.prototype = {
    call$1: function(ev) {
      var t1, w, h;
      t1 = this.canvas;
      w = t1.clientWidth;
      ...
      this.orthographic.AdjustAspect$2(w, h);
      t1 = this.phase;
      t1.viewPortW = w;
      t1.viewPortH = h;
    },
  ...
  F.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      t9 = t5[7];
      t6 = t5[11];
      t5[0] = t11 * m11 + t14 * m21 + t13 * m31;
      t5[1] = t15 * m11 + t16 * m21 + t17 * m31;
      t5[2] = t10 * m11 + t12 * m21 + t8 * m31;
      t5[3] = t7 * m11 + t9 * m21 + t6 * m31;
      t5[4] = t11 * m12 + t14 * m22 + t13 * m32;
      t5[5] = t15 * m12 + t16 * m22 + t17 * m32;
      t5[6] = t10 * m12 + t12 * m22 + t8 * m32;
      t5[7] = t7 * m12 + t9 * m22 + t6 * m32;
      t5[8] = t11 * m13 + t14 * m23 + t13 * m33;
      t5[9] = t15 * m13 + t16 * m23 + t17 * m33;
      t5[10] = t10 * m13 + t12 * m23 + t8 * m33;
      t5[11] = t7 * m13 + t9 * m23 + t6 * m33;
      ...
      this.fps.UpdateFrameCount$2(t1._lastTimeMs, H.S(t3 * 180 / 3.141592653589793) + "<br>" + H.S(t2 * 180 / 3.141592653589793));
    },
    $signature: 27
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(G.NamedEntity, [G.UniformGroup, G.MeshData, G.RenderProgram, G.Spatial, A.Scene, A.RenderPhase]);
    _inheritMany(G.UniformGroup, [G.Material, G.Orthographic]);
