...
class CoolTexture extends Animatable {
  ...
  void animate(double elapsed) {
    ...
    chronosGL.gl.texImage2DCanvas(
        TEXTURE_2D, 0, RGBA, RGBA, UNSIGNED_BYTE, canvas2d);
  }
}
...
class MyGame {
  ...
  void init() {
    ...
    Mesh m = chronosGL.shapes
        .createTorusKnot()
        .createMesh()
        .setTexture(blockTex.texture);
    ...
    html.querySelector("#webgl-canvas").onDragStart
        .listen((html.MouseEvent event) {
