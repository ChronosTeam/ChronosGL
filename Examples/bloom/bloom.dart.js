...
(function dartProgram() {
  ...
  G = {
    ...
    Framebuffer$Default: function(cgl, w, h) {
      var t1, t2, t3, t4, err;
      t1 = $.$get$TexturePropertiesFramebuffer();
      t2 = G.TypedTexture$(cgl, "frame::color", w, h, 32856, t1);
      t1 = G.TypedTexture$(cgl, "frame::depth", w, h, 33190, t1);
      t3 = new G.Framebuffer(cgl, null, t2, t1, null);
  ...
  Q = {
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, orbit, perspective, width, height, fb, progPerlinNoise, torus, t10, bloom, constants, t11, t12, vertices, uvs, n, normals, gb, i;
      t1 = {};
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(165, 0, 0, 0, new T.Vector3(t4), -0.02, t5, t6, t7, new T.Vector3(t8), new T.Vector3(t9), "camera:orbit");
      ...
      t4 = new T.Matrix4(new Float32Array(16));
      t4.setIdentity$0();
      t7.$indexSet(0, "uTransformationMatrix", t4);
      t4 = new T.Matrix4(new Float32Array(16));
      t4.setIdentity$0();
      t7.$indexSet(0, "uModelMatrix", t4);
      torus = G.GeometryBuilderToMeshData("torusknot", progPerlinNoise, B.TorusKnotGeometry(true, 1, 2, 3, 20, 128, 16, 4));
      if (typeof width !== "number")
        return width.$tdiv();
      t4 = C.JSInt_methods._tdivFast$1(width, 4);
      if (typeof height !== "number")
        return height.$tdiv();
      t8 = C.JSInt_methods._tdivFast$1(height, 4);
      t9 = G.Framebuffer$Default(cgl, t4, t8);
      t10 = G.Framebuffer$Default(cgl, t4, t8);
      bloom = new Q.BloomEffect(6, width, height, t4, t8, fb, t9, t10, new G.Framebuffer(cgl, null, null, null, null));
      t8 = $.$get$uvPassthruVertexShader();
      bloom.progHighPass = G.RenderProgram$("highpass", cgl, t8, $.$get$scaledLuminosityHighPassFragmentShader());
      constants = V.makeGaussianPdfKernelString(6, 6);
      t6 = new G.ShaderObject(H.setRuntimeTypeInfo([], t5), H.setRuntimeTypeInfo([], t5), H.setRuntimeTypeInfo([], t5), H.setRuntimeTypeInfo([], t5), P.LinkedHashMap_LinkedHashMap$_empty(t2, t6));
      t6.AddVaryingVars$1(H.setRuntimeTypeInfo(["vTexUV"], t5));
      t6.AddUniformVars$1(H.setRuntimeTypeInfo(["uDirection", "uTexture"], t5));
      t6.SetBody$1(H.setRuntimeTypeInfo([constants, "void main() {\n    vec2 invSize = 1.0 / vec2(textureSize(uTexture, 0));\n    vec3 sum = texture(uTexture, vTexUV).rgb * kernel[0];\n    for (int i = 1; i < kernel.length(); i++) {\n        vec2 offset = uDirection * invSize * float(i);\n        sum += texture(uTexture, vTexUV + offset).rgb * kernel[i];\n        sum += texture(uTexture, vTexUV - offset).rgb * kernel[i];\n    }\n    oFragColor = vec4(sum, 1.0);\n}\n"], t5));
      bloom.progBloom = G.RenderProgram$("bloom", cgl, t8, t6);
      t8 = G.RenderProgram$("bloom", cgl, t8, $.$get$applyBloomEffectFragmentShader());
      bloom.progApplyBloom = t8;
      t4 = new T.Vector3(new Float32Array(3));
      ...
      t12 = [T.Vector3];
      vertices = H.setRuntimeTypeInfo([t4, t5, t6, t11], t12);
      ...
      t11.setValues$2(0, 1);
      uvs = H.setRuntimeTypeInfo([t4, t5, t6, t11], [T.Vector2]);
      ...
      t6 = H.setRuntimeTypeInfo([], t12);
      gb = new G.GeometryBuilder(false, t4, t5, t6, P.LinkedHashMap_LinkedHashMap$_empty(t2, [P.List,,]));
      ...
      bloom.unitQuad = G.GeometryBuilderToMeshData("quad", t8, gb);
      t8 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t4 = new T.Vector2(new Float32Array(2));
      t4.setValues$2(0.65, 0.66);
      t8.$indexSet(0, "uRange", t4);
      t8.$indexSet(0, "uColorAlpha", new T.Vector4(new Float32Array(4)));
      t4 = fb.colorTexture;
      t8.$indexSet(0, "uTexture", t4);
      bloom.uniformsHighPass = new G.UniformGroup(t8, "uniformsHighPass");
      t8 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(1.5, 0);
      t8.$indexSet(0, "uDirection", t5);
      t10 = t10.colorTexture;
      t8.$indexSet(0, "uTexture", t10);
      bloom.uniformsBloomH = new G.UniformGroup(t8, "Bloom Horizontal");
      t8 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t5 = new T.Vector2(new Float32Array(2));
      t5.setValues$2(0, 1.5);
      t8.$indexSet(0, "uDirection", t5);
      t8.$indexSet(0, "uTexture", t9.colorTexture);
      bloom.uniformsBloomV = new G.UniformGroup(t8, "Bloom Vertical");
      t3 = P.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
      t3.$indexSet(0, "uTexture", t4);
      t3.$indexSet(0, "uScale", 0.6);
      t3.$indexSet(0, "uColor", $.$get$ColorWhite());
      t3.$indexSet(0, "uTexture2", t10);
      bloom.uniformsApply = new G.UniformGroup(t3, "uniformApply");
      t1._lastTimeMs = 0;
      new Q.main_animate(t1, orbit, new G.Material(t7, "mat"), fb, width, height, progPerlinNoise, torus, perspective, bloom, fps).call$1(0);
    },
    BloomEffect: function BloomEffect(t0, t1, t2, t3, t4, t5, t6, t7, t8) {
      var _ = this;
      _.radius = t0;
      _.w = t1;
      _.h = t2;
      ...
      _.fb2 = t7;
      _.fbOut = t8;
      _.unitQuad = _.uniformsApply = _.uniformsBloomV = _.uniformsBloomH = _.uniformsHighPass = _.progApplyBloom = _.progBloom = _.progHighPass = null;
    },
  ...
  V = {
    makeGaussianPdfKernelString: function(radius, sigma) {
      var w, t1, total, i, x, sep;
      w = H.setRuntimeTypeInfo([], [P.double]);
      for (t1 = sigma * sigma, total = 0, i = 0; i < radius; ++i) {
        x = 0.39894 * Math.exp(-0.5 * i * i / t1) / sigma;
        C.JSArray_methods.add$1(w, x);
        total += x;
        if (i > 0)
          total += x;
      }
      for (sep = "", i = 0, t1 = ""; i < radius; ++i, sep = ", ") {
        t1 += sep;
        if (i >= w.length)
          return H.ioore(w, i);
        t1 += H.S(w[i] / total);
      }
      return "float kernel[" + radius + "] = float[" + radius + "](" + (t1.charCodeAt(0) == 0 ? t1 : t1) + ");";
    }
  };
  var holders = [C, H, J, P, W, G, R, B, D, A, T, Q, V];
  ...
  Q.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      t3 = this.material;
      t3._uniforms.$indexSet(0, "uTime", timeMs / 1000);
      this.fb.Activate$5(17664, 0, 0, this.width, this.height);
      t4 = [G.UniformGroup];
      this.progPerlinNoise.Draw$2(this.torus, H.setRuntimeTypeInfo([this.perspective, t3], t4));
      t3 = this.bloom;
      t8 = $.$get$gLuminance().valueAsNumber;
      if (typeof t8 !== "number")
        return t8.$mul();
      t7 = $.$get$gIntensity().valueAsNumber;
      if (typeof t7 !== "number")
        return t7.$mul();
      t6 = t3.fb2;
      t9 = t3.wSmall;
      t12 = t3.hSmall;
      t6.Activate$5(17664, 0, 0, t9, t12);
      t10 = t3.uniformsHighPass;
      t2 = new T.Vector2(new Float32Array(2));
      t2.setValues$2(t8, t8 + 0.01);
      t10._uniforms.$indexSet(0, "uRange", t2);
      t3.progHighPass.Draw$2(t3.unitQuad, H.setRuntimeTypeInfo([t3.uniformsHighPass], t4));
      t3.fb1.Activate$5(17664, 0, 0, t9, t12);
      t3.progBloom.Draw$2(t3.unitQuad, H.setRuntimeTypeInfo([t3.uniformsBloomH], t4));
      t6.Activate$5(17664, 0, 0, t9, t12);
      t3.progBloom.Draw$2(t3.unitQuad, H.setRuntimeTypeInfo([t3.uniformsBloomV], t4));
      t3.fbOut.Activate$5(17664, 0, 0, t3.w, t3.h);
      t3.uniformsApply._uniforms.$indexSet(0, "uScale", t7);
      t3.progApplyBloom.Draw$2(t3.unitQuad, H.setRuntimeTypeInfo([t3.uniformsApply], t4));
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "uvPassthruVertexShader", "$get$uvPassthruVertexShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("uv-passthru");
      t2 = [P.String];
    ...
    _lazy($, "applyBloomEffectFragmentShader", "$get$applyBloomEffectFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("BloomPassF");
      t2 = [P.String];
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vTexUV"], t2));
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uTexture", "uTexture2", "uScale", "uColor"], t2));
      t1.SetBody$1(H.setRuntimeTypeInfo(["void main() {\n\toFragColor = texture(uTexture, vTexUV) +\n\t                uScale *\n\t                vec4(uColor, 1.0) *\n\t                texture(uTexture2, vTexUV);\n}\n"], t2));
      return t1;
    });
    _lazy($, "scaledLuminosityHighPassFragmentShader", "$get$scaledLuminosityHighPassFragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("ScaledLuminosityHighPassF");
      t2 = [P.String];
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vTexUV"], t2));
