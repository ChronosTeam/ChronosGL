...
(function dartProgram() {
  ...
  G = {
    ...
    Illumination__SetLightInfo: function(descs, types, lights) {
      ...
      for (t2 = lights.length, n = 0, _i = 0; _i < lights.length; lights.length === t2 || (0, H.throwConcurrentModificationError)(lights), ++_i) {
        l = lights[_i];
        t3 = n * 16;
        t4 = l.pos._v3storage;
        t5 = t4[0];
    ...
    GeometryBuilderToMeshData: function($name, prog, gb) {
      ...
      md = new G.MeshData(t1, t5, 4, t4, t2, -1, P.LinkedHashMap_LinkedHashMap$_empty(t3, P.Float32List), C.JSString_methods.$add("meshdata:", $name));
    ...
    SpotLight: function SpotLight(t0, t1, t2, t3, t4, t5, t6, t7, t8) {
      var _ = this;
      _.pos = t0;
      _.dir = t1;
      _.range = t2;
  ...
  Q = {
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, orbit, perspective, illumination, phase, lightSourceMat, t10, t11, t12, t13, t14, t15, sceneMain, mat;
      t1 = {};
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(0.5, 0, 0, 0, new T.Vector3(t4), -0.02, t5, t6, t7, new T.Vector3(t8), new T.Vector3(t9), "camera:orbit");
      t4 = new T.Matrix4(new Float32Array(16));
      t4.setIdentity$0();
      t5 = new T.Matrix4(new Float32Array(16));
      t5.setIdentity$0();
      perspective = new G.Perspective(orbit, 50, 1, 0.1, 100, t4, t5, new T.Matrix4(new Float32Array(16)), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), "perspective");
      ...
      t7.setFrom$1(t5);
      t8.setFrom$1(t6);
      C.JSArray_methods.add$1(t4, new G.SpotLight(t2, t2, 50, 0.95, 2, 2, t7, t8, "spot"));
      ...
      t7 = G.RenderProgram$("Fixed", cgl, $.$get$solidColorVertexShader(), $.$get$solidColorFragmentShader());
      t2 = [G.UniformGroup];
      t4 = H.setRuntimeTypeInfo([perspective, illumination], t2);
      t6 = [A.Node];
      t5 = H.setRuntimeTypeInfo([], t6);
      C.JSArray_methods.add$1(t8, new A.Scene(t7, t4, t5, "Fixed"));
      lightSourceMat = G.Material$("light");
      t4 = lightSourceMat._uniforms;
      t4.$indexSet(0, "uColor", $.$get$ColorYellow());
      t4.$indexSet(0, "uShininess", 25);
      t7 = G.GeometryBuilderToMeshData("icosahedron-4", t7, B.IcosahedronGeometry(true, 0.1, 4));
      t4 = H.setRuntimeTypeInfo([], t6);
      t9 = new Float32Array(9);
      t10 = new T.Matrix4(new Float32Array(16));
      t10.setIdentity$0();
      t11 = new Float32Array(16);
      t12 = new T.Matrix4(t11);
      t12.setIdentity$0();
      t13 = new Float32Array(3);
      t14 = new Float32Array(3);
      new Float32Array(3);
      new Float32Array(3);
      t15 = $.$get$posLight()._v3storage;
      t11[12] = t15[0];
      t11[13] = t15[1];
      t11[14] = t15[2];
      C.JSArray_methods.add$1(t5, new A.Node(lightSourceMat, t7, t4, new T.Matrix3(t9), t10, t12, new T.Vector3(t13), new T.Vector3(t14), "pointLight"));
      t14 = G.RenderProgram$("main", cgl, $.$get$vertexShader(), $.$get$fragmentShader());
      t2 = H.setRuntimeTypeInfo([perspective, illumination], t2);
      t6 = H.setRuntimeTypeInfo([], t6);
      sceneMain = new A.Scene(t14, t2, t6, "main");
      C.JSArray_methods.add$1(t8, sceneMain);
      t1._lastTimeMs = 0;
      mat = G.Material$("mat");
      t2 = mat._uniforms;
      t2.$indexSet(0, "uColor", $.$get$ColorGray4());
      t2.$indexSet(0, "uShininess", 25);
      P.Future_wait(H.setRuntimeTypeInfo([D.LoadJson($.$get$modelFile()), D.LoadImage($.$get$textureFile()), D.LoadImage($.$get$specularmapFile()), D.LoadImage($.$get$normalmapFile())], [[P.Future, P.Object]]), t3).then$1$1(new Q.main_closure(cgl, mat, sceneMain, new Q.main_animate(t1, orbit, phase, fps)), null);
    },
  ...
  var holders = [C, H, J, P, W, G, R, A, D, T, Q, Y, B];
  ...
  G.Texture.prototype = {
    toString$0: function(_) {
      return "Texture[" + H.S(this._url) + ", " + this._textureType + "]";
    }
  };
  ...
  Q.main_closure.prototype = {
    call$1: function(list) {
      var t1, t2, t3, t4, t5, t6, t7, gbs, md, t8, t9, t10, t11, t12, t13, t14, n;
      H.listTypeCheck(list);
      t1 = this.cgl;
      t2 = $.$get$textureFile();
      ...
      J.bindTexture$2$x(t1._gl, 3553, t5);
      J.texImage2D$6$x(t1._gl, 3553, 0, 6408, 6408, 5121, t4);
      J.texParameteri$3$x(t1._gl, 3553, 10240, 9729);
      J.texParameteri$3$x(t1._gl, 3553, 10241, 9729);
      J.getError$0$x(t1._gl);
      J.bindTexture$2$x(t1._gl, 3553, null);
      t6 = this.mat;
      t7 = t6._uniforms;
      t7.$indexSet(0, "uTexture", new G.ImageTexture(t4, t2, t5, 3553, t1, new G.TextureProperties(1, 9729, 9729)));
      t7.$indexSet(0, "uNormalScale", 0.8);
      gbs = Y.ImportGeometryFromThreeJsJson(H.interceptedTypeCheck(t3.$index(list, 0), "$isMap"));
      if (0 >= gbs.length)
      ...
      if (0 >= gbs.length)
        return H.ioore(gbs, 0);
      md = G.GeometryBuilderToMeshData(t3, t7.program, gbs[0]);
      t3 = [A.Node];
      ...
      new Float32Array(3);
      new Float32Array(3);
      n = new A.Node(null, null, t3, new T.Matrix3(t10), t11, t12, new T.Vector3(t13), new T.Vector3(t14), "wrapper");
      C.JSArray_methods.add$1(t3, new A.Node(t6, md, t1, new T.Matrix3(t2), t4, t5, new T.Vector3(t8), new T.Vector3(t9), md.name));
      t1 = new T.Vector3(new Float32Array(3));
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "modelFile", "$get$modelFile", function() {
      return $.Dir + "LeePerrySmith.js";
    });
    _lazy($, "normalmapFile", "$get$normalmapFile", function() {
      return $.Dir + "Infinite-Level_02_Tangent_SmoothUV.jpg";
    });
    _lazy($, "textureFile", "$get$textureFile", function() {
      return $.Dir + "Map-COL.jpg";
    });
    _lazy($, "specularmapFile", "$get$specularmapFile", function() {
      return $.Dir + "Map-SPEC.jpg";
    });
    _lazy($, "vertexShader", "$get$vertexShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("LightBlinnPhongV");
      t2 = [P.String];
    ...
    _lazy($, "fragmentShader", "$get$fragmentShader", function() {
      var t1, t2;
      t1 = G.ShaderObject$("LightBlinnPhongF");
      t2 = [P.String];
      t1.AddVaryingVars$1(H.setRuntimeTypeInfo(["vPosition", "vNormal", "vTexUV"], t2));
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uLightDescs", "uLightTypes", "uShininess"], t2));
      t1.AddUniformVars$1(H.setRuntimeTypeInfo(["uEyePosition", "uColor", "uTexture"], t2));
    ...
    _lazy($, "posLight", "$get$posLight", function() {
      return T.Vector3_Vector3(0.5, 1, 0);
    });
    _lazy($, "colDiffuse", "$get$colDiffuse", function() {
      return T.Vector3_Vector3$all(0.866);
    });
