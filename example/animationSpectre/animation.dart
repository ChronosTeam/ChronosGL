...
const String meshFile = "../asset/hellknight2/hellknight.mesh";
const String animFile = "../asset/hellknight2/walk7.anim";
const String textureFile = "../asset/hellknight2/body_diffuse.png";
...
SkeletalAnimation ReadAnim(
  ...
  final double duration = data["duration"].toDouble();
