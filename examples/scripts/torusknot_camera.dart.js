...
["chronosgl", "package:chronosgl/chronosgl.dart", , B, {
  ...
  createTexturedShader: function() {
    var shaderObject, vs, fs;
    shaderObject = new B.ShaderObject("Textured", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, "", "", "", "");
  ...
  ChronosGL: {
    ...
    }, "run$0", "call$1", "call$0", "get$run", 0, 2, 11, 12],
    ChronosGL$7$far$fxShader$near$transparent$useElementIndexUint$useFramebuffer: function(canvasID, far, fxShader, near, transparent, useElementIndexUint, useFramebuffer) {
      ...
      t1 = B.createTexturedShader();
      t2 = t1.name;
      pn = B.ShaderProgram$(this, t1, t2);
      this.programs.$indexSet(0, t2, pn);
      this.programBasic = pn;
  ...
  TorusKnotCamera: {
    "^": "Animatable;camera,p1,p2,p,q,radius,time,up",
    animate$1: function(_, elapsed) {
      var t1, t2, t3, t4, t5, t6, up, x, y, z, len;
      t1 = this.time += elapsed;
      t2 = this.q;
      t3 = this.p;
      t4 = this.radius;
      t5 = this.p1;
      B.getTorusKnotPos(t1 / 1500, t2, t3, t4, 1, t5);
      t1 = this.p2;
      B.getTorusKnotPos(this.time / 1500 + 0.1, t2, t3, t4, 1, t1);
      t4 = this.up;
      t2 = t4.array;
      t3 = t1.array;
      t2[0] = t3[0];
      ...
      t2[2] = t3[2];
      t4.normalize$0(0);
      t2 = this.camera.transform;
      t3 = $.Matrix4_POSX;
      t4 = t5.array[0];
      t6 = t2.array;
      t4 = C.JSNumber_methods.toDouble$0(t4);
      if (t3 >= 16)
      ...
      t3 = t5.array[1];
      t6 = t2.array;
      t3 = C.JSNumber_methods.toDouble$0(t3);
      if (t4 >= 16)
      ...
      t5 = t5.array[2];
      t2 = t2.array;
      t5 = C.JSNumber_methods.toDouble$0(t5);
      if (t3 >= 16)
  ...
  MeshData: {
    ...
    optimize$0: function() {
      ...
      if (!J.getInterceptor(this.textureCoords).$isFloat32List)
        this.textureCoords = new Float32Array(H._ensureNativeList(this.textureCoords));
      t1 = this.normals;
      if (t1 != null && !J.getInterceptor(t1).$isFloat32List)
  ...
  Utils: {
    ...
    createGradientImage2$2: function(time, canvas) {
      var e;
      if (canvas == null) {
        e = document.createElement("canvas", null);
        J.set$width$x(e, 512);
        J.set$height$x(e, 512);
        canvas = e;
      }
      new B.Utils_createGradientImage2_closure(time, 512).call$1(J.getContext$1$x(canvas, "2d"));
      return canvas;
    }
  },
  Utils_createGradientImage2_closure: {
    "^": "Closure:18;time_0,d_1",
    call$1: function(ctx) {
      var n, t1, grad, cs1, cs2;
      n = (Math.sin(H.checkNum(this.time_0)) + 1) / 2;
      t1 = this.d_1;
      J.rect$4$x(ctx, 0, 0, t1, t1);
      grad = ctx.createLinearGradient(0, 0, t1 * n, t1);
...
["dart.async", "dart:async", , P, {
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 22, 12],
...
["testgl", "torusknot_camera.dart", , V, {
  "^": "",
  main: [function() {
    new V.MyGame(null, null, null, null, Q.Vector$(0, 0, 0)).MyGame$0();
  }, "call$0", "main$closure", 0, 0, 1],
  CoolTexture: {
    "^": "Animatable;chronosGL,m,canvas2d,time",
    animate$1: function(_, elapsed) {
      var t1 = this.time + elapsed / 1000;
      this.time = t1;
      this.canvas2d = this.chronosGL._utils.createGradientImage2$2(t1, this.canvas2d);
      J.bindTexture$2$x(this.chronosGL.gl, 3553, this.m.texture);
      J.texImage2DCanvas$6$x(this.chronosGL.gl, 3553, 0, 6408, 6408, 5121, this.canvas2d);
    }
  },
  MyGame: {
    "^": "Object;chronosGL,camera,textureCache,blockTex,p1",
    init$0: [function() {
      var t1, t2, t3, t4, t, m, i;
      t1 = this.camera;
      t2 = Q.Vector$(0, 0, 0);
      t3 = Q.Vector$(0, 0, 0);
      t4 = Q.Vector$(0, 0, 0);
      this.chronosGL.animatables.$indexSet(0, "tkc", new B.TorusKnotCamera(t1, t2, t3, 2, 3, 20, 0, t4));
      t4 = this.chronosGL._utils;
      t3 = this.blockTex;
      t4.toString;
      t = t3.texture;
      t1 = t4.chronosGL.programBasic;
      t2 = B.createTorusKnotInternal(1, 2, 3, 20, 128, 16, t, 4);
      t2.optimize$0();
      m = B.Mesh$(t2, false);
      t1.objects.push(m);
      t1 = this.chronosGL;
      t1.animatables.$indexSet(0, "ct", new V.CoolTexture(t1, m, null, 0));
      for (t1 = this.p1, i = 0; i < 128; ++i)
        B.getTorusKnotPos(i / 128 * 2 * 2 * 3.141592653589793, 3, 2, 20, 1, t1);
      t1 = J.get$onDragStart$x(document.querySelector("#webgl-canvas"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new V.MyGame_init_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      this.chronosGL.run$1(0);
    }, "call$0", "get$init", 0, 0, 1],
    MyGame$0: function() {
      var t1, t2;
      t1 = B.ChronosGL$("#webgl-canvas", 1000, null, 0.1, true, false, false);
      this.chronosGL = t1;
      this.camera = t1._camera;
      t1 = t1._textureCache;
      this.textureCache = t1;
      t2 = t1.textureCache;
      t1 = B.TextureWrapper$(t1.gl, null);
      t2.$indexSet(0, "gradient.jpg", t1);
      this.blockTex = t1;
      t1 = this.textureCache;
      t1.textureCache.$indexSet(0, "particle.bmp", B.TextureWrapper$(t1.gl, null));
      this.textureCache.loadAllThenExecute$1(this.get$init());
    }
  },
  MyGame_init_closure: {
    "^": "Closure:13;",
