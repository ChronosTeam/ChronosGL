...
(function dartProgram() {
  ...
  T = {
    ...
    main: function() {
      var t1, t2, t3, text, t4, fps, canvas, cgl, t5, t6, t7, t8, t9, orbit, perspective, progDemo, future, cosAngle, sinAngle, t10, t11, t12, t13, t14, t15;
      t1 = {};
      t2 = document;
      ...
      new Float32Array(3);
      new Float32Array(3);
      orbit = new D.OrbitCamera(25, 0, 0, 0, new T.Vector3(t4), -0.02, t5, t6, t7, new T.Vector3(t8), new T.Vector3(t9), "camera:orbit");
      ...
      future.then$1$1(new T.main_closure(t1, progDemo), null);
      t4 = $.$get$gLoadables();
      ...
      t14 = t5[11];
      t15 = -sinAngle;
      t5[4] = t7 * cosAngle + t8 * sinAngle;
      t5[5] = t9 * cosAngle + t10 * sinAngle;
      t5[6] = t11 * cosAngle + t12 * sinAngle;
      t5[7] = t13 * cosAngle + t14 * sinAngle;
      t5[8] = t7 * t15 + t8 * cosAngle;
      t5[9] = t9 * t15 + t10 * cosAngle;
      t5[10] = t11 * t15 + t12 * cosAngle;
      t5[11] = t13 * t15 + t14 * cosAngle;
      t2.$indexSet(0, "uModelMatrix", t6);
      t1._lastTimeMs = 0;
      P.Future_wait(t4, t3).then$1$1(new T.main_closure0(new T.main_animate(t1, orbit, progDemo, perspective, new G.Material(t2, "mat"), fps)), null);
    },
  ...
  var holders = [C, H, J, P, W, G, R, D, A, T, Y];
  ...
  T.main_closure.prototype = {
    call$1: function($content) {
      var gb, t1, t2, t3, t4, t5, md, desc, index;
      ...
      t5 = J.createVertexArray$0$x(t2._gl);
      md = new G.MeshData(t2, t5, 4, t4, t1, -1, P.LinkedHashMap_LinkedHashMap$_empty(t3, P.Float32List), "meshdata:");
      t3 = G.FlattenVector3List(gb.vertices);
      t4.$indexSet(0, "aPosition", J.createBuffer$0$x(t2._gl));
      md._vertices = t3;
      ...
      J.bindVertexArray$1$x(t2._gl, t5);
      t2.enableVertexAttribArray$2(0, index, 0);
      t2.vertexAttribPointer$7(0, t4.$index(0, "aPosition"), index, desc.GetSize$0(), 5126, false, 0, 0);
  ...
  T.main_animate.prototype = {
    call$1: function(timeMs) {
      ...
      this.progDemo.Draw$2(t1.ctLogo, H.setRuntimeTypeInfo([this.perspective, this.material], [G.UniformGroup]));
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(R.PerspectiveResizeAware.prototype, "get$resolutionChange", "resolutionChange$1", 35);
  })();
